...
public final class AbstractChannelKt {
    ...
    private static final <E> Object toResult(Object obj) {
        return obj instanceof Closed ? ChannelResult.Companion.m2289closedJP2dKIU(((Closed) obj).closeCause) : ChannelResult.Companion.m2291successJP2dKIU(obj);
    }

    private static final <E> Object toResult(Closed<?> closed) {
        return ChannelResult.Companion.m2289closedJP2dKIU(closed.closeCause);
    }
}

...
@Metadata(mo33736d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\b\u0012\u0004\u0012\u00020\u00020\u0001\"\u0004\b\u0000\u0010\u0003*\u00020\u0004H@"}, mo33737d2 = {"<anonymous>", "Lkotlinx/coroutines/channels/ChannelResult;", "", "E", "Lkotlinx/coroutines/CoroutineScope;"}, mo33738k = 3, mo33739mv = {1, 6, 0}, mo33741xi = 48)
@DebugMetadata(mo34423c = "kotlinx.coroutines.channels.ChannelsKt__ChannelsKt$trySendBlocking$2", mo34424f = "Channels.kt", mo34425i = {}, mo34426l = {39}, mo34427m = "invokeSuspend", mo34428n = {}, mo34429s = {})
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            try {
                ...
                obj2 = Result.m772constructorimpl(ResultKt.createFailure(th));
            }
        } else {
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
        obj2 = Result.m772constructorimpl(Unit.INSTANCE);
        if (Result.m779isSuccessimpl(obj2)) {
            obj3 = ChannelResult.Companion.m2291successJP2dKIU(Unit.INSTANCE);
        } else {
            obj3 = ChannelResult.Companion.m2289closedJP2dKIU(Result.m775exceptionOrNullimpl(obj2));
        }
        return ChannelResult.m2276boximpl(obj3);
    }
}

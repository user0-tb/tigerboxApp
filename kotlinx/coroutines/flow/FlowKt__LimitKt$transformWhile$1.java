...
@DebugMetadata(mo34423c = "kotlinx.coroutines.flow.FlowKt__LimitKt$transformWhile$1", mo34424f = "Limit.kt", mo34425i = {0}, mo34426l = {152}, mo34427m = "invokeSuspend", mo34428n = {"collector$iv"}, mo34429s = {"L$0"})
...
final class FlowKt__LimitKt$transformWhile$1 extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        C2740xdf1aa1b6 flowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$1;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = this.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            Flow<T> flow = this.$this_transformWhile;
            C2740xdf1aa1b6 flowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$12 = new C2740xdf1aa1b6(this.$transform, (FlowCollector) this.L$0);
            try {
            ...
            flowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$1 = (C2740xdf1aa1b6) this.L$0;
            try {
                ResultKt.throwOnFailure(obj);

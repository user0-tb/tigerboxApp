...
@DebugMetadata(mo34423c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6", mo34424f = "Zip.kt", mo34425i = {}, mo34426l = {251}, mo34427m = "invokeSuspend", mo34428n = {}, mo34429s = {})
...
public final class FlowKt__ZipKt$combineTransform$6 extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(mo34423c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6$2", mo34424f = "Zip.kt", mo34425i = {}, mo34426l = {251}, mo34427m = "invokeSuspend", mo34428n = {}, mo34429s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6$2 */
    /* compiled from: Zip.kt */
    public static final class C27882 extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> {
        private /* synthetic */ Object L$0;
        /* synthetic */ Object L$1;
        int label;

        public final Object invoke(FlowCollector<? super R> flowCollector, T[] tArr, Continuation<? super Unit> continuation) {
            C27882 r0 = new C27882(r3, continuation);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            }, new C27882((Continuation<? super C27882>) null), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else if (i == 1) {
            ResultKt.throwOnFailure(obj);
    ...
    public final Object invokeSuspend$$forInline(Object obj) {
        ...
        }, new C27882((Continuation<? super C27882>) null), this);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}

...
final class SemaphoreImpl implements Semaphore {
    ...
    public final boolean addAcquireToQueue(CancellableContinuation<? super Unit> cancellableContinuation) {
        ...
        do {
            ...
            while (true) {
                if (segment.getId() >= access$getSEGMENT_SIZE$p && !segment.getRemoved()) {
                    obj = SegmentOrClosed.m2322constructorimpl(segment);
                    break;
                }
                Object access$getNextOrClosed = segment.getNextOrClosed();
                if (access$getNextOrClosed == ConcurrentLinkedListKt.CLOSED) {
                    obj = SegmentOrClosed.m2322constructorimpl(ConcurrentLinkedListKt.CLOSED);
                    break;
                }
            ...
            z = true;
            if (SegmentOrClosed.m2327isClosedimpl(obj)) {
                break;
            }
            Segment r8 = SegmentOrClosed.m2325getSegmentimpl(obj);
            while (true) {
        ...
        SemaphoreSegment semaphoreSegment2 = (SemaphoreSegment) SegmentOrClosed.m2325getSegmentimpl(obj);
    ...
    private final boolean tryResumeNextFromQueue() {
        ...
        L_0x0014:
            ...
            goto L_0x0028
        L_0x0023:
            java.lang.Object r5 = kotlinx.coroutines.internal.SegmentOrClosed.m2322constructorimpl(r5)
            goto L_0x003d
        L_0x0028:
            r6 = r5
            ...
            java.lang.Object r5 = kotlinx.coroutines.internal.SegmentOrClosed.m2322constructorimpl(r5)
        L_0x003d:
            boolean r6 = kotlinx.coroutines.internal.SegmentOrClosed.m2327isClosedimpl(r5)
            r7 = 0
            r8 = 1
            if (r6 != 0) goto L_0x0082
            kotlinx.coroutines.internal.Segment r6 = kotlinx.coroutines.internal.SegmentOrClosed.m2325getSegmentimpl(r5)
        L_0x0049:
        ...
        L_0x0078:
            ...
            goto L_0x0049
        L_0x0082:
            kotlinx.coroutines.internal.Segment r0 = kotlinx.coroutines.internal.SegmentOrClosed.m2325getSegmentimpl(r5)
            kotlinx.coroutines.sync.SemaphoreSegment r0 = (kotlinx.coroutines.sync.SemaphoreSegment) r0
            r0.cleanPrev()
            long r5 = r0.getId()

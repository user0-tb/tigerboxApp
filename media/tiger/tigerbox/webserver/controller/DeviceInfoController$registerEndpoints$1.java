...
final class DeviceInfoController$registerEndpoints$1 extends Lambda implements Function1<NanoHTTPD.IHTTPSession, NanoHTTPD.Response> {
    final /* synthetic */ DeviceInfoController this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    DeviceInfoController$registerEndpoints$1(DeviceInfoController deviceInfoController) {
        super(1);
    ...
    public final NanoHTTPD.Response invoke(NanoHTTPD.IHTTPSession iHTTPSession) {
        ...
        return this.this$0.getDeviceInfoHandler(iHTTPSession);
    }
}

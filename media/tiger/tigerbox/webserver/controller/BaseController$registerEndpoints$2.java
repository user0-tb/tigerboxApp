...
final class BaseController$registerEndpoints$2 extends Lambda implements Function1<NanoHTTPD.IHTTPSession, NanoHTTPD.Response> {
    final /* synthetic */ BaseController this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BaseController$registerEndpoints$2(BaseController baseController) {
        super(1);
    ...
    public final NanoHTTPD.Response invoke(NanoHTTPD.IHTTPSession iHTTPSession) {
        ...
        return this.this$0.keepAliveHandlerWithTimeParam(iHTTPSession);
    }
}

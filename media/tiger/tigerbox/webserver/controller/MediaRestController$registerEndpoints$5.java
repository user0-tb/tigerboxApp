...
final class MediaRestController$registerEndpoints$5 extends Lambda implements Function1<NanoHTTPD.IHTTPSession, NanoHTTPD.Response> {
    final /* synthetic */ MediaRestController this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    MediaRestController$registerEndpoints$5(MediaRestController mediaRestController) {
        super(1);
    ...
    public final NanoHTTPD.Response invoke(NanoHTTPD.IHTTPSession iHTTPSession) {
        ...
        return this.this$0.startDownload(iHTTPSession);
    }
}

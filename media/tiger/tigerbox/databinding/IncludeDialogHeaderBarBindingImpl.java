...
public class IncludeDialogHeaderBarBindingImpl extends IncludeDialogHeaderBarBinding implements OnClickListener.Listener {
    ...
    static {
        ...
        sparseIntArray.put(C2814R.C2817id.f1595includeHeaderclose_button, 6);
        sparseIntArray.put(C2814R.C2817id.f1591headerlimit_timer, 7);
        sparseIntArray.put(C2814R.C2817id.f1592headerlimit_timer_text, 8);
        sparseIntArray.put(C2814R.C2817id.f1596includeHeadercount_down_time, 9);
    }

    public IncludeDialogHeaderBarBindingImpl(DataBindingComponent dataBindingComponent, View view) {
        this(dataBindingComponent, view, mapBindings(dataBindingComponent, view, 10, sIncludes, sViewsWithIds));
    }

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    private IncludeDialogHeaderBarBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, objArr[7], objArr[8], objArr[5], objArr[6], objArr[9], objArr[3], objArr[2], objArr[1], objArr[4]);
        this.mDirtyFlags = -1;
        this.includeHeaderBatteryView.setTag((Object) null);
        this.includeHeaderDownloadMarker.setTag((Object) null);
        this.includeHeaderSettingsIcon.setTag((Object) null);
        this.includeHeaderUpdateAvailableIcon.setTag((Object) null);
        this.includeHeaderWifiCtrl.setTag((Object) null);
    ...
    public void executeBindings() {
        ...
        L_0x0067:
            long r2 = r2 | r18
        L_0x0069:
            android.widget.ImageView r6 = r1.includeHeaderSettingsIcon
        ...
        L_0x0079:
            ...
            media.tiger.tigerbox.ui.view.BatteryView r6 = r1.includeHeaderBatteryView
            media.tiger.tigerbox.p016ui.binding.BindingAdaptersKt.bindBatteryView(r6, r8)
        L_0x008a:
            long r6 = r2 & r12
            int r8 = (r6 > r4 ? 1 : (r6 == r4 ? 0 : -1))
            if (r8 == 0) goto L_0x0095
            android.widget.ImageView r6 = r1.includeHeaderDownloadMarker
        ...
        L_0x0095:
            ...
            android.widget.ImageView r6 = r1.includeHeaderUpdateAvailableIcon
            android.view.View$OnClickListener r7 = r1.mCallback19
            r6.setOnClickListener(r7)
            android.widget.ImageView r6 = r1.includeHeaderWifiCtrl
        ...
        L_0x00bc:
            ...
            android.widget.ImageView r2 = r1.includeHeaderUpdateAvailableIcon
            r2.setVisibility(r0)
        L_0x00c6:
            if (r19 == 0) goto L_0x00cd
            android.widget.ImageView r0 = r1.includeHeaderWifiCtrl
            media.tiger.tigerbox.p016ui.binding.BindingAdaptersKt.wifiStrengthIcon(r0, r9)
        L_0x00cd:
            return
        L_0x00ce:
            r0 = move-exception
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: media.tiger.tigerbox.databinding.IncludeDialogHeaderBarBindingImpl.executeBindings():void");
    }

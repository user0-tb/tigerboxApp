...
final class DefaultTigerBoxAccountRepository$getTigerBoxProfiles$1 extends Lambda implements Function1<Either<? extends Failure, ? extends List<? extends TigerBoxProfileDomain>>, Unit> {
    public static final DefaultTigerBoxAccountRepository$getTigerBoxProfiles$1 INSTANCE = new DefaultTigerBoxAccountRepository$getTigerBoxProfiles$1();

    DefaultTigerBoxAccountRepository$getTigerBoxProfiles$1() {
        super(1);
    }

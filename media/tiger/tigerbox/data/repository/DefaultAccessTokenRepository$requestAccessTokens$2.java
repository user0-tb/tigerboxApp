...
final class DefaultAccessTokenRepository$requestAccessTokens$2 extends Lambda implements Function1<AccessTokenDto, AccessTokenDomain> {
    final /* synthetic */ DefaultAccessTokenRepository this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    DefaultAccessTokenRepository$requestAccessTokens$2(DefaultAccessTokenRepository defaultAccessTokenRepository) {
        super(1);
    ...
    public final AccessTokenDomain invoke(AccessTokenDto accessTokenDto) {
        ...
        Timber.Tree tag = Timber.Forest.tag("DefaultAccessTokenRepository");
        tag.mo50214d("returned token: [" + accessTokenDto + ']', new Object[0]);

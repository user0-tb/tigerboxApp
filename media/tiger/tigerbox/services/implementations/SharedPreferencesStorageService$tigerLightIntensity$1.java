...
final class SharedPreferencesStorageService$tigerLightIntensity$1 extends Lambda implements Function1<SharedPreferences.Editor, Unit> {
    final /* synthetic */ int $value;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SharedPreferencesStorageService$tigerLightIntensity$1(int i) {
        super(1);
        this.$value = i;
    }
    ...
    public final void invoke(SharedPreferences.Editor editor) {
        ...
        editor.putInt(SharedPreferencesStorageService.KEY_TIGER_LIGHT_INTENSITY, this.$value);
    }
}

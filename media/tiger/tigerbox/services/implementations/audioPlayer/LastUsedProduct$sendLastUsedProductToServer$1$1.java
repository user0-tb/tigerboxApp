...
final class LastUsedProduct$sendLastUsedProductToServer$1$1 extends Lambda implements Function1<Either<? extends Failure, ? extends Unit>, Unit> {
    final /* synthetic */ LastUsedProduct this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    LastUsedProduct$sendLastUsedProductToServer$1$1(LastUsedProduct lastUsedProduct) {
        super(1);
    ...
    public final void invoke(Either<? extends Failure, Unit> either) {
        ...
        either.fold(new Function1<Failure, Unit>(this.this$0) {
            ...
            public final void invoke(Failure failure) {
                ...
                ((LastUsedProduct) this.receiver).handlePostStateReqFailure(failure);
            }
            ...
            public final void invoke(Unit unit) {
                ((LastUsedProduct) this.receiver).handlePostStateReqSuccess(unit);
            }
        });
    }
}

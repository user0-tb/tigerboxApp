...
final class Availability$downloadEncodingPlaylists$1 extends Lambda implements Function0<Boolean> {
    final /* synthetic */ Availability.AudioDownload $download;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    Availability$downloadEncodingPlaylists$1(Availability.AudioDownload audioDownload) {
        super(0);

...
final class SharedPreferencesStorageService$windowedLimit$1 extends Lambda implements Function1<SharedPreferences.Editor, Unit> {
    final /* synthetic */ WindowedLimits $value;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SharedPreferencesStorageService$windowedLimit$1(WindowedLimits windowedLimits) {
        super(1);
        this.$value = windowedLimits;
    }
    ...
    public final void invoke(SharedPreferences.Editor editor) {
        ...
        editor.putString("WINDOWED_LIMIT", new Gson().toJson((Object) this.$value));
    }
}

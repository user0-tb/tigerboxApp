...
final class SharedPreferencesStorageService$saveWifiPassword$1 extends Lambda implements Function1<SharedPreferences.Editor, Unit> {
    final /* synthetic */ String $password;
    final /* synthetic */ String $ssid;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SharedPreferencesStorageService$saveWifiPassword$1(String str, String str2) {
        super(1);
        this.$ssid = str;
        this.$password = str2;
    }
    ...
    public final void invoke(SharedPreferences.Editor editor) {
        ...
        editor.putString("WIFI_" + this.$ssid, this.$password);
    }
}

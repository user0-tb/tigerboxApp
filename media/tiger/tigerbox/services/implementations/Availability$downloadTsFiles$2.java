...
final class Availability$downloadTsFiles$2 extends Lambda implements Function5<Boolean, String, String, List<? extends DownloadsManagerService.FileDownloadInfo>, MultiFileDownloadState, Unit> {
    final /* synthetic */ Availability.AudioDownload $download;
    final /* synthetic */ List<DownloadsManagerService.FileDownloadInfo> $tsList;
    ...
    public /* synthetic */ class WhenMappings {
        ...
        static {
            ...
            iArr[MultiFileDownloadState.WILL_BEGIN_ONE.ordinal()] = 4;
            iArr[MultiFileDownloadState.CANCELED.ordinal()] = 5;
            $EnumSwitchMapping$0 = iArr;
        }
    }

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    Availability$downloadTsFiles$2(Availability availability, Availability.AudioDownload audioDownload, List<DownloadsManagerService.FileDownloadInfo> list) {
        super(5);
    ...
    public final void invoke(boolean z, String str, String str2, List<DownloadsManagerService.FileDownloadInfo> list, MultiFileDownloadState multiFileDownloadState) {
        ...
        if (i == 1) {
            ...
            this.this$0.progressAudioDownload(this.$download, ((int) ((((float) list.size()) / ((float) this.$tsList.size())) * 80.0f)) + 20);
            boolean unused3 = this.this$0.freeSpaceIfNeeded();
        } else if (i == 4) {
            boolean unused4 = this.this$0.freeSpaceIfNeeded();
        } else if (i == 5) {
            Job unused5 = this.this$0.finishAudioDownload(this.$download);
        }
    }
}

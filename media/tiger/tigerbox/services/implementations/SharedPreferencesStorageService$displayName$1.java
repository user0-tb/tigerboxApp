...
final class SharedPreferencesStorageService$displayName$1 extends Lambda implements Function1<SharedPreferences.Editor, Unit> {
    final /* synthetic */ String $value;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SharedPreferencesStorageService$displayName$1(String str) {
        super(1);
        this.$value = str;
    }
    ...
    public final void invoke(SharedPreferences.Editor editor) {
        ...
        editor.putString("DISPLAY_NAME", this.$value);
    }
}

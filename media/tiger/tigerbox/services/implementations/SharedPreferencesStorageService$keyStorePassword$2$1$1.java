...
final class SharedPreferencesStorageService$keyStorePassword$2$1$1 extends Lambda implements Function1<SharedPreferences.Editor, Unit> {
    final /* synthetic */ String $newPassword;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SharedPreferencesStorageService$keyStorePassword$2$1$1(String str) {
        super(1);
    ...
    public final void invoke(SharedPreferences.Editor editor) {
        ...
        editor.putString(SharedPreferencesStorageService.KEYSTORE_PASSWORD, this.$newPassword);
    }
}

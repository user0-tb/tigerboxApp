...
final class TigerCardsManager$handleValidatedCard$1$5$1 extends Lambda implements Function1<ProductAcquisitionService.ErrorCode, Unit> {
    ...
    TigerCardsManager$handleValidatedCard$1$5$1(TigerCardsManager tigerCardsManager) {
        super(1);
    ...
    public final void invoke(ProductAcquisitionService.ErrorCode errorCode) {
        if (errorCode != null) {
            ...
            if (WhenMappings.$EnumSwitchMapping$0[errorCode.ordinal()] == 1) {
                ...
                TigerCardsManager.notifyAllOnCardValidateFailure$default(tigerCardsManager, CardValidationFailError.WILDCARD_USER_CONTENT_COULD_NOT_BE_PLAYED, (TicketFailure) null, 2, (Object) null);
            }
        }
    }
}

...
final class DataMigrationServiceImpl$migrate$3$2 extends Lambda implements Function1<SharedPreferences.Editor, Unit> {
    public static final DataMigrationServiceImpl$migrate$3$2 INSTANCE = new DataMigrationServiceImpl$migrate$3$2();

    DataMigrationServiceImpl$migrate$3$2() {
        super(1);
    }

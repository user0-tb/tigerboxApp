...
final class DataMigrationServiceImpl$migrate$3$1 extends Lambda implements Function1<SharedPreferences.Editor, Unit> {
    public static final DataMigrationServiceImpl$migrate$3$1 INSTANCE = new DataMigrationServiceImpl$migrate$3$1();

    DataMigrationServiceImpl$migrate$3$1() {
        super(1);
    }

...
final class TigerCardsManager$handleValidatedCard$1$1 extends Lambda implements Function1<ProductAcquisitionService.ErrorCode, Unit> {
    ...
    TigerCardsManager$handleValidatedCard$1$1(TigerCardsManager tigerCardsManager) {
        super(1);

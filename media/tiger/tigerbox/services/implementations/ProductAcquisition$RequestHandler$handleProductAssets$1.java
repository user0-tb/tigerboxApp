...
final class ProductAcquisition$RequestHandler$handleProductAssets$1 extends Lambda implements Function5<Boolean, String, String, List<? extends DownloadsManagerService.FileDownloadInfo>, MultiFileDownloadState, Unit> {
    final /* synthetic */ Ref.ObjectRef<String> $coverPath;
    final /* synthetic */ Ref.ObjectRef<String> $hlsPath;
    ...
    ProductAcquisition$RequestHandler$handleProductAssets$1(ProductAcquisition.RequestHandler requestHandler, Ref.ObjectRef<String> objectRef, Ref.ObjectRef<String> objectRef2) {
        super(5);
        this.this$0 = requestHandler;
        this.$hlsPath = objectRef;
    ...
    public final void invoke(boolean z, String str, String str2, List<DownloadsManagerService.FileDownloadInfo> list, MultiFileDownloadState multiFileDownloadState) {
        ...
        if (i == 1) {
            this.this$0.availabilityService.flushAudioProductInfoToDisk(new AudioProductInfo(this.this$0.getActiveRequest().getProductId(), (String) this.$hlsPath.element, (String) this.$coverPath.element));
            ProductAcquisition.RequestHandler requestHandler = this.this$0;
            requestHandler.handleProductDetails(requestHandler.getActiveRequest().getProductId());
        } else if (i == 2) {
            Timber.Forest.tag("ProductAcquisition").mo50217e("handleProductAssets: FINISHED_SOME_FAILED", new Object[0]);
            this.this$0.notifyFinish(ProductAcquisitionService.ErrorCode.ACQUISITION_ERROR_GET_PRODUCT_ASSET);
        }
    }
}

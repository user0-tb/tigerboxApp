...
final class SharedPreferencesStorageService$saveVolume$1 extends Lambda implements Function1<SharedPreferences.Editor, Unit> {
    final /* synthetic */ float $volume;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SharedPreferencesStorageService$saveVolume$1(float f) {
        super(1);
        this.$volume = f;
    }
    ...
    public final void invoke(SharedPreferences.Editor editor) {
        ...
        editor.putFloat(SharedPreferencesStorageService.STREAM_VOLUME, this.$volume);
    }
}

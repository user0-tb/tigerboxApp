...
final class SharedPreferencesStorageService$saveNightLightTimer$2 extends Lambda implements Function1<SharedPreferences.Editor, Unit> {
    final /* synthetic */ Ref.ObjectRef<String> $value;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SharedPreferencesStorageService$saveNightLightTimer$2(Ref.ObjectRef<String> objectRef) {
        super(1);
    ...
    public final void invoke(SharedPreferences.Editor editor) {
        ...
        editor.putString(SharedPreferencesStorageService.KEY_NIGHT_LIGHT_TIMERS, (String) this.$value.element);
    }
}

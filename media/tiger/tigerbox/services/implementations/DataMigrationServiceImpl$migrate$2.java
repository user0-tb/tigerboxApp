...
final class DataMigrationServiceImpl$migrate$2 extends Lambda implements Function1<SharedPreferences.Editor, Unit> {
    public static final DataMigrationServiceImpl$migrate$2 INSTANCE = new DataMigrationServiceImpl$migrate$2();

    DataMigrationServiceImpl$migrate$2() {
        super(1);
    }

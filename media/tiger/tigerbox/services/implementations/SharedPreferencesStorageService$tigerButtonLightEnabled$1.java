...
final class SharedPreferencesStorageService$tigerButtonLightEnabled$1 extends Lambda implements Function1<SharedPreferences.Editor, Unit> {
    final /* synthetic */ boolean $value;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SharedPreferencesStorageService$tigerButtonLightEnabled$1(boolean z) {
        super(1);
        this.$value = z;
    }
    ...
    public final void invoke(SharedPreferences.Editor editor) {
        ...
        editor.putBoolean("TIGER_BUTTON_LIGHT_ENABLED", this.$value);
    }
}

...
final class SharedPreferencesStorageService$isMuted$1 extends Lambda implements Function1<SharedPreferences.Editor, Unit> {
    final /* synthetic */ boolean $value;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SharedPreferencesStorageService$isMuted$1(boolean z) {
        super(1);
        this.$value = z;
    }
    ...
    public final void invoke(SharedPreferences.Editor editor) {
        ...
        editor.putBoolean(SharedPreferencesStorageService.STREAM_VOLUME_MUTED, this.$value);
    }
}

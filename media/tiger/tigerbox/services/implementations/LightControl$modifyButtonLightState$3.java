...
final class LightControl$modifyButtonLightState$3 extends Lambda implements Function0<Unit> {
    final /* synthetic */ TigerButtonLightStatus $buttonLightStatus;
    final /* synthetic */ LightControl this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    LightControl$modifyButtonLightState$3(LightControl lightControl, TigerButtonLightStatus tigerButtonLightStatus) {
        super(0);
    ...
    public final void invoke() {
        ...
        lightControl.writeFile("/sys/devices/pwmleds.$/modem_status", lightControl.toFileValue(TigerButtonLightStatus.YELLOW));

...
final class SharedPreferencesStorageService$timeLimit$1 extends Lambda implements Function1<SharedPreferences.Editor, Unit> {
    final /* synthetic */ TimeLimit $value;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SharedPreferencesStorageService$timeLimit$1(TimeLimit timeLimit) {
        super(1);
    ...
    public final void invoke(SharedPreferences.Editor editor) {
        ...
        editor.putString("TIME_LIMIT", new Gson().toJson((Object) this.$value));
    }
}

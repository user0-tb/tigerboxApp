...
final class SharedPreferencesStorageService$completeOnboarding$2 extends Lambda implements Function1<SharedPreferences.Editor, Unit> {
    final /* synthetic */ boolean $complete;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SharedPreferencesStorageService$completeOnboarding$2(boolean z) {
        super(1);
        this.$complete = z;
    }
    ...
    public final void invoke(SharedPreferences.Editor editor) {
        ...
        editor.putBoolean("ONBOARDING_COMPLETED", this.$complete);
    }
}

...
public class GlideRequest<TranscodeType> extends RequestBuilder<TranscodeType> implements Cloneable {
    ...
    public media.tiger.tigerbox.infrastructure.GlideRequest<TranscodeType> transform(com.bumptech.glide.load.Transformation<android.graphics.Bitmap> r1) {
        /*
            r0 = this;
            ...
            media.tiger.tigerbox.infrastructure.GlideRequest r1 = (media.tiger.tigerbox.infrastructure.GlideRequest) r1
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: media.tiger.tigerbox.infrastructure.GlideRequest.transform(com.bumptech.glide.load.Transformation):media.tiger.tigerbox.infrastructure.GlideRequest");
    }
    ...
    /* JADX WARNING: Unknown variable types count: 1 */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public media.tiger.tigerbox.infrastructure.GlideRequest<TranscodeType> optionalTransform(com.bumptech.glide.load.Transformation<android.graphics.Bitmap> r1) {
        /*
            r0 = this;
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: media.tiger.tigerbox.infrastructure.GlideRequest.optionalTransform(com.bumptech.glide.load.Transformation):media.tiger.tigerbox.infrastructure.GlideRequest");
    }

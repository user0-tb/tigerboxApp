...
final class RetryUseCase$invoke$1 extends Lambda implements Function1<Either<? extends Failure, ? extends Type>, Unit> {
    public static final RetryUseCase$invoke$1 INSTANCE = new RetryUseCase$invoke$1();

    RetryUseCase$invoke$1() {
        super(1);
    }

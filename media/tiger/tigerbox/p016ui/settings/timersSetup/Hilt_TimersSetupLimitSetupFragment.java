...
/* renamed from: media.tiger.tigerbox.ui.settings.timersSetup.Hilt_TimersSetupLimitSetupFragment */
public abstract class Hilt_TimersSetupLimitSetupFragment extends FullScreenDialogFragment implements GeneratedComponentManagerHolder {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((TimersSetupLimitSetupFragment_GeneratedInjector) generatedComponent()).injectTimersSetupLimitSetupFragment((TimersSetupLimitSetupFragment) UnsafeCasts.unsafeCast(this));
        }
    }

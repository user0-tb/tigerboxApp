...
/* renamed from: media.tiger.tigerbox.ui.settings.timersSetup.Hilt_TimersSetupFragment */
public abstract class Hilt_TimersSetupFragment extends FullScreenDialogFragment implements GeneratedComponentManagerHolder {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((TimersSetupFragment_GeneratedInjector) generatedComponent()).injectTimersSetupFragment((TimersSetupFragment) UnsafeCasts.unsafeCast(this));
        }
    }

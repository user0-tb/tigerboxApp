...
/* renamed from: media.tiger.tigerbox.ui.settings.timersSetup.Hilt_TimersSetupWindowSetupFragment */
public abstract class Hilt_TimersSetupWindowSetupFragment extends FullScreenDialogFragment implements GeneratedComponentManagerHolder {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((TimersSetupWindowSetupFragment_GeneratedInjector) generatedComponent()).injectTimersSetupWindowSetupFragment((TimersSetupWindowSetupFragment) UnsafeCasts.unsafeCast(this));
        }
    }

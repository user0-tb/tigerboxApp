...
/* renamed from: media.tiger.tigerbox.ui.settings.wildcardreassigning.Hilt_WildCardReAssigningStep1Fragment */
public abstract class Hilt_WildCardReAssigningStep1Fragment extends FullScreenNoHeaderFragment implements GeneratedComponentManagerHolder {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((WildCardReAssigningStep1Fragment_GeneratedInjector) generatedComponent()).injectWildCardReAssigningStep1Fragment((WildCardReAssigningStep1Fragment) UnsafeCasts.unsafeCast(this));
        }
    }

...
/* renamed from: media.tiger.tigerbox.ui.settings.wildcardreassigning.Hilt_TicketRedeemTicketNumberDialogFragment */
public abstract class Hilt_TicketRedeemTicketNumberDialogFragment extends FullScreenNoHeaderFragment implements GeneratedComponentManagerHolder {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((TicketRedeemTicketNumberDialogFragment_GeneratedInjector) generatedComponent()).injectTicketRedeemTicketNumberDialogFragment((TicketRedeemTicketNumberDialogFragment) UnsafeCasts.unsafeCast(this));
        }
    }

...
/* renamed from: media.tiger.tigerbox.ui.settings.wildcardreassigning.Hilt_WildCardReAssigningStep2Fragment */
public abstract class Hilt_WildCardReAssigningStep2Fragment extends FullScreenNoHeaderFragment implements GeneratedComponentManagerHolder {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((WildCardReAssigningStep2Fragment_GeneratedInjector) generatedComponent()).injectWildCardReAssigningStep2Fragment((WildCardReAssigningStep2Fragment) UnsafeCasts.unsafeCast(this));
        }
    }

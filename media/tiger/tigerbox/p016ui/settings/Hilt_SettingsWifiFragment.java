...
/* renamed from: media.tiger.tigerbox.ui.settings.Hilt_SettingsWifiFragment */
public abstract class Hilt_SettingsWifiFragment extends FullScreenDialogFragment implements GeneratedComponentManagerHolder {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((SettingsWifiFragment_GeneratedInjector) generatedComponent()).injectSettingsWifiFragment((SettingsWifiFragment) UnsafeCasts.unsafeCast(this));
        }
    }

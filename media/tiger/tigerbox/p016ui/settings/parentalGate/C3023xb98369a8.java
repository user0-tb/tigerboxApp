...
/* renamed from: media.tiger.tigerbox.ui.settings.parentalGate.ParentalGateEnableStepFragment$special$$inlined$viewModels$default$3 */
/* compiled from: FragmentViewModelLazy.kt */
public final class C3023xb98369a8 extends Lambda implements Function0<ViewModelProvider.Factory> {
    final /* synthetic */ Function0 $ownerProducer;
    final /* synthetic */ Fragment $this_viewModels;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C3023xb98369a8(Function0 function0, Fragment fragment) {
        super(0);

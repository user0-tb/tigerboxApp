...
/* renamed from: media.tiger.tigerbox.ui.settings.parentalGate.Hilt_ParentalGateEnableStepFragment */
public abstract class Hilt_ParentalGateEnableStepFragment extends FullScreenNoHeaderFragment implements GeneratedComponentManagerHolder {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((ParentalGateEnableStepFragment_GeneratedInjector) generatedComponent()).injectParentalGateEnableStepFragment((ParentalGateEnableStepFragment) UnsafeCasts.unsafeCast(this));
        }
    }

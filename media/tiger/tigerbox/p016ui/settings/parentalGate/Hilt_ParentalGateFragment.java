...
/* renamed from: media.tiger.tigerbox.ui.settings.parentalGate.Hilt_ParentalGateFragment */
public abstract class Hilt_ParentalGateFragment extends FullScreenNoHeaderFragment implements GeneratedComponentManagerHolder {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((ParentalGateFragment_GeneratedInjector) generatedComponent()).injectParentalGateFragment((ParentalGateFragment) UnsafeCasts.unsafeCast(this));
        }
    }

...
/* renamed from: media.tiger.tigerbox.ui.settings.parentalGate.ParentalGateViewModel$prepare$1 */
/* compiled from: ParentalGateViewModel.kt */
final class ParentalGateViewModel$prepare$1 extends Lambda implements Function1<Either<? extends Failure, ? extends List<? extends TigerBoxProfileDomain>>, Unit> {
    public static final ParentalGateViewModel$prepare$1 INSTANCE = new ParentalGateViewModel$prepare$1();

    ParentalGateViewModel$prepare$1() {
        super(1);
    }

...
/* renamed from: media.tiger.tigerbox.ui.settings.parentalGate.ParentalGateDisableStepFragment$special$$inlined$viewModels$default$3 */
/* compiled from: FragmentViewModelLazy.kt */
public final class C3019x7df711cd extends Lambda implements Function0<ViewModelProvider.Factory> {
    final /* synthetic */ Function0 $ownerProducer;
    final /* synthetic */ Fragment $this_viewModels;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C3019x7df711cd(Function0 function0, Fragment fragment) {
        super(0);

...
/* renamed from: media.tiger.tigerbox.ui.settings.parentalGate.Hilt_ParentalGateDisableStepFragment */
public abstract class Hilt_ParentalGateDisableStepFragment extends FullScreenNoHeaderFragment implements GeneratedComponentManagerHolder {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((ParentalGateDisableStepFragment_GeneratedInjector) generatedComponent()).injectParentalGateDisableStepFragment((ParentalGateDisableStepFragment) UnsafeCasts.unsafeCast(this));
        }
    }

...
/* renamed from: media.tiger.tigerbox.ui.settings.systeminfo.Hilt_SystemInfoFragment */
public abstract class Hilt_SystemInfoFragment extends FullScreenFragment implements GeneratedComponentManagerHolder {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((SystemInfoFragment_GeneratedInjector) generatedComponent()).injectSystemInfoFragment((SystemInfoFragment) UnsafeCasts.unsafeCast(this));
        }
    }

...
/* renamed from: media.tiger.tigerbox.ui.settings.Hilt_FullScreenSeekBarFragment */
public abstract class Hilt_FullScreenSeekBarFragment extends FullScreenFragment implements GeneratedComponentManagerHolder {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((FullScreenSeekBarFragment_GeneratedInjector) generatedComponent()).injectFullScreenSeekBarFragment((FullScreenSeekBarFragment) UnsafeCasts.unsafeCast(this));
        }
    }

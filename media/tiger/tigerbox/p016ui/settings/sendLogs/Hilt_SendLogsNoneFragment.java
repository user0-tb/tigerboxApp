...
/* renamed from: media.tiger.tigerbox.ui.settings.sendLogs.Hilt_SendLogsNoneFragment */
public abstract class Hilt_SendLogsNoneFragment extends FullScreenNoHeaderFragment implements GeneratedComponentManagerHolder {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((SendLogsNoneFragment_GeneratedInjector) generatedComponent()).injectSendLogsNoneFragment((SendLogsNoneFragment) UnsafeCasts.unsafeCast(this));
        }
    }

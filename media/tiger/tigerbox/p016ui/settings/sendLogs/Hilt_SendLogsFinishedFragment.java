...
/* renamed from: media.tiger.tigerbox.ui.settings.sendLogs.Hilt_SendLogsFinishedFragment */
public abstract class Hilt_SendLogsFinishedFragment extends FullScreenNoHeaderFragment implements GeneratedComponentManagerHolder {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((SendLogsFinishedFragment_GeneratedInjector) generatedComponent()).injectSendLogsFinishedFragment((SendLogsFinishedFragment) UnsafeCasts.unsafeCast(this));
        }
    }

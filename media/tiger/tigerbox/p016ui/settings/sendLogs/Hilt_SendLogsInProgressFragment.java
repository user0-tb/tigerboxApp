...
/* renamed from: media.tiger.tigerbox.ui.settings.sendLogs.Hilt_SendLogsInProgressFragment */
public abstract class Hilt_SendLogsInProgressFragment extends FullScreenNoHeaderFragment implements GeneratedComponentManagerHolder {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((SendLogsInProgressFragment_GeneratedInjector) generatedComponent()).injectSendLogsInProgressFragment((SendLogsInProgressFragment) UnsafeCasts.unsafeCast(this));
        }
    }

...
/* renamed from: media.tiger.tigerbox.ui.common.reset.Hilt_ResetDialogFragment */
public abstract class Hilt_ResetDialogFragment extends FullScreenNoHeaderFragment implements GeneratedComponentManagerHolder {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((ResetDialogFragment_GeneratedInjector) generatedComponent()).injectResetDialogFragment((ResetDialogFragment) UnsafeCasts.unsafeCast(this));
        }
    }

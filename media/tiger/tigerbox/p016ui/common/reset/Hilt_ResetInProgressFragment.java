...
/* renamed from: media.tiger.tigerbox.ui.common.reset.Hilt_ResetInProgressFragment */
public abstract class Hilt_ResetInProgressFragment extends FullScreenNoHeaderFragment implements GeneratedComponentManagerHolder {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((ResetInProgressFragment_GeneratedInjector) generatedComponent()).injectResetInProgressFragment((ResetInProgressFragment) UnsafeCasts.unsafeCast(this));
        }
    }

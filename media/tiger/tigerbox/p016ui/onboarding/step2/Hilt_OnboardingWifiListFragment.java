...
/* renamed from: media.tiger.tigerbox.ui.onboarding.step2.Hilt_OnboardingWifiListFragment */
public abstract class Hilt_OnboardingWifiListFragment extends Fragment implements GeneratedComponentManagerHolder {
    ...
    Hilt_OnboardingWifiListFragment() {
    }

    Hilt_OnboardingWifiListFragment(int i) {
        super(i);
    }
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((OnboardingWifiListFragment_GeneratedInjector) generatedComponent()).injectOnboardingWifiListFragment((OnboardingWifiListFragment) UnsafeCasts.unsafeCast(this));
        }
    }

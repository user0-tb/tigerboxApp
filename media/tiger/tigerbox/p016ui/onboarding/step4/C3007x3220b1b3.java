...
/* renamed from: media.tiger.tigerbox.ui.onboarding.step4.OnboardingBackendResponseFragment$special$$inlined$viewModels$default$3 */
/* compiled from: FragmentViewModelLazy.kt */
public final class C3007x3220b1b3 extends Lambda implements Function0<ViewModelProvider.Factory> {
    final /* synthetic */ Function0 $ownerProducer;
    final /* synthetic */ Fragment $this_viewModels;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C3007x3220b1b3(Function0 function0, Fragment fragment) {
        super(0);

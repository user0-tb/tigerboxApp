...
/* renamed from: media.tiger.tigerbox.ui.onboarding.step4.OnboardingLoginFragment$special$$inlined$activityViewModels$default$2 */
/* compiled from: FragmentViewModelLazy.kt */
public final class C3013x81be7b15 extends Lambda implements Function0<ViewModelProvider.Factory> {
    final /* synthetic */ Fragment $this_activityViewModels;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C3013x81be7b15(Fragment fragment) {
        super(0);

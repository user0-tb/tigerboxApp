...
/* renamed from: media.tiger.tigerbox.ui.onboarding.step4.OnboardingLoginFragment$special$$inlined$activityViewModels$default$1 */
/* compiled from: FragmentViewModelLazy.kt */
public final class C3012x81be7b14 extends Lambda implements Function0<ViewModelStore> {
    final /* synthetic */ Fragment $this_activityViewModels;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C3012x81be7b14(Fragment fragment) {
        super(0);

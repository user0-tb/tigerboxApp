...
/* renamed from: media.tiger.tigerbox.ui.onboarding.step3.security.DownloadFirmware$downloadFirmware$1 */
/* compiled from: DownloadFirmware.kt */
final class DownloadFirmware$downloadFirmware$1 extends Lambda implements Function0<Call<ResponseBody>> {
    final /* synthetic */ String $url;
    final /* synthetic */ DownloadFirmware this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    DownloadFirmware$downloadFirmware$1(DownloadFirmware downloadFirmware, String str) {
        super(0);

...
/* renamed from: media.tiger.tigerbox.ui.onboarding.step3.Hilt_OnboardingUpdateFragment */
public abstract class Hilt_OnboardingUpdateFragment extends Fragment implements GeneratedComponentManagerHolder {
    ...
    Hilt_OnboardingUpdateFragment() {
    }

    Hilt_OnboardingUpdateFragment(int i) {
        super(i);
    }
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((OnboardingUpdateFragment_GeneratedInjector) generatedComponent()).injectOnboardingUpdateFragment((OnboardingUpdateFragment) UnsafeCasts.unsafeCast(this));
        }
    }

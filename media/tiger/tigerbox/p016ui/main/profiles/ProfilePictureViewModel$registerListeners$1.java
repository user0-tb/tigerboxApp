...
/* renamed from: media.tiger.tigerbox.ui.main.profiles.ProfilePictureViewModel$registerListeners$1 */
/* compiled from: ProfilePictureViewModel.kt */
final class ProfilePictureViewModel$registerListeners$1 extends Lambda implements Function1<Either<? extends Failure, ? extends List<? extends TigerBoxProfileDomain>>, Unit> {
    public static final ProfilePictureViewModel$registerListeners$1 INSTANCE = new ProfilePictureViewModel$registerListeners$1();

    ProfilePictureViewModel$registerListeners$1() {
        super(1);
    }

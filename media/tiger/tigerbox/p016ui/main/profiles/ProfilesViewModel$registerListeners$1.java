...
/* renamed from: media.tiger.tigerbox.ui.main.profiles.ProfilesViewModel$registerListeners$1 */
/* compiled from: ProfilesViewModel.kt */
final class ProfilesViewModel$registerListeners$1 extends Lambda implements Function1<Either<? extends Failure, ? extends List<? extends TigerBoxProfileDomain>>, Unit> {
    public static final ProfilesViewModel$registerListeners$1 INSTANCE = new ProfilesViewModel$registerListeners$1();

    ProfilesViewModel$registerListeners$1() {
        super(1);
    }

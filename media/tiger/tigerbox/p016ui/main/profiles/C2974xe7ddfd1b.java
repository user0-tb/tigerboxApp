...
/* renamed from: media.tiger.tigerbox.ui.main.profiles.ProfilePictureFragment$special$$inlined$activityViewModels$default$1 */
/* compiled from: FragmentViewModelLazy.kt */
public final class C2974xe7ddfd1b extends Lambda implements Function0<ViewModelStore> {
    final /* synthetic */ Fragment $this_activityViewModels;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C2974xe7ddfd1b(Fragment fragment) {
        super(0);

...
/* renamed from: media.tiger.tigerbox.ui.main.seemoreproducts.Hilt_SeeMoreProductsFragment */
public abstract class Hilt_SeeMoreProductsFragment extends ProductContentFragment {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((SeeMoreProductsFragment_GeneratedInjector) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).injectSeeMoreProductsFragment((SeeMoreProductsFragment) UnsafeCasts.unsafeCast(this));
        }
    }
}

...
/* renamed from: media.tiger.tigerbox.ui.main.mediaplayer.Hilt_MediaPlayerFragment */
public abstract class Hilt_MediaPlayerFragment extends FullScreenFragment implements GeneratedComponentManagerHolder {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((MediaPlayerFragment_GeneratedInjector) generatedComponent()).injectMediaPlayerFragment((MediaPlayerFragment) UnsafeCasts.unsafeCast(this));
        }
    }

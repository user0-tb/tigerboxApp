...
/* renamed from: media.tiger.tigerbox.ui.main.mediaplayer.Hilt_MediaPlayerChapterListFragment */
public abstract class Hilt_MediaPlayerChapterListFragment extends FullScreenFragment implements GeneratedComponentManagerHolder {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((MediaPlayerChapterListFragment_GeneratedInjector) generatedComponent()).injectMediaPlayerChapterListFragment((MediaPlayerChapterListFragment) UnsafeCasts.unsafeCast(this));
        }
    }

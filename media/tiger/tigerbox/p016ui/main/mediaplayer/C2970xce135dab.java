...
/* renamed from: media.tiger.tigerbox.ui.main.mediaplayer.MediaPlayerFragment$special$$inlined$activityViewModels$default$1 */
/* compiled from: FragmentViewModelLazy.kt */
public final class C2970xce135dab extends Lambda implements Function0<ViewModelStore> {
    final /* synthetic */ Fragment $this_activityViewModels;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C2970xce135dab(Fragment fragment) {
        super(0);

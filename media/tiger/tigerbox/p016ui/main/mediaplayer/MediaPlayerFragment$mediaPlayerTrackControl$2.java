...
/* renamed from: media.tiger.tigerbox.ui.main.mediaplayer.MediaPlayerFragment$mediaPlayerTrackControl$2 */
/* compiled from: MediaPlayerFragment.kt */
final class MediaPlayerFragment$mediaPlayerTrackControl$2 extends Lambda implements Function0<CircleProgressImageView> {
    final /* synthetic */ MediaPlayerFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    MediaPlayerFragment$mediaPlayerTrackControl$2(MediaPlayerFragment mediaPlayerFragment) {
        super(0);
        this.this$0 = mediaPlayerFragment;
    }

    public final CircleProgressImageView invoke() {
        return this.this$0.getMediaPlayerDeviceControls().mediaPlayerControlsTrackControl;
    }
}

...
/* renamed from: media.tiger.tigerbox.ui.main.multiproductcard.Hilt_MultiProductCardFragment */
public abstract class Hilt_MultiProductCardFragment extends ProductContentFragment {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((MultiProductCardFragment_GeneratedInjector) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).injectMultiProductCardFragment((MultiProductCardFragment) UnsafeCasts.unsafeCast(this));
        }
    }
}

...
/* renamed from: media.tiger.tigerbox.ui.main.card.Hilt_TigerTicketPurchaseFragment */
public abstract class Hilt_TigerTicketPurchaseFragment extends FullScreenNoHeaderFragment implements GeneratedComponentManagerHolder {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((TigerTicketPurchaseFragment_GeneratedInjector) generatedComponent()).injectTigerTicketPurchaseFragment((TigerTicketPurchaseFragment) UnsafeCasts.unsafeCast(this));
        }
    }

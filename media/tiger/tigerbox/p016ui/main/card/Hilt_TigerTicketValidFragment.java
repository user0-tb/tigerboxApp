...
/* renamed from: media.tiger.tigerbox.ui.main.card.Hilt_TigerTicketValidFragment */
public abstract class Hilt_TigerTicketValidFragment extends FullScreenNoHeaderFragment implements GeneratedComponentManagerHolder {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((TigerTicketValidFragment_GeneratedInjector) generatedComponent()).injectTigerTicketValidFragment((TigerTicketValidFragment) UnsafeCasts.unsafeCast(this));
        }
    }

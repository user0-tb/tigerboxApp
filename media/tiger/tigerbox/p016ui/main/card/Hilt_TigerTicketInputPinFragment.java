...
/* renamed from: media.tiger.tigerbox.ui.main.card.Hilt_TigerTicketInputPinFragment */
public abstract class Hilt_TigerTicketInputPinFragment extends FullScreenNoHeaderFragment implements GeneratedComponentManagerHolder {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((TigerTicketInputPinFragment_GeneratedInjector) generatedComponent()).injectTigerTicketInputPinFragment((TigerTicketInputPinFragment) UnsafeCasts.unsafeCast(this));
        }
    }

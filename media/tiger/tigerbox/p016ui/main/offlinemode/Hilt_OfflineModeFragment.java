...
/* renamed from: media.tiger.tigerbox.ui.main.offlinemode.Hilt_OfflineModeFragment */
public abstract class Hilt_OfflineModeFragment extends ProductContentFragment {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((OfflineModeFragment_GeneratedInjector) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).injectOfflineModeFragment((OfflineModeFragment) UnsafeCasts.unsafeCast(this));
        }
    }
}

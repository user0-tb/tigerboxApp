...
/* renamed from: media.tiger.tigerbox.ui.main.maincontent.ProductContentFragment$special$$inlined$activityViewModels$default$1 */
/* compiled from: FragmentViewModelLazy.kt */
public final class C2944xca4cacd0 extends Lambda implements Function0<ViewModelStore> {
    final /* synthetic */ Fragment $this_activityViewModels;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C2944xca4cacd0(Fragment fragment) {
        super(0);

...
/* renamed from: media.tiger.tigerbox.ui.main.maincontent.ProductContentFragment$special$$inlined$activityViewModels$default$2 */
/* compiled from: FragmentViewModelLazy.kt */
public final class C2945xca4cacd1 extends Lambda implements Function0<ViewModelProvider.Factory> {
    final /* synthetic */ Fragment $this_activityViewModels;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C2945xca4cacd1(Fragment fragment) {
        super(0);

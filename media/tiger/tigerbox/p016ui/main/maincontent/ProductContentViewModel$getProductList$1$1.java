...
/* renamed from: media.tiger.tigerbox.ui.main.maincontent.ProductContentViewModel$getProductList$1$1 */
/* compiled from: ProductContentViewModel.kt */
final class ProductContentViewModel$getProductList$1$1 extends Lambda implements Function1<List<ProductDomain>, Unit> {
    final /* synthetic */ ProductContentViewModel this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ProductContentViewModel$getProductList$1$1(ProductContentViewModel productContentViewModel) {
        super(1);
    ...
    public final void invoke(List<ProductDomain> list) {
        ...
        this.this$0._productList.setValue(list);
    }
}

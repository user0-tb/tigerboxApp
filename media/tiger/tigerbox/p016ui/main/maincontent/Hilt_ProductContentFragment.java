...
/* renamed from: media.tiger.tigerbox.ui.main.maincontent.Hilt_ProductContentFragment */
public abstract class Hilt_ProductContentFragment extends MainContentFragment implements GeneratedComponentManagerHolder {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((ProductContentFragment_GeneratedInjector) generatedComponent()).injectProductContentFragment((ProductContentFragment) UnsafeCasts.unsafeCast(this));
        }
    }

...
/* renamed from: media.tiger.tigerbox.ui.main.maincontent.ProductContentViewModel$registerListeners$1 */
/* compiled from: ProductContentViewModel.kt */
final class ProductContentViewModel$registerListeners$1 extends Lambda implements Function1<Either<? extends Failure, ? extends List<? extends TigerBoxProfileDomain>>, Unit> {
    public static final ProductContentViewModel$registerListeners$1 INSTANCE = new ProductContentViewModel$registerListeners$1();

    ProductContentViewModel$registerListeners$1() {
        super(1);
    }

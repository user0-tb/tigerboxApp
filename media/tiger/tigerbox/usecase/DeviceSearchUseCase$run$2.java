...
final class DeviceSearchUseCase$run$2 extends Lambda implements Function1<DeviceInformation, DeviceInformation> {
    public static final DeviceSearchUseCase$run$2 INSTANCE = new DeviceSearchUseCase$run$2();

    DeviceSearchUseCase$run$2() {
        super(1);
    }

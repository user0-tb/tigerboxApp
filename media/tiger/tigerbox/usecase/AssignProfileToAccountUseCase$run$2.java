...
final class AssignProfileToAccountUseCase$run$2 extends Lambda implements Function1<DeviceInformation, DeviceInformation> {
    public static final AssignProfileToAccountUseCase$run$2 INSTANCE = new AssignProfileToAccountUseCase$run$2();

    AssignProfileToAccountUseCase$run$2() {
        super(1);
    }

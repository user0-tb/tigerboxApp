        ...
        if (byteString.size() > 0) {
            ...
            if (j4 >= 0) {
                ...
                while (j2 < size4) {
                    ...
                    for (int i2 = (int) ((((long) segment.pos) + j8) - j2); i2 < min2; i2++) {
                        if (bArr2[i2] == b2) {

...
public final class _PathKt {
    ...
    /* access modifiers changed from: private */
    public static final ByteString DOT = ByteString.Companion.encodeUtf8(DownloadsManager.EXTENSION_SEPARATOR);
    /* access modifiers changed from: private */
    public static final ByteString DOT_DOT = ByteString.Companion.encodeUtf8("..");
    /* access modifiers changed from: private */
    public static final ByteString SLASH = ByteString.Companion.encodeUtf8(DownloadsManager.FOLDERS_SEPARATOR);
    ...
    public static final Path commonRelativeTo(Path path, Path path2) {
        ...
        if (Intrinsics.areEqual((Object) path.getRoot(), (Object) path2.getRoot())) {
            ...
            if (i == min && path.getBytes$okio().size() == path2.getBytes$okio().size()) {
                return Path.Companion.get$default(Path.Companion, DownloadsManager.EXTENSION_SEPARATOR, false, 1, (Object) null);
            }
    ...
    public static final ByteString toSlash(String str) {
        if (Intrinsics.areEqual((Object) str, (Object) DownloadsManager.FOLDERS_SEPARATOR)) {
            return SLASH;
        }

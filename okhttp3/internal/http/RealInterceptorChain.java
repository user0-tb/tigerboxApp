...
public final class RealInterceptorChain implements Interceptor.Chain {
    ...
    public Interceptor.Chain withConnectTimeout(int i, TimeUnit timeUnit) {
        ...
        if (this.exchange == null) {
            return copy$okhttp$default(this, 0, (Exchange) null, (Request) null, _UtilJvmKt.checkDuration("connectTimeout", (long) i, timeUnit), 0, 0, 55, (Object) null);
        }
    ...
    public Interceptor.Chain withReadTimeout(int i, TimeUnit timeUnit) {
        Intrinsics.checkNotNullParameter(timeUnit, "unit");
        if (this.exchange == null) {
            return copy$okhttp$default(this, 0, (Exchange) null, (Request) null, 0, _UtilJvmKt.checkDuration("readTimeout", (long) i, timeUnit), 0, 47, (Object) null);
        }
        throw new IllegalStateException("Timeouts can't be adjusted in a network interceptor".toString());
    }
    ...
    public Interceptor.Chain withWriteTimeout(int i, TimeUnit timeUnit) {
        Intrinsics.checkNotNullParameter(timeUnit, "unit");
        if (this.exchange == null) {
            return copy$okhttp$default(this, 0, (Exchange) null, (Request) null, 0, 0, _UtilJvmKt.checkDuration("writeTimeout", (long) i, timeUnit), 31, (Object) null);
        }
        throw new IllegalStateException("Timeouts can't be adjusted in a network interceptor".toString());
    }
    ...
    public Response proceed(Request request2) throws IOException {
        ...
        if (this.index < this.interceptors.size()) {
            ...
            Exchange exchange2 = this.exchange;
            if (exchange2 != null) {
                if (exchange2.getFinder$okhttp().getRoutePlanner().sameHostAndPort(request2.url())) {
                    if (!(this.calls == 1)) {

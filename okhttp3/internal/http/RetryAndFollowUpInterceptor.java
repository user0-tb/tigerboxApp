...
public final class RetryAndFollowUpInterceptor implements Interceptor {
        ...
        while (true) {
            ...
            try {
                if (!call$okhttp.isCanceled()) {
                    response = realInterceptorChain.proceed(request$okhttp).newBuilder().request(request$okhttp).priorResponse(response != null ? _ResponseCommonKt.stripBody(response) : null).build();
    ...
    @Metadata(mo33736d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\u0005"}, mo33737d2 = {"Lokhttp3/internal/http/RetryAndFollowUpInterceptor$Companion;", "", "()V", "MAX_FOLLOW_UPS", "", "okhttp"}, mo33738k = 1, mo33739mv = {1, 6, 0}, mo33741xi = 48)
    /* compiled from: RetryAndFollowUpInterceptor.kt */

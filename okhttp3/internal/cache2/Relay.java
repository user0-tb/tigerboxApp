...
public final class Relay {
    ...
    @Metadata(mo33736d1 = {"\u0000.\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0004\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\b\u0010\t\u001a\u00020\nH\u0016J\u0018\u0010\u000b\u001a\u00020\u00062\u0006\u0010\f\u001a\u00020\r2\u0006\u0010\u000e\u001a\u00020\u0006H\u0016J\b\u0010\u0007\u001a\u00020\bH\u0016R\u0010\u0010\u0003\u001a\u0004\u0018\u00010\u0004X\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0006X\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\bX\u0004¢\u0006\u0002\n\u0000¨\u0006\u000f"}, mo33737d2 = {"Lokhttp3/internal/cache2/Relay$RelaySource;", "Lokio/Source;", "(Lokhttp3/internal/cache2/Relay;)V", "fileOperator", "Lokhttp3/internal/cache2/FileOperator;", "sourcePos", "", "timeout", "Lokio/Timeout;", "close", "", "read", "sink", "Lokio/Buffer;", "byteCount", "okhttp"}, mo33738k = 1, mo33739mv = {1, 6, 0}, mo33741xi = 48)
    /* compiled from: Relay.kt */
    public final class RelaySource implements Source {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:21:0x0052, code lost:
            if (r1.sourcePos >= r6) goto L_0x014e;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:47:0x0106, code lost:
            if (r2.getBuffer().size() <= r2.getBufferMaxSize()) goto L_0x011c;
         */
        ...
        public long read(okio.Buffer r20, long r21) throws java.io.IOException {
            ...
            L_0x0013:
                ...
                monitor-enter(r8)
            L_0x0018:
                long r6 = r8.getUpstreamPos()     // Catch:{ all -> 0x016f }
                long r9 = r1.sourcePos     // Catch:{ all -> 0x016f }
                r0 = 2
                r11 = -1
                int r13 = (r9 > r6 ? 1 : (r9 == r6 ? 0 : -1))
                if (r13 != 0) goto L_0x0041
                boolean r6 = r8.getComplete()     // Catch:{ all -> 0x016f }
                if (r6 == 0) goto L_0x002d
                monitor-exit(r8)
                return r11
            L_0x002d:
                java.lang.Thread r6 = r8.getUpstreamReader()     // Catch:{ all -> 0x016f }
                if (r6 == 0) goto L_0x0039
                okio.Timeout r0 = r1.timeout     // Catch:{ all -> 0x016f }
                r0.waitUntilNotified(r8)     // Catch:{ all -> 0x016f }
                goto L_0x0018
            L_0x0039:
                java.lang.Thread r6 = java.lang.Thread.currentThread()     // Catch:{ all -> 0x016f }
                r8.setUpstreamReader(r6)     // Catch:{ all -> 0x016f }
                goto L_0x0055
            L_0x0041:
                long r6 = r8.getUpstreamPos()     // Catch:{ all -> 0x016f }
                okio.Buffer r4 = r8.getBuffer()     // Catch:{ all -> 0x016f }
                long r9 = r4.size()     // Catch:{ all -> 0x016f }
                long r6 = r6 - r9
                long r9 = r1.sourcePos     // Catch:{ all -> 0x016f }
            ...
            L_0x007b:
                r10 = 0
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x013d }
                okio.Source r0 = r0.getUpstream()     // Catch:{ all -> 0x013d }
                kotlin.jvm.internal.Intrinsics.checkNotNull(r0)     // Catch:{ all -> 0x013d }
                okhttp3.internal.cache2.Relay r4 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x013d }
                okio.Buffer r4 = r4.getUpstreamBuffer()     // Catch:{ all -> 0x013d }
                okhttp3.internal.cache2.Relay r6 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x013d }
                long r6 = r6.getBufferMaxSize()     // Catch:{ all -> 0x013d }
                long r14 = r0.read(r4, r6)     // Catch:{ all -> 0x013d }
                int r0 = (r14 > r11 ? 1 : (r14 == r11 ? 0 : -1))
                if (r0 != 0) goto L_0x00b5
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x013d }
                long r2 = r0.getUpstreamPos()     // Catch:{ all -> 0x013d }
                r0.commit(r2)     // Catch:{ all -> 0x013d }
                okhttp3.internal.cache2.Relay r2 = okhttp3.internal.cache2.Relay.this
                monitor-enter(r2)
                r2.setUpstreamReader(r10)     // Catch:{ all -> 0x00b2 }
                r0 = r2
                java.lang.Object r0 = (java.lang.Object) r0     // Catch:{ all -> 0x00b2 }
                r0.notifyAll()     // Catch:{ all -> 0x00b2 }
            ...
            L_0x00b2:
                ...
                throw r0
            L_0x00b5:
                long r11 = java.lang.Math.min(r14, r2)     // Catch:{ all -> 0x013d }
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x013d }
                okio.Buffer r2 = r0.getUpstreamBuffer()     // Catch:{ all -> 0x013d }
                r6 = 0
                r3 = r20
                r4 = r6
                r6 = r11
                r2.copyTo((okio.Buffer) r3, (long) r4, (long) r6)     // Catch:{ all -> 0x013d }
                long r2 = r1.sourcePos     // Catch:{ all -> 0x013d }
                long r2 = r2 + r11
                r1.sourcePos = r2     // Catch:{ all -> 0x013d }
                okhttp3.internal.cache2.FileOperator r13 = r1.fileOperator     // Catch:{ all -> 0x013d }
                kotlin.jvm.internal.Intrinsics.checkNotNull(r13)     // Catch:{ all -> 0x013d }
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x013d }
                long r2 = r0.getUpstreamPos()     // Catch:{ all -> 0x013d }
                long r2 = r2 + r8
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x013d }
                okio.Buffer r0 = r0.getUpstreamBuffer()     // Catch:{ all -> 0x013d }
                okio.Buffer r16 = r0.clone()     // Catch:{ all -> 0x013d }
                r4 = r14
                r14 = r2
                r17 = r4
                r13.write(r14, r16, r17)     // Catch:{ all -> 0x013d }
                okhttp3.internal.cache2.Relay r2 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x013d }
                monitor-enter(r2)     // Catch:{ all -> 0x013d }
                okio.Buffer r0 = r2.getBuffer()     // Catch:{ all -> 0x013a }
                okio.Buffer r3 = r2.getUpstreamBuffer()     // Catch:{ all -> 0x013a }
                r0.write((okio.Buffer) r3, (long) r4)     // Catch:{ all -> 0x013a }
                okio.Buffer r0 = r2.getBuffer()     // Catch:{ all -> 0x013a }
                long r6 = r0.size()     // Catch:{ all -> 0x013a }
                long r8 = r2.getBufferMaxSize()     // Catch:{ all -> 0x013a }
                int r0 = (r6 > r8 ? 1 : (r6 == r8 ? 0 : -1))
                if (r0 <= 0) goto L_0x011c
                okio.Buffer r0 = r2.getBuffer()     // Catch:{ all -> 0x013a }
                okio.Buffer r3 = r2.getBuffer()     // Catch:{ all -> 0x013a }
                long r6 = r3.size()     // Catch:{ all -> 0x013a }
                long r8 = r2.getBufferMaxSize()     // Catch:{ all -> 0x013a }
                long r6 = r6 - r8
                r0.skip(r6)     // Catch:{ all -> 0x013a }
            L_0x011c:
                long r6 = r2.getUpstreamPos()     // Catch:{ all -> 0x013a }
                long r6 = r6 + r4
                r2.setUpstreamPos(r6)     // Catch:{ all -> 0x013a }
                kotlin.Unit r0 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x013a }
                monitor-exit(r2)     // Catch:{ all -> 0x013d }
                okhttp3.internal.cache2.Relay r2 = okhttp3.internal.cache2.Relay.this
                monitor-enter(r2)
                r2.setUpstreamReader(r10)     // Catch:{ all -> 0x0137 }
                r0 = r2
                java.lang.Object r0 = (java.lang.Object) r0     // Catch:{ all -> 0x0137 }
                r0.notifyAll()     // Catch:{ all -> 0x0137 }
                kotlin.Unit r0 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0137 }
                monitor-exit(r2)
                return r11
            L_0x0137:
                r0 = move-exception
            ...
            L_0x013d:
                ...
                okhttp3.internal.cache2.Relay r2 = okhttp3.internal.cache2.Relay.this
                monitor-enter(r2)
                r2.setUpstreamReader(r10)     // Catch:{ all -> 0x014b }
                r2.notifyAll()     // Catch:{ all -> 0x014b }
                kotlin.Unit r3 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x014b }
                monitor-exit(r2)
                throw r0
            L_0x014b:
                r0 = move-exception
                ...
                throw r0
            L_0x014e:
                long r9 = r8.getUpstreamPos()     // Catch:{ all -> 0x016f }
                long r11 = r1.sourcePos     // Catch:{ all -> 0x016f }
                long r9 = r9 - r11
                long r9 = java.lang.Math.min(r2, r9)     // Catch:{ all -> 0x016f }
                okio.Buffer r2 = r8.getBuffer()     // Catch:{ all -> 0x016f }
                long r3 = r1.sourcePos     // Catch:{ all -> 0x016f }
                long r6 = r3 - r6
                r3 = r20
                r4 = r6
                r6 = r9
                r2.copyTo((okio.Buffer) r3, (long) r4, (long) r6)     // Catch:{ all -> 0x016f }
                long r2 = r1.sourcePos     // Catch:{ all -> 0x016f }
                long r2 = r2 + r9
                r1.sourcePos = r2     // Catch:{ all -> 0x016f }
                monitor-exit(r8)
                return r9
            L_0x016f:
                r0 = move-exception
    ...
    @Metadata(mo33736d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\t\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J&\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\u000e2\u0006\u0010\u000f\u001a\u00020\u00102\u0006\u0010\u0011\u001a\u00020\u00062\u0006\u0010\u0012\u001a\u00020\u0004J\u000e\u0010\u0013\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\u000eR\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u0010\u0010\u0005\u001a\u00020\u00068\u0006X\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\u0007\u001a\u00020\u00068\u0006X\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\tXT¢\u0006\u0002\n\u0000R\u000e\u0010\n\u001a\u00020\tXT¢\u0006\u0002\n\u0000¨\u0006\u0014"}, mo33737d2 = {"Lokhttp3/internal/cache2/Relay$Companion;", "", "()V", "FILE_HEADER_SIZE", "", "PREFIX_CLEAN", "Lokio/ByteString;", "PREFIX_DIRTY", "SOURCE_FILE", "", "SOURCE_UPSTREAM", "edit", "Lokhttp3/internal/cache2/Relay;", "file", "Ljava/io/File;", "upstream", "Lokio/Source;", "metadata", "bufferMaxSize", "read", "okhttp"}, mo33738k = 1, mo33739mv = {1, 6, 0}, mo33741xi = 48)
    /* compiled from: Relay.kt */

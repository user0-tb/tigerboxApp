...
public final class Http2 {
    ...
    static {
        ...
        for (int i2 = 0; i2 < 1; i2++) {
            ...
            strArr3[i3 | 8] = strArr3[i3] + "|PADDED";
        }
    ...
    public final String formattedType$okhttp(int i) {
        ...
        return _UtilJvmKt.format("0x%02x", Integer.valueOf(i));
    }

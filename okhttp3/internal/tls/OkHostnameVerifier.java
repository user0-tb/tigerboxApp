...
public final class OkHostnameVerifier implements HostnameVerifier {
    ...
    private final boolean verifyIpAddress(String str, X509Certificate x509Certificate) {
        ...
        for (String canonicalHost2 : subjectAltNames) {
            if (Intrinsics.areEqual((Object) canonicalHost, (Object) _HostnamesJvmKt.toCanonicalHost(canonicalHost2))) {
                return true;
            }
        }
        return false;
    ...
    private final boolean verifyHostname(String str, String str2) {
        ...
        if (!(charSequence == null || charSequence.length() == 0) && !StringsKt.startsWith$default(str, DownloadsManager.EXTENSION_SEPARATOR, false, 2, (Object) null) && !StringsKt.endsWith$default(str, "..", false, 2, (Object) null)) {
            CharSequence charSequence2 = str2;
            if (!(charSequence2 == null || charSequence2.length() == 0) && !StringsKt.startsWith$default(str2, DownloadsManager.EXTENSION_SEPARATOR, false, 2, (Object) null) && !StringsKt.endsWith$default(str2, "..", false, 2, (Object) null)) {
                if (!StringsKt.endsWith$default(str, DownloadsManager.EXTENSION_SEPARATOR, false, 2, (Object) null)) {
                    str = str + '.';
                }
                if (!StringsKt.endsWith$default(str2, DownloadsManager.EXTENSION_SEPARATOR, false, 2, (Object) null)) {
                    str2 = str2 + '.';
                }

...
public final class Handshake {
    ...
    public final TlsVersion m2636deprecated_tlsVersion() {
        return this.tlsVersion;
    }
    ...
    public final CipherSuite m2631deprecated_cipherSuite() {
        return this.cipherSuite;
    }
    ...
    public final List<Certificate> m2634deprecated_peerCertificates() {
    ...
    public final Principal m2635deprecated_peerPrincipal() {
    ...
    public final List<Certificate> m2632deprecated_localCertificates() {
        return this.localCertificates;
    }
    ...
    public final Principal m2633deprecated_localPrincipal() {
    ...
    public static final class Companion {
        ...
        public final Handshake m2637deprecated_get(SSLSession sSLSession) throws IOException {
        ...
        public final Handshake get(TlsVersion tlsVersion, CipherSuite cipherSuite, List<? extends Certificate> list, List<? extends Certificate> list2) {
            ...
            return new Handshake(tlsVersion, cipherSuite, _UtilJvmKt.toImmutableList(list2), new Handshake$Companion$get$1(_UtilJvmKt.toImmutableList(list)));
        }
    }
}

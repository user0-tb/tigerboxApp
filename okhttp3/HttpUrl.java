...
public final class HttpUrl {
    ...
    public static final class Builder {
        ...
        public final Builder host(String str) {
            ...
            Builder builder = this;
            String canonicalHost = _HostnamesJvmKt.toCanonicalHost(Companion.percentDecode$okhttp$default(HttpUrl.Companion, str, 0, 0, false, 7, (Object) null));
        ...
        public final Builder encodedPath(String str) {
            ...
            Builder builder = this;
            if (StringsKt.startsWith$default(str, DownloadsManager.FOLDERS_SEPARATOR, false, 2, (Object) null)) {
        ...
        public final Builder reencodeForUri$okhttp() {
            ...
            if (list != null) {
                ...
                for (int i2 = 0; i2 < size2; i2++) {
                    ...
                    list.set(i2, str3 != null ? Companion.canonicalize$okhttp$default(HttpUrl.Companion, str3, 0, 0, HttpUrl.QUERY_COMPONENT_ENCODE_SET_URI, true, true, true, false, (Charset) null, CipherSuite.TLS_DHE_DSS_WITH_CAMELLIA_256_CBC_SHA256, (Object) null) : null);
                }
            }
            String str4 = builder.encodedFragment;
            if (str4 != null) {
                str2 = Companion.canonicalize$okhttp$default(HttpUrl.Companion, str4, 0, 0, HttpUrl.FRAGMENT_ENCODE_SET_URI, true, true, false, true, (Charset) null, CipherSuite.TLS_DHE_DSS_WITH_AES_256_GCM_SHA384, (Object) null);
            }
        ...
        public final Builder parse$okhttp(HttpUrl httpUrl, String str) {
            ...
            int indexOfFirstNonAsciiWhitespace$default = _UtilCommonKt.indexOfFirstNonAsciiWhitespace$default(str5, 0, 0, 3, (Object) null);
            int indexOfLastNonAsciiWhitespace$default = _UtilCommonKt.indexOfLastNonAsciiWhitespace$default(str5, indexOfFirstNonAsciiWhitespace$default, 0, 2, (Object) null);
            Companion companion = Companion;
            int access$schemeDelimiterOffset = companion.schemeDelimiterOffset(str5, indexOfFirstNonAsciiWhitespace$default, indexOfLastNonAsciiWhitespace$default);
            String str6 = "this as java.lang.String…ing(startIndex, endIndex)";
            if (access$schemeDelimiterOffset != -1) {
                if (StringsKt.startsWith(str5, "https:", indexOfFirstNonAsciiWhitespace$default, true)) {
                    this.scheme = "https";
                    indexOfFirstNonAsciiWhitespace$default += 6;
                } else if (StringsKt.startsWith(str5, "http:", indexOfFirstNonAsciiWhitespace$default, true)) {
                    this.scheme = "http";
                ...
                if (str.length() > 6) {
                    str5 = StringsKt.take(str5, 6) + "...";
                }
                throw new IllegalArgumentException("Expected URL scheme 'http' or 'https' but no scheme was found for " + str5);
            }
            int access$slashCount = companion.slashCount(str5, indexOfFirstNonAsciiWhitespace$default, indexOfLastNonAsciiWhitespace$default);
            char c2 = '?';
            if (access$slashCount >= 2 || httpUrl == null || !Intrinsics.areEqual((Object) httpUrl.scheme(), (Object) this.scheme)) {
                ...
                boolean z3 = false;
                while (true) {
                    int delimiterOffset = _UtilCommonKt.delimiterOffset(str5, "@/\\?#", i6, indexOfLastNonAsciiWhitespace$default);
                    char charAt = delimiterOffset != indexOfLastNonAsciiWhitespace$default ? str5.charAt(delimiterOffset) : 65535;
                    if (charAt == '@') {
                        if (!z2) {
                            int delimiterOffset2 = _UtilCommonKt.delimiterOffset(str5, ':', i6, delimiterOffset);
                            String str7 = "%40";
                            int i7 = delimiterOffset;
                            int i8 = delimiterOffset2;
                            i4 = indexOfLastNonAsciiWhitespace$default;
                            String str8 = str6;
                            String canonicalize$okhttp$default = Companion.canonicalize$okhttp$default(HttpUrl.Companion, str, i6, delimiterOffset2, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, (Charset) null, PsExtractor.VIDEO_STREAM_MASK, (Object) null);
                            if (z3) {
                            ...
                            int i10 = i8;
                            if (i10 != i9) {
                                this.encodedPassword = Companion.canonicalize$okhttp$default(HttpUrl.Companion, str, i10 + 1, i9, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, (Charset) null, PsExtractor.VIDEO_STREAM_MASK, (Object) null);
                                z = true;
                            } else {
                                z = z2;
                            }
                            ...
                            str4 = str9;
                            i5 = i11;
                            sb3.append(Companion.canonicalize$okhttp$default(HttpUrl.Companion, str, i6, i11, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, (Charset) null, PsExtractor.VIDEO_STREAM_MASK, (Object) null));
                ...
                int access$portColonOffset = companion2.portColonOffset(str5, i6, i2);
                int i12 = access$portColonOffset + 1;
                if (i12 < i2) {
                    c = Typography.quote;
                    i3 = i6;
                    this.host = _HostnamesJvmKt.toCanonicalHost(Companion.percentDecode$okhttp$default(HttpUrl.Companion, str, i6, access$portColonOffset, false, 4, (Object) null));
                    int access$parsePort = companion2.parsePort(str5, i12, i2);
                    ...
                    str3 = str2;
                    c = Typography.quote;
                    this.host = _HostnamesJvmKt.toCanonicalHost(Companion.percentDecode$okhttp$default(HttpUrl.Companion, str, i3, access$portColonOffset, false, 4, (Object) null));
                ...
                if (this.host != null) {
                    indexOfFirstNonAsciiWhitespace$default = i2;
                } else {
                    StringBuilder sb5 = new StringBuilder();
                    sb5.append("Invalid URL host: \"");
                    String substring3 = str5.substring(i3, access$portColonOffset);
            ...
            int i13 = i;
            int delimiterOffset3 = _UtilCommonKt.delimiterOffset(str5, "?#", indexOfFirstNonAsciiWhitespace$default, i13);
            resolvePath(str5, indexOfFirstNonAsciiWhitespace$default, delimiterOffset3);
            if (delimiterOffset3 < i13 && str5.charAt(delimiterOffset3) == c2) {
                int delimiterOffset4 = _UtilCommonKt.delimiterOffset(str5, '#', delimiterOffset3, i13);
                this.encodedQueryNamesAndValues = HttpUrl.Companion.toQueryNamesAndValues$okhttp(Companion.canonicalize$okhttp$default(HttpUrl.Companion, str, delimiterOffset3 + 1, delimiterOffset4, HttpUrl.QUERY_ENCODE_SET, true, false, true, false, (Charset) null, HttpStatusCodesKt.HTTP_ALREADY_REPORTED, (Object) null));
                delimiterOffset3 = delimiterOffset4;
            }
            if (delimiterOffset3 < i13 && str5.charAt(delimiterOffset3) == '#') {
        ...
        private final boolean isDot(String str) {
            return Intrinsics.areEqual((Object) str, (Object) DownloadsManager.EXTENSION_SEPARATOR) || StringsKt.equals(str, "%2e", true);
        }
        ...
        @Metadata(mo33736d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0002\b\u0007\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J \u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u00042\u0006\u0010\b\u001a\u00020\u00062\u0006\u0010\t\u001a\u00020\u0006H\u0002J \u0010\n\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u00042\u0006\u0010\b\u001a\u00020\u00062\u0006\u0010\t\u001a\u00020\u0006H\u0002J \u0010\u000b\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u00042\u0006\u0010\b\u001a\u00020\u00062\u0006\u0010\t\u001a\u00020\u0006H\u0002J\u001c\u0010\f\u001a\u00020\u0006*\u00020\u00042\u0006\u0010\b\u001a\u00020\u00062\u0006\u0010\t\u001a\u00020\u0006H\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\r"}, mo33737d2 = {"Lokhttp3/HttpUrl$Builder$Companion;", "", "()V", "INVALID_HOST", "", "parsePort", "", "input", "pos", "limit", "portColonOffset", "schemeDelimiterOffset", "slashCount", "okhttp"}, mo33738k = 1, mo33739mv = {1, 6, 0}, mo33741xi = 48)
        /* compiled from: HttpUrl.kt */
    ...
    public static final class Companion {
        ...
        public final HttpUrl m2660deprecated_get(String str) {
        ...
        public final HttpUrl m2663deprecated_parse(String str) {
            Intrinsics.checkNotNullParameter(str, "url");
            return parse(str);
        }
        ...
        @Deprecated(level = DeprecationLevel.ERROR, message = "moved to extension function", replaceWith = @ReplaceWith(expression = "url.toHttpUrlOrNull()", imports = {"okhttp3.HttpUrl.Companion.toHttpUrlOrNull"}))
        /* renamed from: -deprecated_get  reason: not valid java name */
        public final HttpUrl m2662deprecated_get(URL url) {
        ...
        /* renamed from: -deprecated_get  reason: not valid java name */
        public final HttpUrl m2661deprecated_get(URI uri) {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:37:0x006a, code lost:
            if (isPercentEncoded(r1, r6, r2) == false) goto L_0x0073;
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        private final void writeCanonicalized(okio.Buffer r15, java.lang.String r16, int r17, int r18, java.lang.String r19, boolean r20, boolean r21, boolean r22, boolean r23, java.nio.charset.Charset r24) {
            ...
            L_0x0053:
                ...
                r12 = 0
                r13 = 2
                boolean r10 = kotlin.text.StringsKt.contains$default((java.lang.CharSequence) r10, (char) r11, (boolean) r12, (int) r13, (java.lang.Object) r5)
            ...
            L_0x007a:
                ...
                boolean r11 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r4, (java.lang.Object) r11)
                if (r11 == 0) goto L_0x0085
                goto L_0x008e
            L_0x0085:
                int r11 = java.lang.Character.charCount(r8)
                int r11 = r11 + r6
                r7.writeString((java.lang.String) r1, (int) r6, (int) r11, (java.nio.charset.Charset) r4)
                goto L_0x0091
            L_0x008e:

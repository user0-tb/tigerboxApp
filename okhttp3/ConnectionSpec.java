...
public final class ConnectionSpec {
    ...
    public final List<CipherSuite> m2617deprecated_cipherSuites() {
        return cipherSuites();
    }
    ...
    public final List<TlsVersion> m2619deprecated_tlsVersions() {
        return tlsVersions();
    }
    ...
    public final boolean m2618deprecated_supportsTlsExtensions() {
        return this.supportsTlsExtensions;
    }
    ...
    private final ConnectionSpec supportedSpec(SSLSocket sSLSocket, boolean z) {
        ...
        if (this.tlsVersionsAsString != null) {
            ...
            strArr = _UtilCommonKt.intersect(enabledProtocols, this.tlsVersionsAsString, ComparisonsKt.naturalOrder());
        } else {
    ...
    public final boolean isCompatible(SSLSocket sSLSocket) {
        ...
        String[] strArr = this.tlsVersionsAsString;
        if (strArr != null && !_UtilCommonKt.hasIntersection(strArr, sSLSocket.getEnabledProtocols(), ComparisonsKt.naturalOrder())) {
            return false;
        }
        String[] strArr2 = this.cipherSuitesAsString;
        if (strArr2 == null || _UtilCommonKt.hasIntersection(strArr2, sSLSocket.getEnabledCipherSuites(), CipherSuite.Companion.getORDER_BY_NAME$okhttp())) {
            return true;
        }
        return false;
    }
    ...
    public static final class Builder {
        ...
        public final Builder tlsVersions(String... strArr) {
            ...
            if (builder.tls) {
                if (!(strArr.length == 0)) {
                    builder.tlsVersions = (String[]) strArr.clone();
                    return builder;
                }
    ...
    @Metadata(mo33736d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0016\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004X\u0004¢\u0006\u0004\n\u0002\u0010\u0006R\u0010\u0010\u0007\u001a\u00020\b8\u0006X\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\t\u001a\u00020\b8\u0006X\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\n\u001a\u00020\b8\u0006X\u0004¢\u0006\u0002\n\u0000R\u0016\u0010\u000b\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004X\u0004¢\u0006\u0004\n\u0002\u0010\u0006R\u0010\u0010\f\u001a\u00020\b8\u0006X\u0004¢\u0006\u0002\n\u0000¨\u0006\r"}, mo33737d2 = {"Lokhttp3/ConnectionSpec$Companion;", "", "()V", "APPROVED_CIPHER_SUITES", "", "Lokhttp3/CipherSuite;", "[Lokhttp3/CipherSuite;", "CLEARTEXT", "Lokhttp3/ConnectionSpec;", "COMPATIBLE_TLS", "MODERN_TLS", "RESTRICTED_CIPHER_SUITES", "RESTRICTED_TLS", "okhttp"}, mo33738k = 1, mo33739mv = {1, 6, 0}, mo33741xi = 48)
    /* compiled from: ConnectionSpec.kt */

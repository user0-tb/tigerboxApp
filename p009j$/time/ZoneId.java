...
public abstract class ZoneId implements Serializable {
    ...
    /* renamed from: of */
    public static ZoneId m192of(String str) {
        int i;
        Objects.requireNonNull(str, "zoneId");
        if (str.length() <= 1 || str.startsWith("+") || str.startsWith("-")) {
            return ZoneOffset.m193of(str);
        }
    ...
    public static ZoneId ofOffset(String str, ZoneOffset zoneOffset) {
        ...
        if (str.equals("GMT") || str.equals("UTC") || str.equals("UT")) {
            ...
            return new ZoneRegion(str, ZoneRules.m200of(zoneOffset));
        }
    ...
    private static ZoneId ofWithPrefix(String str, int i, boolean z) {
        ...
        try {
            ZoneOffset of = ZoneOffset.m193of(str.substring(i));

...
public final /* synthetic */ class C$r8$wrapper$java$util$stream$Stream$WRP implements Stream {
    final /* synthetic */ p009j$.util.stream.Stream wrappedValue;

    private /* synthetic */ C$r8$wrapper$java$util$stream$Stream$WRP(p009j$.util.stream.Stream stream) {
        this.wrappedValue = stream;
    }

    public static /* synthetic */ Stream convert(p009j$.util.stream.Stream stream) {
        if (stream == null) {
            return null;
        }
        return new C$r8$wrapper$java$util$stream$Stream$WRP(stream);
    }
    ...
    public /* synthetic */ Optional max(Comparator comparator) {
        return Objects.convert(this.wrappedValue.max(comparator));
    }

    public /* synthetic */ Optional min(Comparator comparator) {
        return Objects.convert(this.wrappedValue.min(comparator));
    }
    ...
    public /* synthetic */ Object reduce(Object obj, BiFunction biFunction, BinaryOperator binaryOperator) {
        return this.wrappedValue.reduce(obj, C$r8$wrapper$java$util$function$BiFunction$VWRP.convert(biFunction), C$r8$wrapper$java$util$function$IntPredicate$VWRP.convert(binaryOperator));
    }

    public /* synthetic */ Object reduce(Object obj, BinaryOperator binaryOperator) {
        return this.wrappedValue.reduce(obj, C$r8$wrapper$java$util$function$IntPredicate$VWRP.convert(binaryOperator));
    }

    public /* synthetic */ Optional reduce(BinaryOperator binaryOperator) {
        return Objects.convert(this.wrappedValue.reduce(C$r8$wrapper$java$util$function$IntPredicate$VWRP.convert(binaryOperator)));
    }

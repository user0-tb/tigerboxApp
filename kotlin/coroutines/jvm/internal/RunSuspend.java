...
final class RunSuspend implements Continuation<Unit> {
    ...
    public final Result<Unit> m1979getResultxLWZpok() {
        return this.result;
    }
        ...
        synchronized (this) {
            while (true) {
                ...
                if (result2 == null) {
                    ...
                    ResultKt.throwOnFailure(result2.m781unboximpl());
                }
            }
        }
    }

...
public final class TextStreamsKt {
    ...
    public static final byte[] readBytes(java.net.URL r2) {
        /*
            ...
            byte[] r0 = kotlin.p013io.ByteStreamsKt.readBytes(r0)     // Catch:{ all -> 0x001c }
            r1 = 0
            kotlin.p013io.CloseableKt.closeFinally(r2, r1)
            return r0
        L_0x001c:
            r0 = move-exception

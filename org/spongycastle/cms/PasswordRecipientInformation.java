...
public class PasswordRecipientInformation extends RecipientInformation {
    ...
    public RecipientOperator getRecipientOperator(Recipient recipient) throws CMSException, IOException {
        ...
        return passwordRecipient.getRecipientOperator(instance, this.messageAlgorithm, passwordRecipient.calculateDerivedKey(CMSUtils.getPasswordBytes(passwordRecipient.getPasswordConversionScheme(), passwordRecipient.getPassword()), getKeyDerivationAlgorithm(), ((Integer) KEYSIZES.get(instance.getAlgorithm())).intValue()), this.info.getEncryptedKey().getOctets());
    }
}

...
public class TimeStampRequestGenerator {
    ...
    public TimeStampRequest generate(String str, byte[] bArr, BigInteger bigInteger) {
        if (str != null) {
            ...
            if (bigInteger != null) {
                return new TimeStampRequest(new TimeStampReq(messageImprint, this.reqPolicy, new ASN1Integer(bigInteger), this.certReq, extensions2));
            }
            return new TimeStampRequest(new TimeStampReq(messageImprint, this.reqPolicy, (ASN1Integer) null, this.certReq, extensions2));
        }

...
public class Skein {
    ...
    public static class HashMac_512_384 extends BaseMac {
        public HashMac_512_384() {
            super(new HMac(new SkeinDigest(512, RendererCapabilities.MODE_SUPPORT_MASK)));
        }
    }
    ...
    public static class HashMac_1024_384 extends BaseMac {
        public HashMac_1024_384() {
            super(new HMac(new SkeinDigest(1024, RendererCapabilities.MODE_SUPPORT_MASK)));
        }
    }
    ...
    public static class HMacKeyGenerator_512_384 extends BaseKeyGenerator {
        public HMacKeyGenerator_512_384() {
            super("HMACSkein-512-384", RendererCapabilities.MODE_SUPPORT_MASK, new CipherKeyGenerator());
        }
    }
    ...
    public static class HMacKeyGenerator_1024_384 extends BaseKeyGenerator {
        public HMacKeyGenerator_1024_384() {
            super("HMACSkein-1024-384", RendererCapabilities.MODE_SUPPORT_MASK, new CipherKeyGenerator());
        }
    }
    ...
    public static class SkeinMac_512_384 extends BaseMac {
        public SkeinMac_512_384() {
            super(new SkeinMac(512, RendererCapabilities.MODE_SUPPORT_MASK));
        }
    }
    ...
    public static class SkeinMac_1024_384 extends BaseMac {
        public SkeinMac_1024_384() {
            super(new SkeinMac(1024, RendererCapabilities.MODE_SUPPORT_MASK));
        }
    }
    ...
    public static class SkeinMacKeyGenerator_512_384 extends BaseKeyGenerator {
        public SkeinMacKeyGenerator_512_384() {
            super("Skein-MAC-512-384", RendererCapabilities.MODE_SUPPORT_MASK, new CipherKeyGenerator());
        }
    }
    ...
    public static class SkeinMacKeyGenerator_1024_384 extends BaseKeyGenerator {
        public SkeinMacKeyGenerator_1024_384() {
            super("Skein-MAC-1024-384", RendererCapabilities.MODE_SUPPORT_MASK, new CipherKeyGenerator());
        }
    }
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            addSkeinMacAlgorithm(configurableProvider, 512, RendererCapabilities.MODE_SUPPORT_MASK);
            addSkeinMacAlgorithm(configurableProvider, 512, 512);
            addSkeinMacAlgorithm(configurableProvider, 1024, RendererCapabilities.MODE_SUPPORT_MASK);
        ...
        private void addSkeinMacAlgorithm(ConfigurableProvider configurableProvider, int i, int i2) {
            ...
            configurableProvider.addAlgorithm("Alg.Alias.Mac.Skein-MAC" + i + DownloadsManager.FOLDERS_SEPARATOR + i2, str);
            StringBuilder sb2 = new StringBuilder();
            sb2.append("KeyGenerator.");
            sb2.append(str);
            configurableProvider.addAlgorithm(sb2.toString(), str2 + "$SkeinMacKeyGenerator_" + i + "_" + i2);
            configurableProvider.addAlgorithm("Alg.Alias.KeyGenerator.Skein-MAC" + i + DownloadsManager.FOLDERS_SEPARATOR + i2, str);
        }
    }
}

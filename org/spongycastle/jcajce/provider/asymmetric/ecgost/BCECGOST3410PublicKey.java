...
public class BCECGOST3410PublicKey implements ECPublicKey, org.spongycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    /* renamed from: q */
    private transient ECPoint f1203q;
    ...
    public BCECGOST3410PublicKey(BCECGOST3410PublicKey bCECGOST3410PublicKey) {
        this.f1203q = bCECGOST3410PublicKey.f1203q;
    ...
    public BCECGOST3410PublicKey(ECPublicKeySpec eCPublicKeySpec) {
        ...
        this.ecSpec = params;
        this.f1203q = EC5Util.convertPoint(params, eCPublicKeySpec.getW(), false);
    }

    public BCECGOST3410PublicKey(org.spongycastle.jce.spec.ECPublicKeySpec eCPublicKeySpec) {
        this.f1203q = eCPublicKeySpec.getQ();
        ...
        if (this.f1203q.getCurve() == null) {
            this.f1203q = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa().getCurve().createPoint(this.f1203q.getAffineXCoord().toBigInteger(), this.f1203q.getAffineYCoord().toBigInteger());
        }
        this.ecSpec = null;
    }
    ...
    public BCECGOST3410PublicKey(String str, ECPublicKeyParameters eCPublicKeyParameters, ECParameterSpec eCParameterSpec) {
        ...
        this.algorithm = str;
        this.f1203q = eCPublicKeyParameters.getQ();
    ...
    public BCECGOST3410PublicKey(ECPublicKey eCPublicKey) {
        ...
        this.ecSpec = params;
        this.f1203q = EC5Util.convertPoint(params, eCPublicKey.getW(), false);
    }
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            ...
            this.f1203q = curve.createPoint(new BigInteger(1, bArr), new BigInteger(1, bArr2));
    ...
    public byte[] getEncoded() {
        ...
        BigInteger bigInteger = this.f1203q.getAffineXCoord().toBigInteger();
        BigInteger bigInteger2 = this.f1203q.getAffineYCoord().toBigInteger();
    ...
    public java.security.spec.ECPoint getW() {
        return new java.security.spec.ECPoint(this.f1203q.getAffineXCoord().toBigInteger(), this.f1203q.getAffineYCoord().toBigInteger());
    }

    public ECPoint getQ() {
        if (this.ecSpec == null) {
            return this.f1203q.getDetachedPoint();
        }
        return this.f1203q;
    }
    ...
    public String toString() {
        ...
        stringBuffer.append(this.f1203q.getAffineXCoord().toBigInteger().toString(16));
        stringBuffer.append(property);
        stringBuffer.append("            Y: ");
        stringBuffer.append(this.f1203q.getAffineYCoord().toBigInteger().toString(16));
        stringBuffer.append(property);

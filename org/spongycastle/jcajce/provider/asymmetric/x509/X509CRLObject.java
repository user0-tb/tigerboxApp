...
public class X509CRLObject extends X509CRL {
    ...
    /* renamed from: c */
    private CertificateList f1211c;
    ...
    private Set getExtensionOIDs(boolean z) {
        ...
        if (getVersion() != 2 || (extensions = this.f1211c.getTBSCertList().getExtensions()) == null) {
            return null;
        }
    ...
    public byte[] getExtensionValue(String str) {
        Extension extension;
        Extensions extensions = this.f1211c.getTBSCertList().getExtensions();
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f1211c.getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
    ...
    public void verify(PublicKey publicKey, String str) throws CRLException, NoSuchAlgorithmException, InvalidKeyException, NoSuchProviderException, SignatureException {
        Signature signature;
        if (this.f1211c.getSignatureAlgorithm().equals(this.f1211c.getTBSCertList().getSignature())) {
            if (str != null) {
    ...
    public int getVersion() {
        return this.f1211c.getVersionNumber();
    }

    public Principal getIssuerDN() {
        return new X509Principal(X500Name.getInstance(this.f1211c.getIssuer().toASN1Primitive()));
    }

    public X500Principal getIssuerX500Principal() {
        try {
            return new X500Principal(this.f1211c.getIssuer().getEncoded());
    ...
    public Date getThisUpdate() {
        return this.f1211c.getThisUpdate().getDate();
    }

    public Date getNextUpdate() {
        if (this.f1211c.getNextUpdate() != null) {
            return this.f1211c.getNextUpdate().getDate();
        }
        return null;
    }
    ...
    private Set loadCRLEntries() {
        Extension extension;
        HashSet hashSet = new HashSet();
        Enumeration revokedCertificateEnumeration = this.f1211c.getRevokedCertificateEnumeration();
    ...
    public byte[] getTBSCertList() throws CRLException {
        try {
            return this.f1211c.getTBSCertList().getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
            throw new CRLException(e.toString());
        }
    }
    ...
    public byte[] getSignature() {
        return this.f1211c.getSignature().getBytes();
    }
    ...
    public String getSigAlgOID() {
        return this.f1211c.getSignatureAlgorithm().getAlgorithm().getId();
    }
    ...
    public boolean isRevoked(Certificate certificate) {
        ...
        if (certificate.getType().equals("X.509")) {
            Enumeration revokedCertificateEnumeration = this.f1211c.getRevokedCertificateEnumeration();
            X500Name issuer = this.f1211c.getIssuer();
    ...
    public boolean equals(Object obj) {
        ...
        if (!this.isHashCodeSet || !x509CRLObject.isHashCodeSet || x509CRLObject.hashCodeValue == this.hashCodeValue) {
            return this.f1211c.equals(x509CRLObject.f1211c);
        }
        return false;
    }

...
public final class RC2 {
    ...
    public static class AlgParams extends BaseAlgorithmParameters {
        ...
        public byte[] engineGetEncoded() {
            return Arrays.clone(this.f1216iv);
        }
        ...
        public AlgorithmParameterSpec localEngineGetParameterSpec(Class cls) throws InvalidParameterSpecException {
            ...
            if (cls != RC2ParameterSpec.class || (i = this.parameterVersion) == -1) {
                if (cls == IvParameterSpec.class) {
                    return new IvParameterSpec(this.f1216iv);
                }
                throw new InvalidParameterSpecException("unknown parameter spec passed to RC2 parameters object.");
            } else if (i < 256) {
                return new RC2ParameterSpec(ekb[this.parameterVersion], this.f1216iv);
            } else {
                return new RC2ParameterSpec(this.parameterVersion, this.f1216iv);
            }
        }
        ...
        public void engineInit(AlgorithmParameterSpec algorithmParameterSpec) throws InvalidParameterSpecException {
            if (algorithmParameterSpec instanceof IvParameterSpec) {
                this.f1216iv = ((IvParameterSpec) algorithmParameterSpec).getIV();
                ...
                this.f1216iv = rC2ParameterSpec.getIV();
            } else {
        ...
        public void engineInit(byte[] bArr) throws IOException {
            this.f1216iv = Arrays.clone(bArr);
        }

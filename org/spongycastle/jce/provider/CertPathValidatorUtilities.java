        ...
        if (extendedPKIXParameters.isAdditionalLocationsEnabled()) {
            try {
                if (str.startsWith("ldap://")) {
                    ...
                    String str3 = null;
                    if (substring.indexOf(DownloadsManager.FOLDERS_SEPARATOR) != -1) {
                        str3 = substring.substring(substring.indexOf(DownloadsManager.FOLDERS_SEPARATOR));
                        str2 = "ldap://" + substring.substring(0, substring.indexOf(DownloadsManager.FOLDERS_SEPARATOR));
                    } else {
                        str2 = "ldap://" + substring;
                    }

...
public class PKIXNameConstraintValidator {
    ...
    private Set intersectIPRange(byte[] bArr, byte[] bArr2) {
        ...
        return Collections.singleton(ipWithSubnetMask(m607or(minMaxIPs[0], minMaxIPs[2]), m607or(bArr4, bArr6)));
    }
    ...
    private boolean withinDomain(String str, String str2) {
        if (str2.startsWith(DownloadsManager.EXTENSION_SEPARATOR)) {
    ...
    private void unionEmail(String str, String str2, Set set) {
        if (str.indexOf(64) != -1) {
            ...
            if (str2.indexOf(64) != -1) {
                ...
                set.add(str);
                set.add(str2);
            } else if (str2.startsWith(DownloadsManager.EXTENSION_SEPARATOR)) {
        ...
        } else if (str.startsWith(DownloadsManager.EXTENSION_SEPARATOR)) {
            if (str2.indexOf(64) != -1) {
    ...
    /* renamed from: or */
    private static byte[] m607or(byte[] bArr, byte[] bArr2) {
    ...
    private String stringifyIP(byte[] bArr) {
        ...
        for (int i = 0; i < bArr.length / 2; i++) {
            str = str + Integer.toString(bArr[i] & 255) + DownloadsManager.EXTENSION_SEPARATOR;
        }
        String str2 = str.substring(0, str.length() - 1) + DownloadsManager.FOLDERS_SEPARATOR;
        for (int length = bArr.length / 2; length < bArr.length; length++) {
            str2 = str2 + Integer.toString(bArr[length] & 255) + DownloadsManager.EXTENSION_SEPARATOR;
        }

...
public class X509CRLEntryObject extends X509CRLEntry {
    ...
    private Set getExtensionOIDs(boolean z) {
        Extensions extensions = this.f1231c.getExtensions();
        if (extensions == null) {
            return null;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof X509CRLEntryObject) {
            return this.f1231c.equals(((X509CRLEntryObject) obj).f1231c);
        }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f1231c.getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
    ...
    public BigInteger getSerialNumber() {
        return this.f1231c.getUserCertificate().getValue();
    }

    public Date getRevocationDate() {
        return this.f1231c.getRevocationDate().getDate();
    }

    public boolean hasExtensions() {
        return this.f1231c.getExtensions() != null;
    }

...
public class BasicConstraints extends ASN1Object {
    ...
    private BasicConstraints(ASN1Sequence aSN1Sequence) {
        this.f727cA = ASN1Boolean.getInstance(false);
        ...
        if (aSN1Sequence.getObjectAt(0) instanceof ASN1Boolean) {
            this.f727cA = ASN1Boolean.getInstance((Object) aSN1Sequence.getObjectAt(0));
        } else {
            this.f727cA = null;
    ...
    public BasicConstraints(boolean z) {
        ...
        this.pathLenConstraint = null;
        if (z) {
            this.f727cA = ASN1Boolean.getInstance(true);
        } else {
            this.f727cA = null;
        }
        this.pathLenConstraint = null;
    ...
    public boolean isCA() {
        ASN1Boolean aSN1Boolean = this.f727cA;

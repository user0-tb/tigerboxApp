...
public class ECGOST3410NamedCurves {
    ...
    static {
        ...
        ECCurve.C3204Fp fp = new ECCurve.C3204Fp(bigInteger, new BigInteger("115792089237316195423570985008687907853269984665640564039457584007913129639316"), new BigInteger("166"), bigInteger2, ECConstants.ONE);
        hashtable2.put(CryptoProObjectIdentifiers.gostR3410_2001_CryptoPro_A, new ECDomainParameters(fp, fp.createPoint(new BigInteger(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE), new BigInteger("64033881142927202683649881450433473985931760268884941288852745803908878638612")), bigInteger2));
        ...
        ECCurve.C3204Fp fp2 = new ECCurve.C3204Fp(bigInteger3, bigInteger5, new BigInteger("166"), bigInteger4, ECConstants.ONE);
        hashtable2.put(CryptoProObjectIdentifiers.gostR3410_2001_CryptoPro_XchA, new ECDomainParameters(fp2, fp2.createPoint(new BigInteger(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE), new BigInteger("64033881142927202683649881450433473985931760268884941288852745803908878638612")), bigInteger4));
        ...
        ECCurve.C3204Fp fp3 = new ECCurve.C3204Fp(bigInteger6, new BigInteger("57896044618658097711785492504343953926634992332820282019728792003956564823190"), new BigInteger("28091019353058090096996979000309560759124368558014865957655842872397301267595"), bigInteger7, ECConstants.ONE);
        hashtable2.put(CryptoProObjectIdentifiers.gostR3410_2001_CryptoPro_B, new ECDomainParameters(fp3, fp3.createPoint(new BigInteger(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE), new BigInteger("28792665814854611296992347458380284135028636778229113005756334730996303888124")), bigInteger7));
        ...
        ECCurve.C3204Fp fp4 = new ECCurve.C3204Fp(bigInteger8, new BigInteger("70390085352083305199547718019018437841079516630045180471284346843705633502616"), new BigInteger("32858"), bigInteger9, ECConstants.ONE);
        hashtable2.put(CryptoProObjectIdentifiers.gostR3410_2001_CryptoPro_XchB, new ECDomainParameters(fp4, fp4.createPoint(new BigInteger(SessionDescription.SUPPORTED_SDP_VERSION), new BigInteger("29818893917731240733471273240314769927240550812383695689146495261604565990247")), bigInteger9));
        ...
        ECCurve.C3204Fp fp5 = new ECCurve.C3204Fp(bigInteger10, bigInteger12, new BigInteger("32858"), bigInteger11, ECConstants.ONE);
        hashtable2.put(CryptoProObjectIdentifiers.gostR3410_2001_CryptoPro_C, new ECDomainParameters(fp5, fp5.createPoint(new BigInteger(SessionDescription.SUPPORTED_SDP_VERSION), new BigInteger("29818893917731240733471273240314769927240550812383695689146495261604565990247")), bigInteger11));

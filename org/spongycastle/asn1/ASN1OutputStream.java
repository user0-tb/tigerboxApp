...
public class ASN1OutputStream {
    ...
    /* renamed from: os */
    private OutputStream f664os;

    public ASN1OutputStream(OutputStream outputStream) {
        this.f664os = outputStream;
    }
    ...
    public void write(byte[] bArr) throws IOException {
        this.f664os.write(bArr);
    }

    /* access modifiers changed from: package-private */
    public void write(byte[] bArr, int i, int i2) throws IOException {
        this.f664os.write(bArr, i, i2);
    }
    ...
    public void writeImplicitObject(ASN1Primitive aSN1Primitive) throws IOException {
        if (aSN1Primitive != null) {
            aSN1Primitive.encode(new ImplicitOutputStream(this.f664os));
            return;
        }
        throw new IOException("null object detected");
    }
    ...
    public ASN1OutputStream getDERSubStream() {
        return new DEROutputStream(this.f664os);
    }

    /* access modifiers changed from: package-private */
    public ASN1OutputStream getDLSubStream() {
        return new DLOutputStream(this.f664os);
    }

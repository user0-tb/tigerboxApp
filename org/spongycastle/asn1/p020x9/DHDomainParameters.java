...
public class DHDomainParameters extends ASN1Object {
    ...
    /* renamed from: g */
    private ASN1Integer f744g;

    /* renamed from: j */
    private ASN1Integer f745j;

    /* renamed from: p */
    private ASN1Integer f746p;

    /* renamed from: q */
    private ASN1Integer f747q;
    ...
    public DHDomainParameters(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4, DHValidationParms dHValidationParms) {
        if (bigInteger == null) {
            ...
            this.f746p = new ASN1Integer(bigInteger);
            this.f744g = new ASN1Integer(bigInteger2);
            this.f747q = new ASN1Integer(bigInteger3);
            this.f745j = new ASN1Integer(bigInteger4);
    ...
    public DHDomainParameters(ASN1Integer aSN1Integer, ASN1Integer aSN1Integer2, ASN1Integer aSN1Integer3, ASN1Integer aSN1Integer4, DHValidationParms dHValidationParms) {
        if (aSN1Integer == null) {
            ...
            this.f746p = aSN1Integer;
            this.f744g = aSN1Integer2;
            this.f747q = aSN1Integer3;
            this.f745j = aSN1Integer4;
            this.validationParms = dHValidationParms;
        } else {
            throw new IllegalArgumentException("'q' cannot be null");
        }
    ...
    private DHDomainParameters(ASN1Sequence aSN1Sequence) {
        ...
        this.f746p = ASN1Integer.getInstance(objects.nextElement());
        this.f744g = ASN1Integer.getInstance(objects.nextElement());
        this.f747q = ASN1Integer.getInstance(objects.nextElement());
        ASN1Encodable next = getNext(objects);
        if (next != null && (next instanceof ASN1Integer)) {
            this.f745j = ASN1Integer.getInstance(next);
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(this.f746p);
        aSN1EncodableVector.add(this.f744g);
        aSN1EncodableVector.add(this.f747q);
        ASN1Integer aSN1Integer = this.f745j;
        if (aSN1Integer != null) {

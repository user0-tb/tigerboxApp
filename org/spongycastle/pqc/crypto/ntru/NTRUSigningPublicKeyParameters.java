...
public class NTRUSigningPublicKeyParameters extends AsymmetricKeyParameter {
    ...
    /* renamed from: h */
    public IntegerPolynomial f1438h;
    ...
    public NTRUSigningPublicKeyParameters(byte[] bArr, NTRUSigningParameters nTRUSigningParameters) {
        super(false);
        this.f1438h = IntegerPolynomial.fromBinary(bArr, nTRUSigningParameters.f1430N, nTRUSigningParameters.f1435q);
        this.params = nTRUSigningParameters;
    }
    ...
    public NTRUSigningPublicKeyParameters(InputStream inputStream, NTRUSigningParameters nTRUSigningParameters) throws IOException {
        super(false);
        this.f1438h = IntegerPolynomial.fromBinary(inputStream, nTRUSigningParameters.f1430N, nTRUSigningParameters.f1435q);
        this.params = nTRUSigningParameters;
    }

    public byte[] getEncoded() {
        return this.f1438h.toBinary(this.params.f1435q);
    }
    ...
    public int hashCode() {
        IntegerPolynomial integerPolynomial = this.f1438h;
        int i = 0;
    ...
    public boolean equals(Object obj) {
        ...
        if (integerPolynomial == null) {
            if (nTRUSigningPublicKeyParameters.f1438h != null) {
                return false;
            }
        } else if (!integerPolynomial.equals(nTRUSigningPublicKeyParameters.f1438h)) {
            return false;
        }
        NTRUSigningParameters nTRUSigningParameters = this.params;
        if (nTRUSigningParameters == null) {

...
public class IndexGenerator {
    ...
    IndexGenerator(byte[] bArr, NTRUEncryptionParameters nTRUEncryptionParameters) {
        this.seed = bArr;
        this.f1400N = nTRUEncryptionParameters.f1409N;
        this.f1401c = nTRUEncryptionParameters.f1410c;
    ...
    public int nextIndex() {
        ...
        do {
            ...
            leadingAsInt = trailing.getLeadingAsInt(this.f1401c);
            i = this.f1401c;
            i2 = this.f1400N;

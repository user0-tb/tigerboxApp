...
public class ArrayEncoder {
    ...
    public static int[] decodeModQ(InputStream inputStream, int i, int i2) throws IOException {
        return decodeModQ(C3249Util.readFullLength(inputStream, (((31 - Integer.numberOfLeadingZeros(i2)) * i) + 7) / 8), i, i2);
    }
    ...
    public static int[] decodeMod3Tight(InputStream inputStream, int i) throws IOException {
        return decodeMod3Tight(C3249Util.readFullLength(inputStream, (int) Math.ceil(((((double) i) * Math.log(3.0d)) / Math.log(2.0d)) / 8.0d)), i);
    }

...
public class SparseTernaryPolynomial implements TernaryPolynomial {
    ...
    public SparseTernaryPolynomial(int[] iArr) {
        ...
        int i = 0;
        int i2 = 0;
        for (int i3 = 0; i3 < this.f1510N; i3++) {
            int i4 = iArr[i3];
            if (i4 == -1) {
                this.negOnes[i2] = i3;
                i2++;
    ...
    public static SparseTernaryPolynomial fromBinary(InputStream inputStream, int i, int i2, int i3) throws IOException {
        ...
        return new SparseTernaryPolynomial(i, ArrayEncoder.decodeModQ(C3249Util.readFullLength(inputStream, ((i2 * numberOfLeadingZeros) + 7) / 8), i2, 2048), ArrayEncoder.decodeModQ(C3249Util.readFullLength(inputStream, ((numberOfLeadingZeros * i3) + 7) / 8), i3, 2048));
    }

    public static SparseTernaryPolynomial generateRandom(int i, int i2, int i3, SecureRandom secureRandom) {
        return new SparseTernaryPolynomial(C3249Util.generateRandomTernary(i, i2, i3, secureRandom));
    }
    ...
    public int hashCode() {
        return ((((this.f1510N + 31) * 31) + Arrays.hashCode(this.negOnes)) * 31) + Arrays.hashCode(this.ones);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.f1510N == sparseTernaryPolynomial.f1510N && Arrays.areEqual(this.negOnes, sparseTernaryPolynomial.negOnes) && Arrays.areEqual(this.ones, sparseTernaryPolynomial.ones);
    }
}

...
public final class GoppaCode {
    ...
    public static class MaMaPe {
        ...
        /* renamed from: h */
        private GF2Matrix f1497h;

        /* renamed from: p */
        private Permutation f1498p;

        /* renamed from: s */
        private GF2Matrix f1499s;

        public MaMaPe(GF2Matrix gF2Matrix, GF2Matrix gF2Matrix2, Permutation permutation) {
            this.f1499s = gF2Matrix;
            this.f1497h = gF2Matrix2;
            this.f1498p = permutation;
        }
    ...
    public static class MatrixSet {
        ...
        /* renamed from: g */
        private GF2Matrix f1500g;
        private int[] setJ;

        public MatrixSet(GF2Matrix gF2Matrix, int[] iArr) {
            this.f1500g = gF2Matrix;
            this.setJ = iArr;
        }

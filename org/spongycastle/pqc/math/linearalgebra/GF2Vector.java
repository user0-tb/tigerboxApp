...
public class GF2Vector extends Vector {
    ...
    public GF2Vector(int i, SecureRandom secureRandom) {
        this.length = i;
        int i2 = (i + 31) >> 5;
        this.f1494v = new int[i2];
        int i3 = i2 - 1;
        for (int i4 = i3; i4 >= 0; i4--) {
            this.f1494v[i4] = secureRandom.nextInt();
        }
        int i5 = i & 31;
        if (i5 != 0) {
            int[] iArr = this.f1494v;
    ...
    public GF2Vector(GF2Vector gF2Vector) {
        ...
        this.f1494v = IntUtils.clone(gF2Vector.f1494v);
    }
    ...
    public byte[] getEncoded() {
        return LittleEndianConversions.toByteArray(this.f1494v, (this.length + 7) >> 3);
    }
    ...
    public boolean isZero() {
        for (int length = this.f1494v.length - 1; length >= 0; length--) {
            if (this.f1494v[length] != 0) {
                return false;
            }
        }
        return true;
    ...
    public Vector add(Vector vector) {
        if (vector instanceof GF2Vector) {
            ...
            if (this.length == gF2Vector.length) {
                int[] clone = IntUtils.clone(gF2Vector.f1494v);
                for (int length = clone.length - 1; length >= 0; length--) {
                    clone[length] = clone[length] ^ this.f1494v[length];
                }
    ...
    public Vector multiply(Permutation permutation) {
        ...
        if (this.length == vector.length) {
            ...
            for (int i = 0; i < vector.length; i++) {
                if ((this.f1494v[vector[i] >> 5] & (1 << (vector[i] & 31))) != 0) {
                    int[] iArr = gF2Vector.f1494v;
                    int i2 = i >> 5;
                    iArr[i2] = (1 << (i & 31)) | iArr[i2];
                }
            }
    ...
    public GF2Vector extractVector(int[] iArr) {
        ...
        if (iArr[length - 1] <= this.length) {
            ...
            for (int i = 0; i < length; i++) {
                if ((this.f1494v[iArr[i] >> 5] & (1 << (iArr[i] & 31))) != 0) {
                    int[] iArr2 = gF2Vector.f1494v;
                    int i2 = i >> 5;
    ...
    public GF2Vector extractLeftVector(int i) {
        if (i > this.length) {
            ...
            int i2 = i >> 5;
            int i3 = i & 31;
            System.arraycopy(this.f1494v, 0, gF2Vector.f1494v, 0, i2);
            if (i3 != 0) {
                gF2Vector.f1494v[i2] = ((1 << i3) - 1) & this.f1494v[i2];
            }
            return gF2Vector;
        }
    }
        ...
        if (i > this.length) {
            ...
            if (i4 != 0) {
                while (true) {
                    ...
                    int[] iArr = gF2Vector.f1494v;
                    int[] iArr2 = this.f1494v;
                    int i7 = i3 + 1;
                    iArr[i6] = (iArr2[i3] >>> i4) | (iArr2[i7] << (32 - i4));
                    i6++;
                    i3 = i7;
                }
                int[] iArr3 = gF2Vector.f1494v;
                int[] iArr4 = this.f1494v;
                int i8 = i3 + 1;
                ...
                System.arraycopy(this.f1494v, i3, gF2Vector.f1494v, 0, i5);
            }
            return gF2Vector;
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.length != gF2Vector.length || !IntUtils.equals(this.f1494v, gF2Vector.f1494v)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (this.length * 31) + this.f1494v.hashCode();
    }

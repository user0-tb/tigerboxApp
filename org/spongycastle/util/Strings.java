...
public final class Strings {
    public static String fromUTF8ByteArray(byte[] bArr) {
        ...
        while (i2 < bArr.length) {
            if ((bArr[i2] & 240) == 240) {
                int i6 = (((((bArr[i2] & 3) << Ascii.DC2) | ((bArr[i2 + 1] & Utf8.REPLACEMENT_BYTE) << Ascii.f271FF)) | ((bArr[i2 + 2] & Utf8.REPLACEMENT_BYTE) << 6)) | (bArr[i2 + 3] & Utf8.REPLACEMENT_BYTE)) - 65536;
                ...
                c = (char) (((bArr[i2] & Ascii.f278SI) << Ascii.f271FF) | ((bArr[i2 + 1] & Utf8.REPLACEMENT_BYTE) << 6) | (bArr[i2 + 2] & Utf8.REPLACEMENT_BYTE));
                i2 += 3;
            } else {
                if ((bArr[i2] & 208) == 208) {
                    i = (bArr[i2] & Ascii.f281US) << 6;
                    b = bArr[i2 + 1];

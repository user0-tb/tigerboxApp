...
public class PGPCFBBlockCipher implements BlockCipher {
    ...
    /* renamed from: FR */
    private byte[] f1098FR;
    private byte[] FRE;

    /* renamed from: IV */
    private byte[] f1099IV;
    ...
    public PGPCFBBlockCipher(BlockCipher blockCipher, boolean z) {
        ...
        this.f1099IV = new byte[blockSize2];
        this.f1098FR = new byte[blockSize2];
    ...
    public void reset() {
        ...
        int i = 0;
        while (true) {
            byte[] bArr = this.f1098FR;
            if (i != bArr.length) {
                if (this.inlineIv) {
                    bArr[i] = 0;
                } else {
                    bArr[i] = this.f1099IV[i];
                }
                i++;
            } else {
                this.cipher.reset();
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (cipherParameters instanceof ParametersWithIV) {
            ...
            byte[] bArr = this.f1099IV;
            if (length < bArr.length) {
                System.arraycopy(iv, 0, bArr, bArr.length - iv.length, iv.length);
                int i = 0;
                while (true) {
                    byte[] bArr2 = this.f1099IV;
            ...
            if (i6 != 0) {
                if (i6 >= i5 + 2) {
                    if (i5 + i2 <= bArr2.length) {
                        this.cipher.processBlock(this.f1098FR, 0, this.FRE, 0);
                        int i7 = 0;
                        while (true) {
                            i3 = this.blockSize;
                            if (i7 >= i3) {
                        ...
                        System.arraycopy(bArr2, i2, this.f1098FR, 0, i3);
                    } else {
                ...
                while (true) {
                    ...
                    bArr2[i2 + i8] = encryptByte(this.f1099IV[i8], i8);
                    i8++;
                }
                System.arraycopy(bArr2, i2, this.f1098FR, 0, i4);
                this.cipher.processBlock(this.f1098FR, 0, this.FRE, 0);
                int i9 = this.blockSize;
                bArr2[i2 + i9] = encryptByte(this.f1099IV[i9 - 2], 0);
                int i10 = this.blockSize;
                bArr2[i2 + i10 + 1] = encryptByte(this.f1099IV[i10 - 1], 1);
                System.arraycopy(bArr2, i2 + 2, this.f1098FR, 0, this.blockSize);
                this.cipher.processBlock(this.f1098FR, 0, this.FRE, 0);
                int i11 = 0;
                while (true) {
                    ...
                    if (i11 < i12) {
                        ...
                        System.arraycopy(bArr2, i2 + i12 + 2, this.f1098FR, 0, i12);
                        int i13 = this.count;
            ...
            if (i5 == 0) {
                ...
                while (true) {
                    ...
                    if (i8 < i9 - 2) {
                        ...
                        System.arraycopy(this.tmp, 2, this.f1098FR, 0, i9 - 2);
                        this.count += 2;
                ...
                if (i5 >= i4 + 2) {
                    ...
                    System.arraycopy(this.tmp, 0, this.f1098FR, this.blockSize - 2, 2);
                    this.cipher.processBlock(this.f1098FR, 0, this.FRE, 0);
                    int i10 = 0;
                    while (true) {
                        i3 = this.blockSize;
                    ...
                    System.arraycopy(this.tmp, 2, this.f1098FR, 0, i3 - 2);
                }
                return this.blockSize;
            }
        } else {

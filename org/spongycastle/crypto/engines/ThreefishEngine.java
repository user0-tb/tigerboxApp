...
public class ThreefishEngine implements BlockCipher {
    ...
    private void setKey(long[] jArr) {
        if (jArr.length == this.blocksizeWords) {
            ...
            while (true) {
                ...
                if (i < i2) {
                    long[] jArr2 = this.f1020kw;
                    jArr2[i] = jArr[i];
                    j ^= jArr2[i];
                    i++;
                } else {
                    long[] jArr3 = this.f1020kw;
                    jArr3[i2] = j;
    ...
    private static abstract class ThreefishCipher {
        ...
        /* renamed from: kw */
        protected final long[] f1022kw;

        /* renamed from: t */
        protected final long[] f1023t;
    ...
    private static final class Threefish256Cipher extends ThreefishCipher {
        ...
        public void encryptBlock(long[] jArr, long[] jArr2) {
            long[] jArr3 = this.f1022kw;
            long[] jArr4 = this.f1023t;

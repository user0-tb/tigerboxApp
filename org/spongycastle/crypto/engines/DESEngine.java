...
public class DESEngine implements BlockCipher {
    ...
    private static final int[] SP3 = {520, 134349312, 0, 134348808, 134218240, 0, 131592, 134218240, 131080, 134217736, 134217736, 131072, 134349320, 131080, 134348800, 520, C0963C.BUFFER_FLAG_FIRST_SAMPLE, 8, 134349312, 512, 131584, 134348800, 134348808, 131592, 134218248, 131584, 131072, 134218248, 8, 134349320, 512, C0963C.BUFFER_FLAG_FIRST_SAMPLE, 134349312, C0963C.BUFFER_FLAG_FIRST_SAMPLE, 131080, 520, 131072, 134349312, 134218240, 0, 512, 131080, 134349320, 134218240, 134217736, 512, 0, 134348808, 134218248, 131072, C0963C.BUFFER_FLAG_FIRST_SAMPLE, 134349320, 8, 131592, 131584, 134217736, 134348800, 134218248, 520, 134348800, 131592, 8, 134348808, 131584};
    ...
    private static final byte[] pc1 = {56, 48, 40, 32, Ascii.CAN, 16, 8, 0, 57, 49, 41, 33, Ascii.f270EM, 17, 9, 1, 58, 50, 42, 34, Ascii.SUB, Ascii.DC2, 10, 2, 59, 51, 43, 35, 62, 54, 46, 38, Ascii.f277RS, Ascii.SYN, Ascii.f279SO, 6, 61, 53, 45, 37, Ascii.f273GS, Ascii.NAK, Ascii.f269CR, 5, 60, 52, 44, 36, Ascii.f272FS, Ascii.DC4, Ascii.f271FF, 4, Ascii.ESC, 19, Ascii.f282VT, 3};
    private static final byte[] pc2 = {Ascii.f269CR, 16, 10, Ascii.ETB, 0, 4, 2, Ascii.ESC, Ascii.f279SO, 5, Ascii.DC4, 9, Ascii.SYN, Ascii.DC2, Ascii.f282VT, 3, Ascii.f270EM, 7, Ascii.f278SI, 6, Ascii.SUB, 19, Ascii.f271FF, 1, 40, 51, Ascii.f277RS, 36, 46, 54, Ascii.f273GS, 39, 50, 44, 32, 47, 43, 48, 38, 55, 33, 52, 45, 41, 49, 35, Ascii.f272FS, Ascii.f281US};
    private static final byte[] totrot = {1, 2, 4, 6, 8, 10, Ascii.f271FF, Ascii.f279SO, Ascii.f278SI, 17, 19, Ascii.NAK, Ascii.ETB, Ascii.f270EM, Ascii.ESC, Ascii.f272FS};
    ...
    public void desFunc(int[] iArr, byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        byte b13 = b10 ^ b12;
        byte b14 = b11 ^ (b12 << 8);
        byte b15 = (((b14 >>> Ascii.f281US) & 1) | (b14 << 1)) & -1;
        byte b16 = (b13 ^ b15) & -1431655766;
        byte b17 = b13 ^ b16;
        byte b18 = b15 ^ b16;
        int i3 = (((b17 >>> Ascii.f281US) & 1) | (b17 << 1)) & -1;
        for (int i4 = 0; i4 < 8; i4++) {
            int i5 = i4 * 4;
            int i6 = ((b18 << Ascii.f272FS) | (b18 >>> 4)) ^ iArr[i5 + 0];
            int[] iArr2 = SP7;
            int i7 = iArr2[i6 & 63];
            int[] iArr3 = SP5;
        ...
        int i17 = (b18 >>> 1) | (b18 << Ascii.f281US);

...
public class CamelliaEngine implements BlockCipher {
    ...
    /* renamed from: ke */
    private int[] f973ke = new int[12];

    /* renamed from: kw */
    private int[] f974kw = new int[8];
    ...
    private void setKey(boolean z, byte[] bArr) {
        ...
        if (!this._keyIs128) {
            ...
            roldqo32(51, iArr3, 0, this.f974kw, 0);
        } else if (z) {
            int[] iArr11 = this.f974kw;
            iArr11[0] = iArr[0];
            iArr11[1] = iArr[1];
            iArr11[2] = iArr[2];
            iArr11[3] = iArr[3];
            ...
            roldq(15, iArr2, 0, this.f973ke, 0);
            ...
            roldq(17, iArr2, 0, this.f974kw, 4);
        } else {
            int[] iArr15 = this.f974kw;
            iArr15[4] = iArr[0];
            iArr15[5] = iArr[1];
            iArr15[6] = iArr[2];
            iArr15[7] = iArr[3];
            ...
            iArr16[16] = iArr4[0];
            iArr16[17] = iArr4[1];
            decroldq(17, iArr, 0, this.f973ke, 0);
            ...
            decroldq(15, iArr2, 0, this.f973ke, 4);
            ...
            roldq(17, iArr2, 0, this.f974kw, 0);
        }
    }
    ...
    private int processBlock192or256(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        camelliaF2(this.state, this.subkey, 28);
        camelliaF2(this.state, this.subkey, 32);
        camelliaFLs(this.state, this.f973ke, 8);

...
public class RC532Engine implements BlockCipher {
    ...
    private void setKey(byte[] bArr) {
        ...
        for (int i9 = 0; i9 < i; i9++) {
            int[] iArr4 = this.f998_S;
            i6 = rotateLeft(iArr4[i5] + i6 + i7, 3);
            iArr4[i5] = i6;
            i7 = rotateLeft(iArr2[i8] + i6 + i7, i7 + i6);
            iArr2[i8] = i7;
            i5 = (i5 + 1) % this.f998_S.length;
            i8 = (i8 + 1) % length;
        }
    }

    private int encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        int bytesToWord = bytesToWord(bArr, i) + this.f998_S[0];
        int bytesToWord2 = bytesToWord(bArr, i + 4) + this.f998_S[1];
        for (int i3 = 1; i3 <= this._noRounds; i3++) {
            int i4 = i3 * 2;
            bytesToWord = rotateLeft(bytesToWord ^ bytesToWord2, bytesToWord2) + this.f998_S[i4];
            bytesToWord2 = rotateLeft(bytesToWord2 ^ bytesToWord, bytesToWord) + this.f998_S[i4 + 1];
        }
    ...
    private int decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        for (int i3 = this._noRounds; i3 >= 1; i3--) {
            int i4 = i3 * 2;
            bytesToWord2 = rotateRight(bytesToWord2 - this.f998_S[i4 + 1], bytesToWord) ^ bytesToWord;
            bytesToWord = rotateRight(bytesToWord - this.f998_S[i4], bytesToWord2) ^ bytesToWord2;
        }
        wordToBytes(bytesToWord - this.f998_S[0], bArr2, i2);
        wordToBytes(bytesToWord2 - this.f998_S[1], bArr2, i2 + 4);
        return 8;
    }

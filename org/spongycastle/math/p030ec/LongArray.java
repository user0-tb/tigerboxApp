...
class LongArray {
    ...
    private static int bitLength(long r3) {
        ...
        L_0x002e:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.spongycastle.math.p030ec.LongArray.bitLength(long):int");
    }
    ...
    private static long interleave2_32to64(int i) {
        ...
        return (((long) i2) & 4294967295L) | ((((long) ((iArr[i >>> 24] << 16) | i3)) & 4294967295L) << 32);
    }

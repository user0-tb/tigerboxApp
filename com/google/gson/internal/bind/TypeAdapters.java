...
public final class TypeAdapters {
    ...
    public static final TypeAdapterFactory ENUM_FACTORY = new TypeAdapterFactory() {
        ...
        public <T> com.google.gson.TypeAdapter<T> create(com.google.gson.Gson r1, com.google.gson.reflect.TypeToken<T> r2) {
            ...
            L_0x0021:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.TypeAdapters.C251328.create(com.google.gson.Gson, com.google.gson.reflect.TypeToken):com.google.gson.TypeAdapter");
        }
    };
    ...
    static {
        ...
        TypeAdapter<BitSet> nullSafe2 = new TypeAdapter<BitSet>() {
            ...
            public java.util.BitSet read(com.google.gson.stream.JsonReader r8) throws java.io.IOException {
                ...
                L_0x000e:
                    ...
                    int[] r4 = com.google.gson.internal.bind.TypeAdapters.C252134.$SwitchMap$com$google$gson$stream$JsonToken
                    int r5 = r1.ordinal()
                    r4 = r4[r5]
                    r5 = 1
                ...
                L_0x0075:
                    ...
                    return r0
                */
                throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.TypeAdapters.C25042.read(com.google.gson.stream.JsonReader):java.util.BitSet");
            }
        ...
        C25153 r0 = new TypeAdapter<Boolean>() {
            public Boolean read(JsonReader jsonReader) throws IOException {
        ...
        C25235 r02 = new TypeAdapter<Number>() {
            public Number read(JsonReader jsonReader) throws IOException {
                if (jsonReader.peek() == JsonToken.NULL) {
                    jsonReader.nextNull();
                    return null;
        ...
        C25246 r03 = new TypeAdapter<Number>() {
            public Number read(JsonReader jsonReader) throws IOException {
                if (jsonReader.peek() == JsonToken.NULL) {
                    jsonReader.nextNull();
                    return null;
        ...
        C25257 r04 = new TypeAdapter<Number>() {
            public Number read(JsonReader jsonReader) throws IOException {
                if (jsonReader.peek() == JsonToken.NULL) {
                    jsonReader.nextNull();
                    return null;
        ...
        C249814 r05 = new TypeAdapter<Character>() {
        ...
        C249915 r06 = new TypeAdapter<String>() {
        ...
        C250218 r07 = new TypeAdapter<StringBuilder>() {
        ...
        C250319 r08 = new TypeAdapter<StringBuffer>() {
        ...
        C250520 r09 = new TypeAdapter<URL>() {
        ...
        C250621 r010 = new TypeAdapter<URI>() {
        ...
        C250722 r011 = new TypeAdapter<InetAddress>() {
        ...
        C250823 r012 = new TypeAdapter<UUID>() {
        ...
        C251025 r013 = new TypeAdapter<Calendar>() {
        ...
        C251126 r014 = new TypeAdapter<Locale>() {
        ...
        C251227 r015 = new TypeAdapter<JsonElement>() {
            public JsonElement read(JsonReader jsonReader) throws IOException {
                if (jsonReader instanceof JsonTreeReader) {
                    return ((JsonTreeReader) jsonReader).nextJsonElement();
                }
                switch (C252134.$SwitchMap$com$google$gson$stream$JsonToken[jsonReader.peek().ordinal()]) {
                    case 1:
    ...
    static /* synthetic */ class C252134 {
        ...
        static {
            ...
            L_0x0078:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.TypeAdapters.C252134.<clinit>():void");
        }
    }

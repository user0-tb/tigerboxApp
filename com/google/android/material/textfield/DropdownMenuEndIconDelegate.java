...
class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    public void initialize() {
        int i;
        float dimensionPixelOffset = (float) this.context.getResources().getDimensionPixelOffset(C1241R.dimen.mtrl_shape_corner_size_small_component);
        float dimensionPixelOffset2 = (float) this.context.getResources().getDimensionPixelOffset(C1241R.dimen.mtrl_exposed_dropdown_menu_popup_elevation);
        int dimensionPixelOffset3 = this.context.getResources().getDimensionPixelOffset(C1241R.dimen.mtrl_exposed_dropdown_menu_popup_vertical_padding);
        ...
        if (this.customEndIcon == 0) {
            i = IS_LOLLIPOP ? C1241R.C1243drawable.mtrl_dropdown_arrow : C1241R.C1243drawable.mtrl_ic_arrow_drop_down;
        } else {
            i = this.customEndIcon;
        }
        this.textInputLayout.setEndIconDrawable(i);
        this.textInputLayout.setEndIconContentDescription(this.textInputLayout.getResources().getText(C1241R.string.exposed_dropdown_menu_content_description));
    ...
    public void addRippleEffect(AutoCompleteTextView autoCompleteTextView) {
        if (!isEditable(autoCompleteTextView)) {
            ...
            int color = MaterialColors.getColor(autoCompleteTextView, C1241R.attr.colorControlHighlight);
    ...
    private void addRippleEffectOnOutlinedLayout(AutoCompleteTextView autoCompleteTextView, int i, int[][] iArr, MaterialShapeDrawable materialShapeDrawable) {
        ...
        int color = MaterialColors.getColor(autoCompleteTextView, C1241R.attr.colorSurface);

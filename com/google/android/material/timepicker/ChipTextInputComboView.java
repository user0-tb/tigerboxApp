...
class ChipTextInputComboView extends FrameLayout implements Checkable {
    ...
    public ChipTextInputComboView(Context context, AttributeSet attributeSet, int i) {
        ...
        Chip chip2 = (Chip) from.inflate(C1241R.C1246layout.material_time_chip, this, false);
        this.chip = chip2;
        chip2.setAccessibilityClassName("android.view.View");
        TextInputLayout textInputLayout2 = (TextInputLayout) from.inflate(C1241R.C1246layout.material_time_input, this, false);
        ...
        this.label = (TextView) findViewById(C1241R.C1244id.material_label);

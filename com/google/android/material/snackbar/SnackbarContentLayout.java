...
public class SnackbarContentLayout extends LinearLayout implements ContentViewCallback {
    ...
    public void onFinishInflate() {
        ...
        this.messageView = (TextView) findViewById(C1241R.C1244id.snackbar_text);
        this.actionView = (Button) findViewById(C1241R.C1244id.snackbar_action);
    }
    ...
    public void updateActionTextColorAlphaIfNeeded(float f) {
        if (f != 1.0f) {
            this.actionView.setTextColor(MaterialColors.layer(MaterialColors.getColor(this, C1241R.attr.colorSurface), this.actionView.getCurrentTextColor(), f));
        }
    }
    ...
    public void onMeasure(int r8, int r9) {
        ...
        L_0x000b:
            ...
            int r2 = com.google.android.material.C1241R.dimen.design_snackbar_padding_vertical_2lines
            int r0 = r0.getDimensionPixelSize(r2)
            android.content.res.Resources r2 = r7.getResources()
            int r3 = com.google.android.material.C1241R.dimen.design_snackbar_padding_vertical

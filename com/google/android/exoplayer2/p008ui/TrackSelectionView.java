...
public class TrackSelectionView extends LinearLayout {
    ...
    public TrackSelectionView(Context context, AttributeSet attributeSet, int i) {
        ...
        checkedTextView.setText(C1187R.string.exo_track_selection_none);
        checkedTextView.setEnabled(false);
        checkedTextView.setFocusable(true);
        checkedTextView.setOnClickListener(componentListener2);
        checkedTextView.setVisibility(8);
        addView(checkedTextView);
        addView(from.inflate(C1187R.C1191layout.exo_list_divider, this, false));
        CheckedTextView checkedTextView2 = (CheckedTextView) from.inflate(17367055, this, false);
        this.defaultView = checkedTextView2;
        checkedTextView2.setBackgroundResource(resourceId);
        checkedTextView2.setText(C1187R.string.exo_track_selection_auto);
    ...
    private void updateViews() {
        ...
        for (int i = 0; i < this.trackGroups.size(); i++) {
            ...
            for (int i4 = 0; i4 < i2; i4++) {
                if (i4 == 0) {
                    addView(this.inflater.inflate(C1187R.C1191layout.exo_list_divider, this, false));
                }
        ...
        for (int i = 0; i < this.trackViews.length; i++) {
            ...
            while (true) {
                ...
                if (trackSelectionOverride != null) {
                    this.trackViews[i][i2].setChecked(trackSelectionOverride.trackIndices.contains(Integer.valueOf(((TrackInfo) Assertions.checkNotNull(checkedTextViewArr[i][i2].getTag())).trackIndex)));
                } else {
    ...
    private void onTrackViewClicked(View view) {
        ...
        if (trackSelectionOverride == null) {
            ...
            this.overrides.put(mediaTrackGroup, new TrackSelectionOverride(mediaTrackGroup, (List<Integer>) ImmutableList.m262of(Integer.valueOf(i))));
            return;
        }

...
public final class SubtitleView extends FrameLayout {
    ...
    private float getUserCaptionFontScale() {
        ...
        if (C1229Util.SDK_INT < 19 || isInEditMode() || (captioningManager = (CaptioningManager) getContext().getSystemService("captioning")) == null || !captioningManager.isEnabled()) {
            return 1.0f;
        }
    ...
    private CaptionStyleCompat getUserCaptionStyle() {
        if (C1229Util.SDK_INT < 19 || isInEditMode()) {

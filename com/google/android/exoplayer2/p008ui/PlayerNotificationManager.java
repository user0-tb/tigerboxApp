...
public class PlayerNotificationManager {
    ...
    private final Handler mainHandler = C1229Util.createHandler(Looper.getMainLooper(), new PlayerNotificationManager$$ExternalSyntheticLambda0(this));
    ...
    public static class Builder {
        ...
        public Builder(Context context2, int i, String str) {
            ...
            this.smallIconResourceId = C1187R.C1189drawable.exo_notification_small_icon;
            this.playActionIconResourceId = C1187R.C1189drawable.exo_notification_play;
            this.pauseActionIconResourceId = C1187R.C1189drawable.exo_notification_pause;
            this.stopActionIconResourceId = C1187R.C1189drawable.exo_notification_stop;
            this.rewindActionIconResourceId = C1187R.C1189drawable.exo_notification_rewind;
            this.fastForwardActionIconResourceId = C1187R.C1189drawable.exo_notification_fastforward;
            this.previousActionIconResourceId = C1187R.C1189drawable.exo_notification_previous;
            this.nextActionIconResourceId = C1187R.C1189drawable.exo_notification_next;
        }
    ...
    public final void setMediaSessionToken(MediaSessionCompat.Token token) {
        if (!C1229Util.areEqual(this.mediaSessionToken, token)) {
    ...
    private void startOrUpdateNotification(Player player2, Bitmap bitmap) {
        ...
        if (!this.isNotificationStarted) {
            C1229Util.registerReceiverNotExported(this.context, this.notificationBroadcastReceiver, this.intentFilter);
        }
        NotificationListener notificationListener2 = this.notificationListener;
    ...
    public NotificationCompat.Builder createNotification(Player player2, NotificationCompat.Builder builder2, boolean z, Bitmap bitmap) {
        ...
        if (player2.getPlaybackState() != 1 || !player2.isCommandAvailable(17) || !player2.getCurrentTimeline().isEmpty()) {
            ...
            if (C1229Util.SDK_INT < 21 || !this.useChronometer || !player2.isCommandAvailable(16) || !player2.isPlaying() || player2.isPlayingAd() || player2.isCurrentMediaItemDynamic() || player2.getPlaybackParameters().speed != 1.0f) {
    ...
    public int[] getActionIndicesForCompactView(java.util.List<java.lang.String> r7, com.google.android.exoplayer2.Player r8) {
        ...
        L_0x0062:
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.p008ui.PlayerNotificationManager.getActionIndicesForCompactView(java.util.List, com.google.android.exoplayer2.Player):int[]");
    }
    ...
    private static Map<String, NotificationCompat.Action> createPlaybackActions(Context context2, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        ...
        hashMap.put(ACTION_PLAY, new NotificationCompat.Action(i2, (CharSequence) context2.getString(C1187R.string.exo_controls_play_description), createBroadcastIntent(ACTION_PLAY, context2, i)));
        hashMap.put(ACTION_PAUSE, new NotificationCompat.Action(i3, (CharSequence) context2.getString(C1187R.string.exo_controls_pause_description), createBroadcastIntent(ACTION_PAUSE, context2, i)));
        hashMap.put(ACTION_STOP, new NotificationCompat.Action(i4, (CharSequence) context2.getString(C1187R.string.exo_controls_stop_description), createBroadcastIntent(ACTION_STOP, context2, i)));
        hashMap.put(ACTION_REWIND, new NotificationCompat.Action(i5, (CharSequence) context2.getString(C1187R.string.exo_controls_rewind_description), createBroadcastIntent(ACTION_REWIND, context2, i)));
        hashMap.put(ACTION_FAST_FORWARD, new NotificationCompat.Action(i6, (CharSequence) context2.getString(C1187R.string.exo_controls_fastforward_description), createBroadcastIntent(ACTION_FAST_FORWARD, context2, i)));
        hashMap.put(ACTION_PREVIOUS, new NotificationCompat.Action(i7, (CharSequence) context2.getString(C1187R.string.exo_controls_previous_description), createBroadcastIntent(ACTION_PREVIOUS, context2, i)));
        hashMap.put(ACTION_NEXT, new NotificationCompat.Action(i8, (CharSequence) context2.getString(C1187R.string.exo_controls_next_description), createBroadcastIntent(ACTION_NEXT, context2, i)));
        return hashMap;
    }
    ...
    private static PendingIntent createBroadcastIntent(String str, Context context2, int i) {
        ...
        return PendingIntent.getBroadcast(context2, i, intent, C1229Util.SDK_INT >= 23 ? 201326592 : C0963C.BUFFER_FLAG_FIRST_SAMPLE);
    }

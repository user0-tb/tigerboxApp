...
final class StyledPlayerControlViewLayoutManager {
    ...
    private final Runnable hideAllBarsRunnable = new StyledPlayerControlViewLayoutManager$$ExternalSyntheticLambda11(this);
    private final Runnable hideControllerRunnable = new StyledPlayerControlViewLayoutManager$$ExternalSyntheticLambda12(this);
    private final AnimatorSet hideMainBarAnimator;
    private final Runnable hideMainBarRunnable = new StyledPlayerControlViewLayoutManager$$ExternalSyntheticLambda2(this);
    private final AnimatorSet hideProgressBarAnimator;
    private final Runnable hideProgressBarRunnable = new StyledPlayerControlViewLayoutManager$$ExternalSyntheticLambda1(this);
    /* access modifiers changed from: private */
    ...
    private final View.OnLayoutChangeListener onLayoutChangeListener = new StyledPlayerControlViewLayoutManager$$ExternalSyntheticLambda8(this);
    ...
    /* access modifiers changed from: private */
    public final Runnable showAllBarsRunnable = new StyledPlayerControlViewLayoutManager$$ExternalSyntheticLambda3(this);
    ...
    public StyledPlayerControlViewLayoutManager(final StyledPlayerControlView styledPlayerControlView) {
        ...
        this.controlsBackground = styledPlayerControlView.findViewById(C1187R.C1190id.exo_controls_background);
        this.centerControls = (ViewGroup) styledPlayerControlView.findViewById(C1187R.C1190id.exo_center_controls);
        this.minimalControls = (ViewGroup) styledPlayerControlView.findViewById(C1187R.C1190id.exo_minimal_controls);
        ViewGroup viewGroup = (ViewGroup) styledPlayerControlView.findViewById(C1187R.C1190id.exo_bottom_bar);
        this.bottomBar = viewGroup;
        this.timeView = (ViewGroup) styledPlayerControlView.findViewById(C1187R.C1190id.exo_time);
        View findViewById = styledPlayerControlView.findViewById(C1187R.C1190id.exo_progress);
        this.timeBar = findViewById;
        this.basicControls = (ViewGroup) styledPlayerControlView.findViewById(C1187R.C1190id.exo_basic_controls);
        this.extraControls = (ViewGroup) styledPlayerControlView.findViewById(C1187R.C1190id.exo_extra_controls);
        this.extraControlsScrollView = (ViewGroup) styledPlayerControlView.findViewById(C1187R.C1190id.exo_extra_controls_scroll_view);
        View findViewById2 = styledPlayerControlView.findViewById(C1187R.C1190id.exo_overflow_show);
        this.overflowShowButton = findViewById2;
        View findViewById3 = styledPlayerControlView.findViewById(C1187R.C1190id.exo_overflow_hide);
        if (!(findViewById2 == null || findViewById3 == null)) {
            findViewById2.setOnClickListener(new StyledPlayerControlViewLayoutManager$$ExternalSyntheticLambda7(this));
            findViewById3.setOnClickListener(new StyledPlayerControlViewLayoutManager$$ExternalSyntheticLambda7(this));
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(new float[]{1.0f, 0.0f});
        ofFloat.setInterpolator(new LinearInterpolator());
        ofFloat.addUpdateListener(new StyledPlayerControlViewLayoutManager$$ExternalSyntheticLambda0(this));
        ...
        ofFloat2.addUpdateListener(new StyledPlayerControlViewLayoutManager$$ExternalSyntheticLambda4(this));
        ...
        float dimension = resources.getDimension(C1187R.dimen.exo_styled_bottom_bar_height) - resources.getDimension(C1187R.dimen.exo_styled_progress_bar_height);
        float dimension2 = resources.getDimension(C1187R.dimen.exo_styled_bottom_bar_height);
        ...
        ofFloat3.addUpdateListener(new StyledPlayerControlViewLayoutManager$$ExternalSyntheticLambda5(this));
        ...
        ofFloat4.addUpdateListener(new StyledPlayerControlViewLayoutManager$$ExternalSyntheticLambda6(this));
    ...
    public /* synthetic */ void mo19363x2808b27(ValueAnimator valueAnimator) {
    ...
    public /* synthetic */ void mo19364xe5ac3e68(ValueAnimator valueAnimator) {
        float floatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        View view = this.controlsBackground;
        if (view != null) {
            view.setAlpha(floatValue);
    ...
    public /* synthetic */ void mo19365xc8d7f1a9(ValueAnimator valueAnimator) {
    ...
    public /* synthetic */ void mo19366xac03a4ea(ValueAnimator valueAnimator) {
        animateOverflow(((Float) valueAnimator.getAnimatedValue()).floatValue());
    }
    ...
    public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        ...
        if (this.isMinimalMode != useMinimalMode) {
            ...
            view.post(new StyledPlayerControlViewLayoutManager$$ExternalSyntheticLambda9(this));
        }
        boolean z = i3 - i != i7 - i5;
        if (!this.isMinimalMode && z) {
            view.post(new StyledPlayerControlViewLayoutManager$$ExternalSyntheticLambda10(this));
        }
    }
    ...
    public void onOverflowButtonClick(View view) {
        resetHideCallbacks();
        if (view.getId() == C1187R.C1190id.exo_overflow_show) {
            this.overflowShowAnimator.start();
        } else if (view.getId() == C1187R.C1190id.exo_overflow_hide) {
    ...
    public void updateLayoutForSizeChange() {
        ...
        if (this.timeBar != null) {
            int dimensionPixelSize = this.playerControlView.getResources().getDimensionPixelSize(C1187R.dimen.exo_styled_progress_margin_bottom);
    ...
    private boolean shouldHideInMinimalMode(View view) {
        int id = view.getId();
        return id == C1187R.C1190id.exo_bottom_bar || id == C1187R.C1190id.exo_prev || id == C1187R.C1190id.exo_next || id == C1187R.C1190id.exo_rew || id == C1187R.C1190id.exo_rew_with_amount || id == C1187R.C1190id.exo_ffwd || id == C1187R.C1190id.exo_ffwd_with_amount;
    }

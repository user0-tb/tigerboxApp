...
final class SpannedToHtmlConverter {
    ...
    public static HtmlAndCss convert(CharSequence charSequence, float f) {
        if (charSequence == null) {
            return new HtmlAndCss("", ImmutableMap.m280of());
        }
        if (!(charSequence instanceof Spanned)) {
            return new HtmlAndCss(escapeHtml(charSequence), ImmutableMap.m280of());
        }
        ...
        for (Integer intValue : hashSet) {
            ...
            hashMap.put(HtmlUtils.cssAllClassDescendantsSelector("bg_" + intValue2), C1229Util.formatInvariant("background-color:%s;", HtmlUtils.toCssRgba(intValue2)));
        }
    ...
    private static String getOpeningTag(Object obj, float f) {
        ...
        if (obj instanceof ForegroundColorSpan) {
            return C1229Util.formatInvariant("<span style='color:%s;'>", HtmlUtils.toCssRgba(((ForegroundColorSpan) obj).getForegroundColor()));
        } else if (obj instanceof BackgroundColorSpan) {
            return C1229Util.formatInvariant("<span class='bg_%s'>", Integer.valueOf(((BackgroundColorSpan) obj).getBackgroundColor()));
            ...
            if (obj instanceof AbsoluteSizeSpan) {
                ...
                return C1229Util.formatInvariant("<span style='font-size:%.2fpx;'>", Float.valueOf(f2));
            } else if (obj instanceof RelativeSizeSpan) {
                return C1229Util.formatInvariant("<span style='font-size:%.2f%%;'>", Float.valueOf(((RelativeSizeSpan) obj).getSizeChange() * 100.0f));
            } else if (obj instanceof TypefaceSpan) {
                String family = ((TypefaceSpan) obj).getFamily();
                if (family == null) {
                    return null;
                }
                return C1229Util.formatInvariant("<span style='font-family:\"%s\";'>", family);
                ...
                return C1229Util.formatInvariant("<span style='-webkit-text-emphasis-style:%1$s;text-emphasis-style:%1$s;-webkit-text-emphasis-position:%2$s;text-emphasis-position:%2$s;display:inline-block;'>", getTextEmphasisStyle(textEmphasisSpan.markShape, textEmphasisSpan.markFill), getTextEmphasisPosition(textEmphasisSpan.position));
            }
        }
    }
    ...
    private static final class SpanInfo {
        /* access modifiers changed from: private */
        public static final Comparator<SpanInfo> FOR_CLOSING_TAGS = SpannedToHtmlConverter$SpanInfo$$ExternalSyntheticLambda1.INSTANCE;
        /* access modifiers changed from: private */
        public static final Comparator<SpanInfo> FOR_OPENING_TAGS = SpannedToHtmlConverter$SpanInfo$$ExternalSyntheticLambda0.INSTANCE;

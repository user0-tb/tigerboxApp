...
public final class Ac3Reader implements ElementaryStreamReader {
    ...
    public void consume(ParsableByteArray parsableByteArray) {
        ...
        while (parsableByteArray.bytesLeft() > 0) {
            ...
            if (i != 0) {
                ...
                this.state = 1;
                this.headerScratchBytes.getData()[0] = Ascii.f282VT;
    ...
    private void parseHeader() {
        ...
        if (this.format == null || parseAc3SyncframeInfo.channelCount != this.format.channelCount || parseAc3SyncframeInfo.sampleRate != this.format.sampleRate || !C1229Util.areEqual(parseAc3SyncframeInfo.mimeType, this.format.sampleMimeType)) {

...
public final class H263Reader implements ElementaryStreamReader {
        ...
        while (true) {
            ...
            if (nalUnitTargetBuffer != null) {
                ...
                if (this.userData.endNalUnit(i3)) {
                    ((ParsableByteArray) C1229Util.castNonNull(this.userDataParsable)).reset(this.userData.nalData, NalUnitUtil.unescapeStream(this.userData.nalData, this.userData.nalLength));
                    ((UserDataReader) C1229Util.castNonNull(this.userDataReader)).consume(this.pesTimeUs, this.userDataParsable);
                }
    ...
    private static Format parseCsdBuffer(CsdBuffer csdBuffer2, int i, String str) {
        ...
        if (readBits == 15) {
            ...
            if (readBits3 == 0) {
                Log.m157w(TAG, "Invalid aspect ratio");
            } else {
        ...
        if (parsableBitArray.readBits(2) != 0) {
            Log.m157w(TAG, "Unhandled video object layer shape");
        }
        parsableBitArray.skipBit();
        ...
        if (parsableBitArray.readBit()) {
            if (readBits4 == 0) {
                Log.m157w(TAG, "Invalid vop_increment_time_resolution");
            } else {
                int i2 = 0;
                ...
                if (i3 != 1) {
                    if (i3 != 2) {
                        if (i3 != 3) {
                            ...
                            Log.m157w(H263Reader.TAG, "Unexpected start code value");
                            reset();
                        } else {

...
public final class PsExtractor implements Extractor {
    ...
    public void seek(long j, long j2) {
        boolean z = true;
        boolean z2 = this.timestampAdjuster.getTimestampOffsetUs() == C0963C.TIME_UNSET;
        if (!z2) {
            long firstSampleTimestampUs = this.timestampAdjuster.getFirstSampleTimestampUs();
            if (firstSampleTimestampUs == C0963C.TIME_UNSET || firstSampleTimestampUs == 0 || firstSampleTimestampUs == j2) {
                z = false;
            }
            z2 = z;
        }

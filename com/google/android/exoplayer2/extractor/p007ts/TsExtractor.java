...
public final class TsExtractor implements Extractor {
    ...
    public void seek(long j, long j2) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            boolean z = timestampAdjuster.getTimestampOffsetUs() == C0963C.TIME_UNSET;
            if (!z) {
                long firstSampleTimestampUs = timestampAdjuster.getFirstSampleTimestampUs();
                z = (firstSampleTimestampUs == C0963C.TIME_UNSET || firstSampleTimestampUs == 0 || firstSampleTimestampUs == j2) ? false : true;
            }
            if (z) {
    ...
    private void maybeOutputSeekMap(long j) {
        if (!this.hasOutputSeekMap) {
            ...
            if (this.durationReader.getDurationUs() != C0963C.TIME_UNSET) {
            ...
            if (parsableByteArray.readUnsignedByte() == 2) {
                ...
                if ((parsableByteArray.readUnsignedByte() & 128) != 0) {
                    ...
                    if (TsExtractor.this.mode == 2 && TsExtractor.this.id3Reader == null) {
                        TsPayloadReader.EsInfo esInfo = new TsPayloadReader.EsInfo(21, (String) null, (List<TsPayloadReader.DvbSubtitleInfo>) null, C1229Util.EMPTY_BYTE_ARRAY);

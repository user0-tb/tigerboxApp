...
public final class GaplessInfoHolder {
    ...
    private boolean setFromComment(String str) {
        ...
        try {
            int parseInt = Integer.parseInt((String) C1229Util.castNonNull(matcher.group(1)), 16);
            int parseInt2 = Integer.parseInt((String) C1229Util.castNonNull(matcher.group(2)), 16);

...
public final class WavExtractor implements Extractor {
    ...
    private void skipToSampleData(ExtractorInput extractorInput) throws IOException {
        ...
        if (length != -1 && this.dataEndPosition > length) {
            Log.m157w(TAG, "Data exceeds input length: " + this.dataEndPosition + ", " + length);
    ...
    private static final class PassthroughOutputWriter implements OutputWriter {
        ...
        public boolean sampleData(ExtractorInput extractorInput, long j) throws IOException {
            ...
            if (i52 > 0) {
                ...
                this.trackOutput.sampleMetadata(this.startTimeUs + C1229Util.scaleLargeTimestamp(this.outputFrameCount, 1000000, (long) this.wavFormat.frameRateHz), 1, i6, i7, (TrackOutput.CryptoData) null);
    ...
    private static final class ImaAdPcmOutputWriter implements OutputWriter {
        ...
        private static final int[] STEP_TABLE = {7, 8, 9, 10, 11, 12, 13, 14, 16, 17, 19, 21, 23, 25, 28, 31, 34, 37, 41, 45, 50, 55, 60, 66, 73, 80, 88, 97, 107, 118, TsExtractor.TS_STREAM_TYPE_HDMV_DTS, CipherSuite.TLS_DHE_PSK_WITH_3DES_EDE_CBC_SHA, CipherSuite.TLS_RSA_WITH_AES_256_GCM_SHA384, CipherSuite.TLS_RSA_PSK_WITH_AES_256_GCM_SHA384, CipherSuite.TLS_DHE_RSA_WITH_CAMELLIA_128_CBC_SHA256, 209, 230, 253, 279, 307, 337, 371, HttpStatusCodesKt.HTTP_CLIENT_TIMEOUT, 449, 494, 544, 598, 658, 724, 796, 876, 963, 1060, 1166, 1282, 1411, 1552, 1707, 1878, 2066, 2272, 2499, 2749, 3024, 3327, 3660, 4026, 4428, 4871, 5358, 5894, 6484, 7132, 7845, 8630, 9493, 10442, 11487, 12635, 13899, 15289, 16818, 18500, 20350, 22385, 24623, 27086, 29794, 32767};
        ...
        public ImaAdPcmOutputWriter(ExtractorOutput extractorOutput2, TrackOutput trackOutput2, WavFormat wavFormat2) throws ParserException {
            ...
            if (readLittleEndianUnsignedShort == i2) {
                int ceilDivide = C1229Util.ceilDivide(max, readLittleEndianUnsignedShort);
        ...
        public boolean sampleData(com.google.android.exoplayer2.extractor.ExtractorInput r7, long r8) throws java.io.IOException {
            /*
                ...
                int r0 = com.google.android.exoplayer2.util.C1229Util.ceilDivide((int) r0, (int) r1)
        ...
        private void writeSampleMetadata(int i) {
            long scaleLargeTimestamp = this.startTimeUs + C1229Util.scaleLargeTimestamp(this.outputFrameCount, 1000000, (long) this.wavFormat.frameRateHz);
        ...
        private void decodeBlockForChannel(byte[] bArr, int i, int i2, byte[] bArr2) {
            ...
            for (int i11 = 0; i11 < i7 * 2; i11++) {
                ...
                int i12 = i11 % 2 == 0 ? b & Ascii.f278SI : b >> 4;
                int i13 = ((((i12 & 7) * 2) + 1) * i9) >> 3;
                if ((i12 & 8) != 0) {
                    i13 = -i13;
                }
                i8 = C1229Util.constrainValue(i8 + i13, -32768, 32767);
                i10 += i4 * 2;
                bArr2[i10] = (byte) (i8 & 255);
                bArr2[i10 + 1] = (byte) (i8 >> 8);
                int i14 = min + INDEX_TABLE[i12];
                int[] iArr = STEP_TABLE;
                min = C1229Util.constrainValue(i14, 0, iArr.length - 1);
                i9 = iArr[min];
            }
        }

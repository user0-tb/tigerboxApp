...
final class XingSeeker implements Seeker {
    ...
    public static XingSeeker create(long j, long j2, MpegAudioUtil.Header header, ParsableByteArray parsableByteArray) {
        ...
        long scaleLargeTimestamp = C1229Util.scaleLargeTimestamp((long) readUnsignedIntToInt, ((long) i) * 1000000, (long) i2);
        if ((readInt & 6) != 6) {
    ...
    public SeekMap.SeekPoints getSeekPoints(long j) {
        ...
        long constrainValue = C1229Util.constrainValue(j, 0, this.durationUs);
        ...
        return new SeekMap.SeekPoints(new SeekPoint(constrainValue, this.dataStartPosition + C1229Util.constrainValue(Math.round((d3 / 256.0d) * ((double) this.dataSize)), (long) this.xingFrameSize, this.dataSize - 1)));
    }
    ...
    public long getTimeUs(long j) {
        ...
        int binarySearchFloor = C1229Util.binarySearchFloor(jArr, (long) d, true, true);

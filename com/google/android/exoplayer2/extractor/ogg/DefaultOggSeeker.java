...
final class DefaultOggSeeker implements OggSeeker {
    ...
    public void startSeek(long j) {
        this.targetGranule = C1229Util.constrainValue(j, 0, this.totalGranules - 1);
        this.state = 2;
    ...
    private long getNextSeekPosition(ExtractorInput extractorInput) throws IOException {
        ...
        long j6 = this.end;
        long j7 = this.start;
        return C1229Util.constrainValue((extractorInput.getPosition() - j5) + ((j2 * (j6 - j7)) / (this.endGranule - this.startGranule)), j7, j6 - 1);
    }

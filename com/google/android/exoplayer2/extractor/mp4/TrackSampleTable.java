...
final class TrackSampleTable {
    ...
    public int getIndexOfEarlierOrEqualSynchronizationSample(long j) {
        for (int binarySearchFloor = C1229Util.binarySearchFloor(this.timestampsUs, j, true, false); binarySearchFloor >= 0; binarySearchFloor--) {
    ...
    public int getIndexOfLaterOrEqualSynchronizationSample(long j) {
        for (int binarySearchCeil = C1229Util.binarySearchCeil(this.timestampsUs, j, true, false); binarySearchCeil < this.timestampsUs.length; binarySearchCeil++) {

...
final class ChunkReader {
    ...
    public void seekToPosition(long j) {
        ...
        this.currentChunkIndex = this.keyFrameIndices[C1229Util.binarySearchFloor(this.keyFrameOffsets, j, true, true)];
    }

    public SeekMap.SeekPoints getSeekPoints(long j) {
        int frameDurationUs = (int) (j / getFrameDurationUs());
        int binarySearchFloor = C1229Util.binarySearchFloor(this.keyFrameIndices, frameDurationUs, true, true);

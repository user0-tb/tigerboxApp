...
final class AviStreamHeaderChunk implements AviChunk {
    ...
    public int getTrackType() {
        ...
        Log.m157w(TAG, "Found unsupported streamType fourCC: " + Integer.toHexString(this.streamType));
        return -1;
    }
    ...
    public long getDurationUs() {
        return C1229Util.scaleLargeTimestamp((long) this.length, ((long) this.scale) * 1000000, (long) this.rate);
    }
}

    ...
    public static boolean readMetadataBlock(ExtractorInput extractorInput, FlacStreamMetadataHolder flacStreamMetadataHolder) throws IOException {
        ...
        if (readBits == 0) {
            ...
            if (flacStreamMetadata == null) {
                ...
                flacStreamMetadataHolder.flacStreamMetadata = flacStreamMetadata.copyWithPictureFrames(ImmutableList.m262of(PictureFrame.fromPictureBlock(parsableByteArray)));
            } else {

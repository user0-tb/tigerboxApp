...
public final class AmrExtractor implements Extractor {
    ...
    private static final byte[] amrSignatureNb = C1229Util.getUtf8Bytes("#!AMR\n");
    private static final byte[] amrSignatureWb = C1229Util.getUtf8Bytes("#!AMR-WB\n");
    ...
    private void maybeOutputSeekMap(long j, int i) {
        ...
        if (!this.hasOutputSeekMap) {
            ...
            if ((i3 & 1) == 0 || j == -1 || !((i2 = this.firstSampleSize) == -1 || i2 == this.currentSampleSize)) {
                SeekMap.Unseekable unseekable = new SeekMap.Unseekable(C0963C.TIME_UNSET);

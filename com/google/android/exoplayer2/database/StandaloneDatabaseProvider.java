...
public class StandaloneDatabaseProvider extends SQLiteOpenHelper implements DatabaseProvider {
    ...
    private static void wipeDatabase(SQLiteDatabase sQLiteDatabase) {
        String str;
        Cursor query = sQLiteDatabase.query("sqlite_master", new String[]{SessionDescription.ATTR_TYPE, "name"}, (String) null, (String[]) null, (String) null, (String) null, (String) null);
        while (query.moveToNext()) {
            try {
                ...
                Log.m154e(TAG, "Error executing " + str, e);
            } catch (Throwable th) {
                if (query != null) {
                    try {
                        query.close();

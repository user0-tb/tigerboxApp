...
public abstract class BasePlayer implements Player {
    ...
    public final void setMediaItem(MediaItem mediaItem) {
        setMediaItems(ImmutableList.m262of(mediaItem));
    }

    public final void setMediaItem(MediaItem mediaItem, long j) {
        setMediaItems(ImmutableList.m262of(mediaItem), 0, j);
    }

    public final void setMediaItem(MediaItem mediaItem, boolean z) {
        setMediaItems(ImmutableList.m262of(mediaItem), z);
    }
    ...
    public final void addMediaItem(int i, MediaItem mediaItem) {
        addMediaItems(i, ImmutableList.m262of(mediaItem));
    }

    public final void addMediaItem(MediaItem mediaItem) {
        addMediaItems(ImmutableList.m262of(mediaItem));
    }
    ...
    public final int getBufferedPercentage() {
        ...
        if (bufferedPosition == C0963C.TIME_UNSET || duration == C0963C.TIME_UNSET) {
            return 0;
        }
        if (duration == 0) {
            return 100;
        }
        return C1229Util.constrainValue((int) ((bufferedPosition * 100) / duration), 0, 100);
    }
    ...
    public final long getCurrentLiveOffset() {
        Timeline currentTimeline = getCurrentTimeline();
        if (!currentTimeline.isEmpty() && currentTimeline.getWindow(getCurrentMediaItemIndex(), this.window).windowStartTimeMs != C0963C.TIME_UNSET) {
    ...
    private void seekToDefaultPositionInternal(int i, int i2) {
        seekTo(i, C0963C.TIME_UNSET, i2, false);
    }
    ...
    private void repeatCurrentMediaItem(int i) {
        seekTo(getCurrentMediaItemIndex(), C0963C.TIME_UNSET, i, true);
    }
}

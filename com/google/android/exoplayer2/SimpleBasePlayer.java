...
public abstract class SimpleBasePlayer extends BasePlayer {
    ...
    protected static final class State {
        ...
        public static final class Builder {
            ...
            public Builder() {
                ...
                this.maxSeekToPreviousPositionMs = C0963C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS;
                ...
                this.timedMetadata = new Metadata((long) C0963C.TIME_UNSET, new Metadata.Entry[0]);
                this.playlist = ImmutableList.m261of();
                ...
                this.contentPositionMsSupplier = PositionSupplier.CC.getConstant(C0963C.TIME_UNSET);
                this.adPositionMs = null;
                this.adPositionMsSupplier = PositionSupplier.ZERO;
                this.contentBufferedPositionMsSupplier = PositionSupplier.CC.getConstant(C0963C.TIME_UNSET);
        ...
        private State(Builder builder) {
            ...
            if (builder.contentPositionMs != null) {
                if (builder.currentAdGroupIndex == -1 && builder.playWhenReady && builder.playbackState == 3 && builder.playbackSuppressionReason == 0 && builder.contentPositionMs.longValue() != C0963C.TIME_UNSET) {
    ...
    protected static final class MediaItemData {
        ...
        public static final class Builder {
            ...
            public Builder(Object obj) {
                ...
                this.presentationStartTimeMs = C0963C.TIME_UNSET;
                this.windowStartTimeMs = C0963C.TIME_UNSET;
                this.elapsedRealtimeEpochOffsetMs = C0963C.TIME_UNSET;
                ...
                this.periods = ImmutableList.m261of();
            }
            ...
            public Builder setDurationUs(long j) {
                Assertions.checkArgument(j == C0963C.TIME_UNSET || j >= 0);
                this.durationUs = j;
                return this;
            }
            ...
            public Builder setPeriods(List<PeriodData> list) {
                ...
                int i = 0;
                while (i < size - 1) {
                    Assertions.checkArgument(list.get(i).durationUs != C0963C.TIME_UNSET, "Periods other than last need a duration");
                    int i2 = i + 1;
        ...
        private MediaItemData(Builder builder) {
            ...
            if (builder.liveConfiguration == null) {
                Assertions.checkArgument(builder.presentationStartTimeMs == C0963C.TIME_UNSET, "presentationStartTimeMs can only be set if liveConfiguration != null");
                Assertions.checkArgument(builder.windowStartTimeMs == C0963C.TIME_UNSET, "windowStartTimeMs can only be set if liveConfiguration != null");
                Assertions.checkArgument(builder.elapsedRealtimeEpochOffsetMs == C0963C.TIME_UNSET, "elapsedRealtimeEpochOffsetMs can only be set if liveConfiguration != null");
            } else if (!(builder.presentationStartTimeMs == C0963C.TIME_UNSET || builder.windowStartTimeMs == C0963C.TIME_UNSET)) {
            ...
            if (builder.durationUs != C0963C.TIME_UNSET) {
    ...
    protected interface PositionSupplier {
        ...
        public final /* synthetic */ class CC {
            ...
            public static PositionSupplier getConstant(long j) {
                return new SimpleBasePlayer$PositionSupplier$$ExternalSyntheticLambda0(j);
            }

            public static PositionSupplier getExtrapolating(long j, float f) {
                return new SimpleBasePlayer$PositionSupplier$$ExternalSyntheticLambda1(j, SystemClock.elapsedRealtime(), f);
            }
    ...
    protected SimpleBasePlayer(Looper looper, Clock clock) {
        ...
        this.listeners = new ListenerSet<>(looper, clock, new SimpleBasePlayer$$ExternalSyntheticLambda23(this));
    }

    /* renamed from: lambda$new$0$com-google-android-exoplayer2-SimpleBasePlayer  reason: not valid java name */
    public /* synthetic */ void m724lambda$new$0$comgoogleandroidexoplayer2SimpleBasePlayer(Player.Listener listener, FlagSet flagSet) {
        listener.onEvents(this, new Player.C0984Events(flagSet));
    }
    ...
    public final void setPlayWhenReady(boolean z) {
        ...
        if (shouldHandleCommand(1)) {
            updateStateForPendingOperation(handleSetPlayWhenReady(z), new SimpleBasePlayer$$ExternalSyntheticLambda44(state2, z));
        }
    }
    ...
    private void setMediaItemsInternal(List<MediaItem> list, int i, long j) {
        ...
        if (shouldHandleCommand(20) || (list.size() == 1 && shouldHandleCommand(31))) {
            updateStateForPendingOperation(handleSetMediaItems(list, i, j), new SimpleBasePlayer$$ExternalSyntheticLambda49(this, list, state2, i, j));
        }
    }

    /* renamed from: lambda$setMediaItemsInternal$2$com-google-android-exoplayer2-SimpleBasePlayer */
    public /* synthetic */ State mo16132xb80ed5ee(List list, State state2, int i, long j) {
    ...
    public final void addMediaItems(int i, List<MediaItem> list) {
        ...
        if (shouldHandleCommand(20) && !list.isEmpty()) {
            ...
            updateStateForPendingOperation(handleAddMediaItems(min, list), new SimpleBasePlayer$$ExternalSyntheticLambda48(this, state2, list, min));
        }
    }

    /* renamed from: lambda$addMediaItems$3$com-google-android-exoplayer2-SimpleBasePlayer */
    public /* synthetic */ State mo16128xc134386b(State state2, List list, int i) {
    ...
    public final void moveMediaItems(int i, int i2, int i3) {
        ...
        if (shouldHandleCommand(20) && size != 0 && i < size) {
            ...
            if (i != min && min2 != i) {
                updateStateForPendingOperation(handleMoveMediaItems(i, min, min2), new SimpleBasePlayer$$ExternalSyntheticLambda47(this, state2, i, min, min2));
            }
        }
    }

    /* renamed from: lambda$moveMediaItems$4$com-google-android-exoplayer2-SimpleBasePlayer */
    public /* synthetic */ State mo16129xfea097c0(State state2, int i, int i2, int i3) {
        ArrayList arrayList = new ArrayList(state2.playlist);
        C1229Util.moveItems(arrayList, i, i2, i3);
        return getStateWithNewPlaylist(state2, arrayList, this.period);
    }
    ...
    public final void removeMediaItems(int i, int i2) {
        ...
        if (shouldHandleCommand(20) && size != 0 && i < size && i != (min = Math.min(i2, size))) {
            updateStateForPendingOperation(handleRemoveMediaItems(i, min), new SimpleBasePlayer$$ExternalSyntheticLambda46(this, state2, i, min));
        }
    }

    /* renamed from: lambda$removeMediaItems$5$com-google-android-exoplayer2-SimpleBasePlayer */
    public /* synthetic */ State mo16131xc687f44c(State state2, int i, int i2) {
        ArrayList arrayList = new ArrayList(state2.playlist);
        C1229Util.removeRange(arrayList, i, i2);
        return getStateWithNewPlaylist(state2, arrayList, this.period);
    }
    ...
    public final void prepare() {
        ...
        if (shouldHandleCommand(2)) {
            updateStateForPendingOperation(handlePrepare(), new SimpleBasePlayer$$ExternalSyntheticLambda27(state2));
        }
    }
    ...
    public final void setShuffleModeEnabled(boolean z) {
        ...
        if (shouldHandleCommand(14)) {
            updateStateForPendingOperation(handleSetShuffleModeEnabled(z), new SimpleBasePlayer$$ExternalSyntheticLambda45(state2, z));
        }
    }
    ...
    public final void seekTo(int i, long j, int i2, boolean z) {
        ...
        if (shouldHandleCommand(i2) && !isPlayingAd()) {
            if (state2.playlist.isEmpty() || i < state2.playlist.size()) {
                updateStateForPendingOperation(handleSeek(i, j, i2), new SimpleBasePlayer$$ExternalSyntheticLambda35(state2, i, j), true, z);
            }
        }
    }
    ...
    public final void setPlaybackParameters(PlaybackParameters playbackParameters) {
        ...
        if (shouldHandleCommand(13)) {
            updateStateForPendingOperation(handleSetPlaybackParameters(playbackParameters), new SimpleBasePlayer$$ExternalSyntheticLambda39(state2, playbackParameters));
        }
    }
    ...
    public final void stop() {
        ...
        if (shouldHandleCommand(3)) {
            updateStateForPendingOperation(handleStop(), new SimpleBasePlayer$$ExternalSyntheticLambda30(state2));
        }
    }
    ...
    public final void release() {
        ...
        State state2 = this.state;
        if (!this.released) {
            updateStateForPendingOperation(handleRelease(), new SimpleBasePlayer$$ExternalSyntheticLambda28(state2));
            this.released = true;
    ...
    public final void setTrackSelectionParameters(TrackSelectionParameters trackSelectionParameters) {
        ...
        if (shouldHandleCommand(29)) {
            updateStateForPendingOperation(handleSetTrackSelectionParameters(trackSelectionParameters), new SimpleBasePlayer$$ExternalSyntheticLambda40(state2, trackSelectionParameters));
        }
    }
    ...
    public final void setPlaylistMetadata(MediaMetadata mediaMetadata) {
        ...
        if (shouldHandleCommand(19)) {
            updateStateForPendingOperation(handleSetPlaylistMetadata(mediaMetadata), new SimpleBasePlayer$$ExternalSyntheticLambda38(state2, mediaMetadata));
        }
    }
    ...
    public final long getDuration() {
        ...
        return C1229Util.usToMs(this.period.getAdDurationUs(this.state.currentAdGroupIndex, this.state.currentAdIndexInAdGroup));
    }
    ...
    public final void setVideoSurface(Surface surface) {
        ...
        if (shouldHandleCommand(27)) {
            if (surface == null) {
                ...
                updateStateForPendingOperation(handleSetVideoOutput(surface), new SimpleBasePlayer$$ExternalSyntheticLambda29(state2));
            }
        }
    }
    ...
    public final void setVideoSurfaceHolder(SurfaceHolder surfaceHolder) {
        ...
        if (shouldHandleCommand(27)) {
            if (surfaceHolder == null) {
                ...
                updateStateForPendingOperation(handleSetVideoOutput(surfaceHolder), new SimpleBasePlayer$$ExternalSyntheticLambda36(state2, surfaceHolder));
            }
        }
    }
    ...
    public final void setVideoSurfaceView(SurfaceView surfaceView) {
        ...
        if (shouldHandleCommand(27)) {
            if (surfaceView == null) {
                ...
                updateStateForPendingOperation(handleSetVideoOutput(surfaceView), new SimpleBasePlayer$$ExternalSyntheticLambda37(state2, surfaceView));
            }
        }
    }
    ...
    public final void setVideoTextureView(TextureView textureView) {
        ...
        if (shouldHandleCommand(27)) {
            ...
            updateStateForPendingOperation(handleSetVideoOutput(textureView), new SimpleBasePlayer$$ExternalSyntheticLambda41(state2, size));
        }
    }
    ...
    private void clearVideoOutput(Object obj) {
        ...
        State state2 = this.state;
        if (shouldHandleCommand(27)) {
            updateStateForPendingOperation(handleClearVideoOutput(obj), new SimpleBasePlayer$$ExternalSyntheticLambda24(state2));
        }
    }
    ...
    public final void setDeviceVolume(int i) {
        ...
        if (shouldHandleCommand(25)) {
            updateStateForPendingOperation(handleSetDeviceVolume(i), new SimpleBasePlayer$$ExternalSyntheticLambda33(state2, i));
        }
    }
    ...
    public final void increaseDeviceVolume() {
        ...
        if (shouldHandleCommand(26)) {
            updateStateForPendingOperation(handleIncreaseDeviceVolume(), new SimpleBasePlayer$$ExternalSyntheticLambda26(state2));
        }
    }
    ...
    public final void decreaseDeviceVolume() {
        ...
        State state2 = this.state;
        if (shouldHandleCommand(26)) {
            updateStateForPendingOperation(handleDecreaseDeviceVolume(), new SimpleBasePlayer$$ExternalSyntheticLambda25(state2));
        }
    }
    ...
    public final void setDeviceMuted(boolean z) {
        ...
        State state2 = this.state;
        if (shouldHandleCommand(26)) {
            updateStateForPendingOperation(handleSetDeviceMuted(z), new SimpleBasePlayer$$ExternalSyntheticLambda43(state2, z));
        }
    }
    ...
    private void updateStateAndInformListeners(State state2, boolean z, boolean z2) {
        ...
        if (z5) {
            this.listeners.queueEvent(0, new SimpleBasePlayer$$ExternalSyntheticLambda20(state3, getTimelineChangeReason(state4.playlist, state3.playlist)));
        }
        if (positionDiscontinuityReason != -1) {
            this.listeners.queueEvent(11, new SimpleBasePlayer$$ExternalSyntheticLambda0(positionDiscontinuityReason, getPositionInfo(state4, false, this.window, this.period), getPositionInfo(state3, state3.hasPositionDiscontinuity, this.window, this.period)));
        }
        if (mediaItemTransitionReason != -1) {
            ...
            this.listeners.queueEvent(1, new SimpleBasePlayer$$ExternalSyntheticLambda11(mediaItem, mediaItemTransitionReason));
        }
        if (!C1229Util.areEqual(state4.playerError, state3.playerError)) {
            this.listeners.queueEvent(10, new SimpleBasePlayer$$ExternalSyntheticLambda31(state3));
            if (state3.playerError != null) {
                this.listeners.queueEvent(10, new SimpleBasePlayer$$ExternalSyntheticLambda42(state3));
            }
        }
        if (!state4.trackSelectionParameters.equals(state3.trackSelectionParameters)) {
            this.listeners.queueEvent(19, new SimpleBasePlayer$$ExternalSyntheticLambda52(state3));
        }
        if (!currentTracksInternal.equals(currentTracksInternal2)) {
            this.listeners.queueEvent(2, new SimpleBasePlayer$$ExternalSyntheticLambda21(currentTracksInternal2));
        }
        if (!mediaMetadataInternal.equals(mediaMetadataInternal2)) {
            this.listeners.queueEvent(14, new SimpleBasePlayer$$ExternalSyntheticLambda22(mediaMetadataInternal2));
        }
        if (state4.isLoading != state3.isLoading) {
            this.listeners.queueEvent(3, new SimpleBasePlayer$$ExternalSyntheticLambda53(state3));
        }
        if (z3 || z4) {
            this.listeners.queueEvent(-1, new SimpleBasePlayer$$ExternalSyntheticLambda54(state3));
        }
        if (z4) {
            this.listeners.queueEvent(4, new SimpleBasePlayer$$ExternalSyntheticLambda55(state3));
        }
        if (z3 || state4.playWhenReadyChangeReason != state3.playWhenReadyChangeReason) {
            this.listeners.queueEvent(5, new SimpleBasePlayer$$ExternalSyntheticLambda56(state3));
        }
        if (state4.playbackSuppressionReason != state3.playbackSuppressionReason) {
            this.listeners.queueEvent(6, new SimpleBasePlayer$$ExternalSyntheticLambda1(state3));
        }
        if (isPlaying(state4) != isPlaying(state2)) {
            this.listeners.queueEvent(7, new SimpleBasePlayer$$ExternalSyntheticLambda2(state3));
        }
        if (!state4.playbackParameters.equals(state3.playbackParameters)) {
            this.listeners.queueEvent(12, new SimpleBasePlayer$$ExternalSyntheticLambda3(state3));
        }
        if (state4.repeatMode != state3.repeatMode) {
            this.listeners.queueEvent(8, new SimpleBasePlayer$$ExternalSyntheticLambda4(state3));
        }
        if (state4.shuffleModeEnabled != state3.shuffleModeEnabled) {
            this.listeners.queueEvent(9, new SimpleBasePlayer$$ExternalSyntheticLambda5(state3));
        }
        if (state4.seekBackIncrementMs != state3.seekBackIncrementMs) {
            this.listeners.queueEvent(16, new SimpleBasePlayer$$ExternalSyntheticLambda6(state3));
        }
        if (state4.seekForwardIncrementMs != state3.seekForwardIncrementMs) {
            this.listeners.queueEvent(17, new SimpleBasePlayer$$ExternalSyntheticLambda7(state3));
        }
        if (state4.maxSeekToPreviousPositionMs != state3.maxSeekToPreviousPositionMs) {
            this.listeners.queueEvent(18, new SimpleBasePlayer$$ExternalSyntheticLambda8(state3));
        }
        ...
        if (!state4.timedMetadata.equals(state3.timedMetadata) && state3.timedMetadata.presentationTimeUs != C0963C.TIME_UNSET) {
        ...
        if (!state4.availableCommands.equals(state3.availableCommands)) {
            this.listeners.queueEvent(13, new SimpleBasePlayer$$ExternalSyntheticLambda19(state3));
        }
    ...
    private void updateStateForPendingOperation(ListenableFuture<?> listenableFuture, Supplier<State> supplier, boolean z, boolean z2) {
        if (!listenableFuture.isDone() || !this.pendingOperations.isEmpty()) {
            ...
            listenableFuture.addListener(new SimpleBasePlayer$$ExternalSyntheticLambda50(this, listenableFuture), new SimpleBasePlayer$$ExternalSyntheticLambda51(this));
            return;
        }
        updateStateAndInformListeners(getState(), z, z2);
    }

    /* renamed from: lambda$updateStateForPendingOperation$55$com-google-android-exoplayer2-SimpleBasePlayer */
    public /* synthetic */ void mo16133x902fbd44(ListenableFuture listenableFuture) {
        C1229Util.castNonNull(this.state);
    ...
    private static long getPositionOrDefaultInMediaItem(long j, State state2) {
        ...
        return C1229Util.usToMs(((MediaItemData) state2.playlist.get(getCurrentMediaItemIndexInternal(state2))).defaultPositionUs);
    }
    ...
    public static int getPeriodIndexFromWindowPosition(Timeline timeline, int i, long j, Timeline.Window window, Timeline.Period period2) {
        return timeline.getIndexOfPeriod(timeline.getPeriodPositionUs(window, period2, i, C1229Util.msToUs(j)).first);
    }
    ...
    private static int getPositionDiscontinuityReason(State state2, State state3, boolean z, Timeline.Window window, Timeline.Period period2) {
        ...
        if (uidOfPeriod2.equals(uidOfPeriod) && state2.currentAdGroupIndex == state3.currentAdGroupIndex && state2.currentAdIndexInAdGroup == state3.currentAdIndexInAdGroup) {
            ...
            if (periodOrAdDurationMs == C0963C.TIME_UNSET || currentPeriodOrAdPositionMs < periodOrAdDurationMs) {
                return 5;
            }
            return 0;
            ...
            if (periodOrAdDurationMs2 == C0963C.TIME_UNSET || currentPeriodOrAdPositionMs2 < periodOrAdDurationMs2) {
                return 3;
            }
            return 0;
        }
    ...
    private static Player.PositionInfo getPositionInfo(State state2, boolean z, Timeline.Window window, Timeline.Period period2) {
        ...
        Object obj2 = null;
        if (!state2.timeline.isEmpty()) {
            int currentPeriodIndexInternal = getCurrentPeriodIndexInternal(state2, window, period2);
            Object obj3 = state2.timeline.getPeriod(currentPeriodIndexInternal, period2, true).uid;
            obj2 = state2.timeline.getWindow(currentMediaItemIndexInternal, window).uid;
        ...
        if (z) {
            j2 = state2.discontinuityPositionMs;
            if (state2.currentAdGroupIndex == -1) {
                j3 = j2;
            } else {
                j3 = getContentPositionMsInternal(state2);
            }
            j = j3;
        } else {
            long contentPositionMsInternal = getContentPositionMsInternal(state2);
            j = contentPositionMsInternal;
            j2 = state2.currentAdGroupIndex != -1 ? state2.adPositionMsSupplier.get() : contentPositionMsInternal;
        }
        return new Player.PositionInfo(obj2, currentMediaItemIndexInternal, mediaItem, obj, i, j2, j, state2.currentAdGroupIndex, state2.currentAdIndexInAdGroup);
    }
    ...
    private static State getStateWithNewPlaylist(State state2, List<MediaItemData> list, Timeline.Period period2) {
        ...
        long j2 = mediaItemIndexInNewPlaylist == -1 ? C0963C.TIME_UNSET : j;
    ...
    private static State buildStateForNewPosition(State.Builder builder, State state2, long j, List<MediaItemData> list, int i, long j2, boolean z) {
        ...
        if (!list.isEmpty() && j2 == C0963C.TIME_UNSET) {
            j2 = C1229Util.usToMs(list.get(i).defaultPositionUs);
        }

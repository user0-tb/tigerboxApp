...
public final class EventMessage implements Metadata.Entry {
    ...
    EventMessage(Parcel parcel) {
        this.schemeIdUri = (String) C1229Util.castNonNull(parcel.readString());
        this.value = (String) C1229Util.castNonNull(parcel.readString());
        this.durationMs = parcel.readLong();
        this.f155id = parcel.readLong();
        this.messageData = (byte[]) C1229Util.castNonNull(parcel.createByteArray());
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.durationMs != eventMessage.durationMs || this.f155id != eventMessage.f155id || !C1229Util.areEqual(this.schemeIdUri, eventMessage.schemeIdUri) || !C1229Util.areEqual(this.value, eventMessage.value) || !Arrays.equals(this.messageData, eventMessage.messageData)) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "EMSG: scheme=" + this.schemeIdUri + ", id=" + this.f155id + ", durationMs=" + this.durationMs + ", value=" + this.value;
    }

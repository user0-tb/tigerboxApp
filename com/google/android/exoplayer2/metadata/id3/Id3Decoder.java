...
public final class Id3Decoder extends SimpleMetadataDecoder {
    ...
    private static Id3Header decodeHeader(ParsableByteArray parsableByteArray) {
        ...
        if (readUnsignedInt24 != 4801587) {
            Log.m157w(TAG, "Unexpected first three bytes of ID3 tag header: 0x" + String.format("%06X", new Object[]{Integer.valueOf(readUnsignedInt24)}));
            return null;
        }
    ...
    private static com.google.android.exoplayer2.metadata.id3.Id3Frame decodeFrame(int r19, com.google.android.exoplayer2.util.ParsableByteArray r20, boolean r21, int r22, com.google.android.exoplayer2.metadata.id3.Id3Decoder.FramePredicate r23) {
        ...
        L_0x01f2:
            ...
            com.google.android.exoplayer2.util.Log.m157w(r12, r0)     // Catch:{ all -> 0x012e }
        L_0x0214:
            r7.setPosition(r14)
            return r1
        L_0x0218:
        ...
        L_0x021c:
            ...
            com.google.android.exoplayer2.util.Log.m157w(r12, r0)
            r7.setPosition(r14)
            return r16
        */
    ...
    private static ImmutableList<String> decodeTextInformationFrameValues(byte[] bArr, int i, int i2) {
        ...
        return build.isEmpty() ? ImmutableList.m262of("") : build;
    }
    ...
    private static byte[] copyOfRangeIfValid(byte[] bArr, int i, int i2) {
        if (i2 <= i) {
            return C1229Util.EMPTY_BYTE_ARRAY;
        }

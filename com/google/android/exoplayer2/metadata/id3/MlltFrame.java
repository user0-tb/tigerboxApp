...
public final class MlltFrame extends Id3Frame {
    ...
    /* renamed from: ID */
    public static final String f163ID = "MLLT";
    ...
    MlltFrame(Parcel parcel) {
        ...
        this.bytesDeviations = (int[]) C1229Util.castNonNull(parcel.createIntArray());
        this.millisecondsDeviations = (int[]) C1229Util.castNonNull(parcel.createIntArray());
    }

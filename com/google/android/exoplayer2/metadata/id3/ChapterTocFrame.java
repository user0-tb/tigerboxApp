...
public final class ChapterTocFrame extends Id3Frame {
    ...
    /* renamed from: ID */
    public static final String f158ID = "CTOC";
    ...
    ChapterTocFrame(Parcel parcel) {
        super(f158ID);
        this.elementId = (String) C1229Util.castNonNull(parcel.readString());
        boolean z = true;
        this.isRoot = parcel.readByte() != 0;
        this.isOrdered = parcel.readByte() == 0 ? false : z;
        this.children = (String[]) C1229Util.castNonNull(parcel.createStringArray());
    ...
    public boolean equals(Object obj) {
        ...
        if (this.isRoot != chapterTocFrame.isRoot || this.isOrdered != chapterTocFrame.isOrdered || !C1229Util.areEqual(this.elementId, chapterTocFrame.elementId) || !Arrays.equals(this.children, chapterTocFrame.children) || !Arrays.equals(this.subFrames, chapterTocFrame.subFrames)) {
            return false;
        }
        return true;
    }

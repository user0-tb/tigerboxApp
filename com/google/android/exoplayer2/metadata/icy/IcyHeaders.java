...
public final class IcyHeaders implements Metadata.Entry {
    ...
    public static com.google.android.exoplayer2.metadata.icy.IcyHeaders parse(java.util.Map<java.lang.String, java.util.List<java.lang.String>> r13) {
        ...
        L_0x0021:
            ...
            com.google.android.exoplayer2.util.Log.m157w(r2, r7)     // Catch:{ NumberFormatException -> 0x003a }
            r1 = 0
            r6 = -1
        L_0x0037:
            r7 = r6
        ...
        L_0x00c2:
            ...
            com.google.android.exoplayer2.util.Log.m157w(r2, r4)     // Catch:{ NumberFormatException -> 0x00d7 }
            r4 = r1
        L_0x00d5:
            r1 = r4
            goto L_0x00ea
        ...
        L_0x00d8:
            ...
            com.google.android.exoplayer2.util.Log.m157w(r2, r13)
        L_0x00ea:
    ...
    IcyHeaders(Parcel parcel) {
        ...
        this.isPublic = C1229Util.readBoolean(parcel);
    ...
    public boolean equals(Object obj) {
        ...
        if (this.bitrate != icyHeaders.bitrate || !C1229Util.areEqual(this.genre, icyHeaders.genre) || !C1229Util.areEqual(this.name, icyHeaders.name) || !C1229Util.areEqual(this.url, icyHeaders.url) || this.isPublic != icyHeaders.isPublic || this.metadataInterval != icyHeaders.metadataInterval) {
            return false;
        }
        return true;
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        C1229Util.writeBoolean(parcel, this.isPublic);

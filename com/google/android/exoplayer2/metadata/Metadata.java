...
public final class Metadata implements Parcelable {
    ...
    public Metadata(Entry... entryArr) {
        this((long) C0963C.TIME_UNSET, entryArr);
    }
    ...
    public Metadata copyWithAppendedEntries(Entry... entryArr) {
        ...
        return new Metadata(this.presentationTimeUs, (Entry[]) C1229Util.nullSafeArrayConcatenation(this.entries, entryArr));
    }
    ...
    public String toString() {
        ...
        if (this.presentationTimeUs == C0963C.TIME_UNSET) {
            str = "";
        } else {

        ...
        public boolean handleMessage(Message message) {
            ...
            if (i == 1) {
                try {
                    ...
                    Log.m154e(PlaceholderSurface.TAG, "Failed to initialize placeholder surface", e);
                    this.initException = e;
                    synchronized (this) {
                        notify();
                    }
                } catch (GlUtil.GlException e2) {
                    Log.m154e(PlaceholderSurface.TAG, "Failed to initialize placeholder surface", e2);
                    ...
                    try {
                        Log.m154e(PlaceholderSurface.TAG, "Failed to initialize placeholder surface", e3);
                        this.initError = e3;
                        synchronized (this) {
                            notify();
                        }

...
public final class VideoSize implements Bundleable {
    ...
    private static final String FIELD_HEIGHT = C1229Util.intToStringMaxRadix(1);
    private static final String FIELD_PIXEL_WIDTH_HEIGHT_RATIO = C1229Util.intToStringMaxRadix(3);
    private static final String FIELD_UNAPPLIED_ROTATION_DEGREES = C1229Util.intToStringMaxRadix(2);
    private static final String FIELD_WIDTH = C1229Util.intToStringMaxRadix(0);

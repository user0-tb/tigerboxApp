...
final class FixedFrameRateEstimator {
    ...
    private long lastFramePresentationTimeNs = C0963C.TIME_UNSET;
    ...
    public void reset() {
        ...
        this.lastFramePresentationTimeNs = C0963C.TIME_UNSET;
    ...
    public void onNextFrame(long j) {
        ...
        if (this.currentMatcher.isSynced() && !this.switchToCandidateMatcherWhenSynced) {
            this.candidateMatcherActive = false;
        } else if (this.lastFramePresentationTimeNs != C0963C.TIME_UNSET) {
    ...
    public long getMatchingFrameDurationSumNs() {
        return isSynced() ? this.currentMatcher.getMatchingFrameDurationSumNs() : C0963C.TIME_UNSET;
    }

    public long getFrameDurationNs() {
        return isSynced() ? this.currentMatcher.getFrameDurationNs() : C0963C.TIME_UNSET;
    }

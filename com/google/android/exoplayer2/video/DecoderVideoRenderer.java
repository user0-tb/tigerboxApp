...
public abstract class DecoderVideoRenderer extends BaseRenderer {
    ...
    private long joiningDeadlineMs = C0963C.TIME_UNSET;
        ...
        if (!this.outputStreamEnded) {
            ...
            if (this.decoder != null) {
                try {
                    ...
                    Log.m154e(TAG, "Video codec error", e);
    ...
    public void renderOutputBuffer(VideoDecoderOutputBuffer videoDecoderOutputBuffer, long j, Format format) throws DecoderException {
        ...
        this.lastRenderTimeUs = C1229Util.msToUs(SystemClock.elapsedRealtime() * 1000);

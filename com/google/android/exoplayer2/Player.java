...
public interface Player {
    ...
    public interface Listener {
        ...
        public final /* synthetic */ class CC {
            ...
            public static void $default$onEvents(Listener listener, Player player, C0984Events events) {
            }
        ...
        void onEvents(Player player, C0984Events events);
    ...
    public static final class C0984Events {
        private final FlagSet flags;

        public C0984Events(FlagSet flagSet) {
            this.flags = flagSet;
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof C0984Events)) {
                return false;
            }
            return this.flags.equals(((C0984Events) obj).flags);
        }
    }
    ...
    public static final class PositionInfo implements Bundleable {
        ...
        private static final String FIELD_AD_GROUP_INDEX = C1229Util.intToStringMaxRadix(5);
        private static final String FIELD_AD_INDEX_IN_AD_GROUP = C1229Util.intToStringMaxRadix(6);
        private static final String FIELD_CONTENT_POSITION_MS = C1229Util.intToStringMaxRadix(4);
        private static final String FIELD_MEDIA_ITEM = C1229Util.intToStringMaxRadix(1);
        private static final String FIELD_MEDIA_ITEM_INDEX = C1229Util.intToStringMaxRadix(0);
        private static final String FIELD_PERIOD_INDEX = C1229Util.intToStringMaxRadix(2);
        private static final String FIELD_POSITION_MS = C1229Util.intToStringMaxRadix(3);
    ...
    public static final class Commands implements Bundleable {
        ...
        private static final String FIELD_COMMANDS = C1229Util.intToStringMaxRadix(0);
        /* access modifiers changed from: private */

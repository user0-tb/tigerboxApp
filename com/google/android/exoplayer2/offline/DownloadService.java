...
public abstract class DownloadService extends Service {
    ...
    public static void startForeground(Context context, Class<? extends DownloadService> cls) {
        C1229Util.startForegroundService(context, getIntent(context, cls, ACTION_INIT, true));
    }
        ...
        switch (c) {
            case 0:
                ...
                if (downloadRequest != null) {
                    ...
                    Log.m153e(TAG, "Ignored ADD_DOWNLOAD: Missing download_request extra");
                    break;
                }
            case 1:
            ...
            case 4:
                ...
                if (requirements != null) {
                    ...
                    Log.m153e(TAG, "Ignored SET_REQUIREMENTS: Missing requirements extra");
                    break;
                }
            case 5:
            ...
            case 6:
                if (((Intent) Assertions.checkNotNull(intent)).hasExtra(KEY_STOP_REASON)) {
                    ...
                    Log.m153e(TAG, "Ignored SET_STOP_REASON: Missing stop_reason extra");
                    break;
                }
            case 8:
                if (str != null) {
                    ...
                    Log.m153e(TAG, "Ignored REMOVE_DOWNLOAD: Missing content_id extra");
                    break;
                }
            default:
                Log.m153e(TAG, "Ignored unrecognized action: " + str2);
                break;
        }
        if (C1229Util.SDK_INT >= 26 && this.startedInForeground && (foregroundNotificationUpdater2 = this.foregroundNotificationUpdater) != null) {
    ...
    public void onIdle() {
        ...
        if (((DownloadManagerHelper) Assertions.checkNotNull(this.downloadManagerHelper)).updateScheduler()) {
            if (C1229Util.SDK_INT >= 28 || !this.taskRemoved) {
    ...
    private static void startService(Context context, Intent intent, boolean z) {
        if (z) {
            C1229Util.startForegroundService(context, intent);
        } else {
    ...
    private final class ForegroundNotificationUpdater {
        ...
        public void update() {
            ...
            if (this.periodicUpdatesStarted) {
                this.handler.removeCallbacksAndMessages((Object) null);
                this.handler.postDelayed(new C1096xac84e153(this), this.updateInterval);
            }
        }
    }
    ...
    private static final class DownloadManagerHelper implements DownloadManager.Listener {
        ...
        public void attachService(DownloadService downloadService2) {
            ...
            if (this.downloadManager.isInitialized()) {
                C1229Util.createHandlerForCurrentOrMainLooper().postAtFrontOfQueue(new DownloadService$DownloadManagerHelper$$ExternalSyntheticLambda0(this, downloadService2));
            }
        }

        /* renamed from: lambda$attachService$0$com-google-android-exoplayer2-offline-DownloadService$DownloadManagerHelper */
        public /* synthetic */ void mo17679x5d17c8bb(DownloadService downloadService2) {
        ...
        public boolean updateScheduler() {
            ...
            if (!this.scheduler.getSupportedRequirements(requirements).equals(requirements)) {
                ...
                Log.m157w(DownloadService.TAG, "Failed to schedule restart");
                cancelScheduler();
                return false;
            }
        }
        ...
        public void onDownloadChanged(DownloadManager downloadManager2, Download download, Exception exc) {
            ...
            if (serviceMayNeedRestart() && DownloadService.needsStartedService(download.state)) {
                Log.m157w(DownloadService.TAG, "DownloadService wasn't running. Restarting.");
                restartService();
            }
        }
        ...
        private boolean schedulerNeedsUpdate(Requirements requirements) {
            return !C1229Util.areEqual(this.scheduledRequirements, requirements);
        }
        ...
        private void restartService() {
            if (this.foregroundAllowed) {
                try {
                    C1229Util.startForegroundService(this.context, DownloadService.getIntent(this.context, this.serviceClass, DownloadService.ACTION_RESTART));
                } catch (IllegalStateException unused) {
                    Log.m157w(DownloadService.TAG, "Failed to restart (foreground launch restriction)");
                }
            } else {
                try {
                    this.context.startService(DownloadService.getIntent(this.context, this.serviceClass, DownloadService.ACTION_INIT));
                } catch (IllegalStateException unused2) {
                    Log.m157w(DownloadService.TAG, "Failed to restart (process is idle)");
                }
            }
        }
    }

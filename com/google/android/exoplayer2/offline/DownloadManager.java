...
public final class DownloadManager {
    ...
    public DownloadManager(Context context2, DatabaseProvider databaseProvider, Cache cache, DataSource.Factory factory) {
        this(context2, databaseProvider, cache, factory, C0866x19d39ccf.INSTANCE);
    }
    ...
    public DownloadManager(Context context2, WritableDownloadIndex writableDownloadIndex, DownloaderFactory downloaderFactory) {
        ...
        Handler createHandlerForCurrentOrMainLooper = C1229Util.createHandlerForCurrentOrMainLooper(new DownloadManager$$ExternalSyntheticLambda0(this));
    ...
    private static final class InternalHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            switch (message.what) {
                ...
                case 9:
                    ...
                    break;
                case 10:
                    onContentLengthChanged((Task) message.obj, C1229Util.toLong(message.arg1, message.arg2));
                    return;
                case 11:
                    updateProgress();
                    return;
        ...
        private void initialize(int i) {
            ...
            try {
                ...
                Log.m154e(DownloadManager.TAG, "Failed to load index.", e);
                this.downloads.clear();
            } catch (Throwable th) {
                C1229Util.closeQuietly((Closeable) null);
                throw th;
            }
            C1229Util.closeQuietly(downloadCursor);
        ...
        private void setStopReason(String str, int i) {
            if (str == null) {
                ...
                try {
                    ...
                    Log.m154e(DownloadManager.TAG, "Failed to set manual stop reason", e);
                }
            } else {
                ...
                if (download != null) {
                    ...
                    try {
                        ...
                        Log.m154e(DownloadManager.TAG, "Failed to set manual stop reason: " + str, e2);
                    }
                }
            }
            syncTasks();
        ...
        private void addDownload(DownloadRequest downloadRequest, int i) {
            Download download = getDownload(downloadRequest.f165id, true);
        ...
        private void removeDownload(String str) {
            ...
            if (download == null) {
                Log.m153e(DownloadManager.TAG, "Failed to remove nonexistent download: " + str);
                return;
            }
        ...
        private void removeAllDownloads() {
            ...
            try {
                ...
                Log.m153e(DownloadManager.TAG, "Failed to load downloads.");
            } catch (Throwable th) {
                th.addSuppressed(th);
            }
            ...
            try {
                ...
                Log.m154e(DownloadManager.TAG, "Failed to update index.", e);
            }
        ...
        private void syncTasks() {
            ...
            for (int i2 = 0; i2 < this.downloads.size(); i2++) {
                ...
                Task task = this.activeTasks.get(download.request.f165id);
        ...
        private Task syncQueuedDownload(Task task, Download download) {
            if (task != null) {
                ...
                this.activeTasks.put(putDownloadWithState.request.f165id, task2);
        ...
        private void syncRemovingDownload(Task task, Download download) {
            if (task != null) {
                ...
                this.activeTasks.put(download.request.f165id, task2);
        ...
        private void onContentLengthChanged(Task task, long j) {
            Download download = (Download) Assertions.checkNotNull(getDownload(task.request.f165id, false));
        ...
        private void onTaskStopped(Task task) {
            String str = task.request.f165id;
            ...
            if (access$400 != null) {
                Log.m154e(DownloadManager.TAG, "Task failed: " + task.request + ", " + access$000, access$400);
            }
        ...
        private void onDownloadTaskStopped(Download download, Exception exc) {
            ...
            this.downloads.remove(getDownloadIndex(download3.request.f165id));
            try {
        ...
        private void onRemoveTaskStopped(Download download) {
            ...
            this.downloads.remove(getDownloadIndex(download.request.f165id));
            try {
                this.downloadIndex.removeDownload(download.request.f165id);
            } catch (IOException unused) {
                Log.m153e(DownloadManager.TAG, "Failed to remove from database");
            }
        ...
        private Download putDownload(Download download) {
            ...
            int downloadIndex2 = getDownloadIndex(download.request.f165id);
            if (downloadIndex2 == -1) {
        ...
        private Download getDownload(String str, boolean z) {
            ...
            try {
                ...
                Log.m154e(DownloadManager.TAG, "Failed to load download: " + str, e);
                return null;
            }
        }
        ...
        private int getDownloadIndex(String str) {
            for (int i = 0; i < this.downloads.size(); i++) {
                if (this.downloads.get(i).request.f165id.equals(str)) {
                    return i;
                }
            }
            return -1;
        ...
        public static int compareStartTimes(Download download, Download download2) {
            return C1229Util.compareLong(download.startTimeMs, download2.startTimeMs);
        }
    }

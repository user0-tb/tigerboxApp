...
public abstract class SegmentDownloader<M extends FilterableManifest<M>> implements Downloader {
    ...
    protected static class Segment implements Comparable<Segment> {
        ...
        public int compareTo(Segment segment) {
            return C1229Util.compareLong(this.startTimeUs, segment.startTimeUs);
        }
    }
    ...
    public SegmentDownloader(MediaItem mediaItem, ParsingLoadable.Parser<M> parser, CacheDataSource.Factory factory, Executor executor2, long j) {
        ...
        this.maxMergedSegmentStartTimeDiffUs = C1229Util.msToUs(j);
    }
    ...
    private static void mergeSegments(List<Segment> list, CacheKeyFactory cacheKeyFactory2, long j) {
        ...
        C1229Util.removeRange(list, i, list.size());
    }

    private static boolean canMergeSegments(DataSpec dataSpec, DataSpec dataSpec2) {
        return dataSpec.uri.equals(dataSpec2.uri) && dataSpec.length != -1 && dataSpec.position + dataSpec.length == dataSpec2.position && C1229Util.areEqual(dataSpec.key, dataSpec2.key) && dataSpec.flags == dataSpec2.flags && dataSpec.httpMethod == dataSpec2.httpMethod && dataSpec.httpRequestHeaders.equals(dataSpec2.httpRequestHeaders);
    }

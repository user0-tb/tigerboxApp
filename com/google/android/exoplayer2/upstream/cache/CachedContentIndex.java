...
class CachedContentIndex {
    ...
    public CachedContentIndex(DatabaseProvider databaseProvider, File file, byte[] bArr, boolean z, boolean z2) {
        ...
        if (databaseStorage == null || (legacyStorage != null && z2)) {
            this.storage = (Storage) C1229Util.castNonNull(legacyStorage);
    ...
    private static class LegacyStorage implements Storage {
        ...
        private boolean readFile(java.util.HashMap<java.lang.String, com.google.android.exoplayer2.upstream.cache.CachedContent> r11, android.util.SparseArray<java.lang.String> r12) {
            ...
            L_0x0027:
                ...
                com.google.android.exoplayer2.util.C1229Util.closeQuietly(r4)
                return r2
            L_0x0036:
                r6 = 16
                ...
                java.lang.Object r8 = com.google.android.exoplayer2.util.C1229Util.castNonNull(r8)     // Catch:{ InvalidKeyException -> 0x005f, InvalidAlgorithmParameterException -> 0x005d }
            ...
            L_0x0072:
                ...
                int r8 = r7.f185id     // Catch:{ IOException -> 0x00ae, all -> 0x00ab }
            ...
            L_0x00b1:
                ...
                com.google.android.exoplayer2.util.C1229Util.closeQuietly(r0)
            L_0x00b6:
                throw r11
            L_0x00b7:
            L_0x00b8:
            ...
            try {
                ...
                try {
                    ...
                    if (this.encrypt) {
                        ...
                        ((SecureRandom) C1229Util.castNonNull(this.random)).nextBytes(bArr);
                        dataOutputStream2.write(bArr);
                        ((Cipher) C1229Util.castNonNull(this.cipher)).init(1, (Key) C1229Util.castNonNull(this.secretKeySpec), new IvParameterSpec(bArr));
                    ...
                    C1229Util.closeQuietly(dataOutputStream);
                    throw th;
                }
            } catch (Throwable th2) {
                th = th2;
        ...
        private int hashCachedContent(CachedContent cachedContent, int i) {
            int hashCode = (cachedContent.f185id * 31) + cachedContent.key.hashCode();
            if (i >= 2) {
        ...
        private void writeCachedContent(CachedContent cachedContent, DataOutputStream dataOutputStream) throws IOException {
            dataOutputStream.writeInt(cachedContent.f185id);
    ...
    private static final class DatabaseStorage implements Storage {
        ...
        public void load(HashMap<String, CachedContent> hashMap, SparseArray<String> sparseArray) throws IOException {
            ...
            try {
                ...
                while (cursor.moveToNext()) {
                    ...
                    sparseArray.put(cachedContent.f185id, cachedContent.key);
                }
                if (cursor != null) {
                    cursor.close();
                    return;
        ...
        public void onUpdate(CachedContent cachedContent) {
            this.pendingUpdates.put(cachedContent.f185id, cachedContent);
        }

        public void onRemove(CachedContent cachedContent, boolean z) {
            if (z) {
                this.pendingUpdates.delete(cachedContent.f185id);
            } else {
                this.pendingUpdates.put(cachedContent.f185id, (Object) null);
            }
        }
        ...
        private void addOrUpdateRow(SQLiteDatabase sQLiteDatabase, CachedContent cachedContent) throws IOException {
            ...
            contentValues.put("id", Integer.valueOf(cachedContent.f185id));

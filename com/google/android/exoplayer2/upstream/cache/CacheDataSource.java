...
public final class CacheDataSource implements DataSource {
    ...
    public int read(byte[] bArr, int i, int i2) throws IOException {
        ...
        try {
            ...
            if (read != -1) {
                ...
                setNoBytesRemainingAndMaybeStoreLength((String) C1229Util.castNonNull(dataSpec.key));
            }
            return read;
        } catch (Throwable th) {
            handleBeforeThrow(th);
    ...
    private void openNextSource(DataSpec dataSpec, boolean z) throws IOException {
        ...
        String str = (String) C1229Util.castNonNull(dataSpec3.key);
        Uri uri = null;
        if (this.currentRequestIgnoresCache) {
            cacheSpan = null;
        ...
        if (cacheSpan == null) {
            ...
            Uri fromFile = Uri.fromFile((File) C1229Util.castNonNull(cacheSpan.file));
        ...
        if (z) {
            ...
            if (dataSource != this.upstreamDataSource) {
                try {
                    ...
                    Throwable th2 = th;
                    if (((CacheSpan) C1229Util.castNonNull(cacheSpan)).isHoleSpan()) {
                        this.cache.releaseHoleSpan(cacheSpan);
                    }
                    throw th2;
                }

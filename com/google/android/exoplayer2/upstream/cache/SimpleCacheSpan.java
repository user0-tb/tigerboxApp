...
final class SimpleCacheSpan extends CacheSpan {
    ...
    public static SimpleCacheSpan createLookup(String str, long j) {
        return new SimpleCacheSpan(str, j, -1, C0963C.TIME_UNSET, (File) null);
    }

    public static SimpleCacheSpan createHole(String str, long j, long j2) {
        return new SimpleCacheSpan(str, j, j2, C0963C.TIME_UNSET, (File) null);
    }

    public static SimpleCacheSpan createCacheEntry(File file, long j, CachedContentIndex cachedContentIndex) {
        return createCacheEntry(file, j, C0963C.TIME_UNSET, cachedContentIndex);
    }
    ...
    public static SimpleCacheSpan createCacheEntry(File file, long j, long j2, CachedContentIndex cachedContentIndex) {
        ...
        return new SimpleCacheSpan(keyForId, Long.parseLong((String) Assertions.checkNotNull(matcher.group(2))), length, j2 == C0963C.TIME_UNSET ? Long.parseLong((String) Assertions.checkNotNull(matcher.group(3))) : j2, file2);
    }
    ...
    private static File upgradeFile(File file, CachedContentIndex cachedContentIndex) {
        ...
        if (matcher.matches()) {
            str = C1229Util.unescapeFileName((String) Assertions.checkNotNull(matcher.group(1)));
        } else {

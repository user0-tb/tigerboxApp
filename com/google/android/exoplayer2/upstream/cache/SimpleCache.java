...
public final class SimpleCache implements Cache {
    ...
    public static void delete(File file, DatabaseProvider databaseProvider) {
        if (file.exists()) {
            ...
            if (databaseProvider != null) {
                ...
                if (loadUid != -1) {
                    try {
                        ...
                        Log.m157w(TAG, "Failed to delete file metadata: " + loadUid);
                    }
                    try {
            ...
            C1229Util.recursiveDelete(file);
        }
    }
    ...
    public synchronized File startFile(String str, long j, long j2) throws Cache.CacheException {
        ...
        return SimpleCacheSpan.getCacheFile(file, cachedContent.f185id, j, System.currentTimeMillis());
    }
    ...
    private SimpleCacheSpan touchSpan(String str, SimpleCacheSpan simpleCacheSpan) {
        ...
        if (cacheFileMetadataIndex != null) {
            try {
                ...
                Log.m157w(TAG, "Failed to update index with new touch timestamp.");
            }
        } else {
            z = true;
        }
        ...
        if (cachedContent != null && cachedContent.removeSpan(cacheSpan)) {
            ...
            if (this.fileIndex != null) {
                ...
                try {
                    ...
                    Log.m157w(TAG, "Failed to remove file index entry for: " + name);
                }
            }
            this.contentIndex.maybeRemove(cachedContent.key);
        ...
        while (i < length) {
            ...
            if (name.endsWith(UID_FILE_SUFFIX)) {
                try {
                    ...
                    Log.m153e(TAG, "Malformed UID file: " + file);
                    file.delete();
                }
            } else {
                i++;

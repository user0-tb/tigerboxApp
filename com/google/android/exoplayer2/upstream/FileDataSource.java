...
public final class FileDataSource extends BaseDataSource {
    ...
    public int read(byte[] bArr, int i, int i2) throws FileDataSourceException {
        ...
        try {
            int read = ((RandomAccessFile) C1229Util.castNonNull(this.file)).read(bArr, i, (int) Math.min(this.bytesRemaining, (long) i2));
            if (read > 0) {
    ...
    private static RandomAccessFile openLocalFile(Uri uri2) throws FileDataSourceException {
        ...
        try {
            ...
            if (C1229Util.SDK_INT < 21 || !Api21.isPermissionError(e.getCause())) {

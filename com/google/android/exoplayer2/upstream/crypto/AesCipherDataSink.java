...
public final class AesCipherDataSink implements DataSink {
    ...
    public void write(byte[] bArr, int i, int i2) throws IOException {
        if (this.scratch == null) {
            ((AesFlushingCipher) C1229Util.castNonNull(this.cipher)).updateInPlace(bArr, i, i2);
        ...
        while (i3 < i2) {
            ...
            ((AesFlushingCipher) C1229Util.castNonNull(this.cipher)).update(bArr, i + i3, min, this.scratch, 0);

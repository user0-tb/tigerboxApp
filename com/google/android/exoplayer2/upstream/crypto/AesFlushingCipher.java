...
public final class AesFlushingCipher {
    ...
    public AesFlushingCipher(int i, byte[] bArr, long j, long j2) {
        try {
            ...
            instance.init(i, new SecretKeySpec(bArr, C1229Util.splitAtFirst(instance.getAlgorithm(), DownloadsManager.FOLDERS_SEPARATOR)[0]), new IvParameterSpec(getInitializationVector(j, j2 / ((long) blockSize2))));
            if (i2 != 0) {

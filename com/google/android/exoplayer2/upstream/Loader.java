...
public final class Loader implements LoaderErrorThrower {
    ...
    public static final LoadErrorAction DONT_RETRY = new LoadErrorAction(2, C0963C.TIME_UNSET);
    public static final LoadErrorAction DONT_RETRY_FATAL = new LoadErrorAction(3, C0963C.TIME_UNSET);
    public static final LoadErrorAction RETRY = createRetryAction(false, C0963C.TIME_UNSET);
    public static final LoadErrorAction RETRY_RESET_ERROR_COUNT = createRetryAction(true, C0963C.TIME_UNSET);
    ...
    public Loader(String str) {
        this.downloadExecutorService = C1229Util.newSingleThreadExecutor(THREAD_NAME_PREFIX + str);
    }
                ...
                if (message.what == 0) {
                    ...
                    if (i == 1) {
                        ...
                        if (onLoadError.type == 3) {
                            ...
                            if (onLoadError.retryDelayMillis != C0963C.TIME_UNSET) {

...
public final class ExoPlaybackException extends PlaybackException {
    ...
    private static final String FIELD_IS_RECOVERABLE = C1229Util.intToStringMaxRadix(1006);
    private static final String FIELD_RENDERER_FORMAT = C1229Util.intToStringMaxRadix(1004);
    private static final String FIELD_RENDERER_FORMAT_SUPPORT = C1229Util.intToStringMaxRadix(1005);
    private static final String FIELD_RENDERER_INDEX = C1229Util.intToStringMaxRadix(1003);
    private static final String FIELD_RENDERER_NAME = C1229Util.intToStringMaxRadix(1002);
    private static final String FIELD_TYPE = C1229Util.intToStringMaxRadix(1001);
    ...
    public boolean errorInfoEquals(PlaybackException playbackException) {
        ...
        ExoPlaybackException exoPlaybackException = (ExoPlaybackException) C1229Util.castNonNull(playbackException);
        if (this.type == exoPlaybackException.type && C1229Util.areEqual(this.rendererName, exoPlaybackException.rendererName) && this.rendererIndex == exoPlaybackException.rendererIndex && C1229Util.areEqual(this.rendererFormat, exoPlaybackException.rendererFormat) && this.rendererFormatSupport == exoPlaybackException.rendererFormatSupport && C1229Util.areEqual(this.mediaPeriodId, exoPlaybackException.mediaPeriodId) && this.isRecoverable == exoPlaybackException.isRecoverable) {
            return true;
        }
        return false;
    }
    ...
    public ExoPlaybackException copyWithMediaPeriodId(MediaPeriodId mediaPeriodId2) {
        return new ExoPlaybackException((String) C1229Util.castNonNull(getMessage()), getCause(), this.errorCode, this.type, this.rendererName, this.rendererIndex, this.rendererFormat, this.rendererFormatSupport, mediaPeriodId2, this.timestampMs, this.isRecoverable);
    }
    ...
    private static String deriveMessage(int i, String str, String str2, int i2, Format format, int i3) {
        ...
        if (i == 0) {
            ...
            str3 = str2 + " error, index=" + i2 + ", format=" + format + ", format_supported=" + C1229Util.getFormatSupportString(i3);
        }

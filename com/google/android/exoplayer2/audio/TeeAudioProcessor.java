...
public final class TeeAudioProcessor extends BaseAudioProcessor {
    ...
    public static final class WavFileAudioBufferSink implements AudioBufferSink {
        ...
        private void writeFileHeader(RandomAccessFile randomAccessFile2) throws IOException {
            ...
            int pcmFrameSize = C1229Util.getPcmFrameSize(this.encoding, this.channelCount);
        ...
        private String getNextOutputFileName() {
            int i = this.counter;
            this.counter = i + 1;
            return C1229Util.formatInvariant("%s-%04d.wav", this.outputFileNamePrefix, Integer.valueOf(i));
        }
    }
}

...
public final class AudioAttributes implements Bundleable {
    ...
    private static final String FIELD_ALLOWED_CAPTURE_POLICY = C1229Util.intToStringMaxRadix(3);
    private static final String FIELD_CONTENT_TYPE = C1229Util.intToStringMaxRadix(0);
    private static final String FIELD_FLAGS = C1229Util.intToStringMaxRadix(1);
    private static final String FIELD_SPATIALIZATION_BEHAVIOR = C1229Util.intToStringMaxRadix(4);
    private static final String FIELD_USAGE = C1229Util.intToStringMaxRadix(2);

...
public final class AudioCapabilities {
    ...
    static AudioCapabilities getCapabilities(Context context, Intent intent) {
        ...
        if (C1229Util.SDK_INT >= 29 && (C1229Util.isTv(context) || C1229Util.isAutomotive(context))) {
    ...
    private static boolean deviceMaySetExternalSurroundSoundGlobalSetting() {
        return C1229Util.SDK_INT >= 17 && ("Amazon".equals(C1229Util.MANUFACTURER) || "Xiaomi".equals(C1229Util.MANUFACTURER));
    }
    ...
    private static int getChannelConfigForPassthrough(int i) {
        ...
        if (C1229Util.SDK_INT <= 26 && "fugu".equals(C1229Util.DEVICE) && i == 1) {
            i = 2;
        }
        return C1229Util.getAudioTrackChannelConfig(i);
    }
    ...
    private static final class Api29 {
        ...
        public static int getMaxSupportedChannelCountForPassthrough(int i, int i2) {
            for (int i3 = 8; i3 > 0; i3--) {
                if (AudioTrack.isDirectPlaybackSupported(new AudioFormat.Builder().setEncoding(i).setSampleRate(i2).setChannelMask(C1229Util.getAudioTrackChannelConfig(i3)).build(), DEFAULT_AUDIO_ATTRIBUTES)) {
                    return i3;
                }
            }
            return 0;

...
public final class SonicAudioProcessor implements AudioProcessor {
    ...
    public long getMediaDuration(long j) {
        ...
        if (this.outputAudioFormat.sampleRate == this.inputAudioFormat.sampleRate) {
            return C1229Util.scaleLargeTimestamp(j, pendingInputBytes, this.outputBytes);
        }
        return C1229Util.scaleLargeTimestamp(j, pendingInputBytes * ((long) this.outputAudioFormat.sampleRate), this.outputBytes * ((long) this.inputAudioFormat.sampleRate));
    }

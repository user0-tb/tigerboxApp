...
public abstract class Timeline implements Bundleable {
    ...
    private static final String FIELD_PERIODS = C1229Util.intToStringMaxRadix(1);
    private static final String FIELD_SHUFFLED_WINDOW_INDICES = C1229Util.intToStringMaxRadix(2);
    private static final String FIELD_WINDOWS = C1229Util.intToStringMaxRadix(0);
    ...
    public static final class Window implements Bundleable {
        ...
        private static final String FIELD_DEFAULT_POSITION_US = C1229Util.intToStringMaxRadix(9);
        private static final String FIELD_DURATION_US = C1229Util.intToStringMaxRadix(10);
        private static final String FIELD_ELAPSED_REALTIME_EPOCH_OFFSET_MS = C1229Util.intToStringMaxRadix(4);
        private static final String FIELD_FIRST_PERIOD_INDEX = C1229Util.intToStringMaxRadix(11);
        private static final String FIELD_IS_DYNAMIC = C1229Util.intToStringMaxRadix(6);
        private static final String FIELD_IS_PLACEHOLDER = C1229Util.intToStringMaxRadix(8);
        private static final String FIELD_IS_SEEKABLE = C1229Util.intToStringMaxRadix(5);
        private static final String FIELD_LAST_PERIOD_INDEX = C1229Util.intToStringMaxRadix(12);
        private static final String FIELD_LIVE_CONFIGURATION = C1229Util.intToStringMaxRadix(7);
        private static final String FIELD_MEDIA_ITEM = C1229Util.intToStringMaxRadix(1);
        private static final String FIELD_POSITION_IN_FIRST_PERIOD_US = C1229Util.intToStringMaxRadix(13);
        private static final String FIELD_PRESENTATION_START_TIME_MS = C1229Util.intToStringMaxRadix(2);
        private static final String FIELD_WINDOW_START_TIME_MS = C1229Util.intToStringMaxRadix(3);
        ...
        public long getDefaultPositionMs() {
            return C1229Util.usToMs(this.defaultPositionUs);
        }
        ...
        public long getDurationMs() {
            return C1229Util.usToMs(this.durationUs);
        }
        ...
        public long getPositionInFirstPeriodMs() {
            return C1229Util.usToMs(this.positionInFirstPeriodUs);
        }
        ...
        public long getCurrentUnixTimeMs() {
            return C1229Util.getNowUnixTimeMs(this.elapsedRealtimeEpochOffsetMs);
        }
        ...
        public static Window fromBundle(Bundle bundle) {
            ...
            long j = bundle2.getLong(FIELD_PRESENTATION_START_TIME_MS, C0963C.TIME_UNSET);
            long j2 = bundle2.getLong(FIELD_WINDOW_START_TIME_MS, C0963C.TIME_UNSET);
            long j3 = bundle2.getLong(FIELD_ELAPSED_REALTIME_EPOCH_OFFSET_MS, C0963C.TIME_UNSET);
            ...
            long j5 = bundle2.getLong(FIELD_DURATION_US, C0963C.TIME_UNSET);
    ...
    public static final class Period implements Bundleable {
        ...
        private static final String FIELD_AD_PLAYBACK_STATE = C1229Util.intToStringMaxRadix(4);
        private static final String FIELD_DURATION_US = C1229Util.intToStringMaxRadix(1);
        private static final String FIELD_PLACEHOLDER = C1229Util.intToStringMaxRadix(3);
        private static final String FIELD_POSITION_IN_WINDOW_US = C1229Util.intToStringMaxRadix(2);
        private static final String FIELD_WINDOW_INDEX = C1229Util.intToStringMaxRadix(0);
        /* access modifiers changed from: private */
        public AdPlaybackState adPlaybackState = AdPlaybackState.NONE;
        public long durationUs;

        /* renamed from: id */
        public Object f150id;
        public boolean isPlaceholder;
        ...
        public long getPositionInWindowMs() {
            return C1229Util.usToMs(this.positionInWindowUs);
        }
        ...
        public long getAdDurationUs(int i, int i2) {
            ...
            return adGroup.count != -1 ? adGroup.durationsUs[i2] : C0963C.TIME_UNSET;
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (C1229Util.areEqual(this.f150id, period.f150id) && C1229Util.areEqual(this.uid, period.uid) && this.windowIndex == period.windowIndex && this.durationUs == period.durationUs && this.positionInWindowUs == period.positionInWindowUs && this.isPlaceholder == period.isPlaceholder && C1229Util.areEqual(this.adPlaybackState, period.adPlaybackState)) {
                return true;
            }
            return false;
        }
        ...
        public static Period fromBundle(Bundle bundle) {
            ...
            long j = bundle.getLong(FIELD_DURATION_US, C0963C.TIME_UNSET);
    ...
    public final Pair<Object, Long> getPeriodPositionUs(Window window, Period period, int i, long j, long j2) {
        ...
        if (period.durationUs != C0963C.TIME_UNSET) {
    ...
    public final Bundle toBundleWithOneWindowOnly(int i) {
        ...
        BundleUtil.putBinder(bundle2, FIELD_WINDOWS, new BundleListRetriever(ImmutableList.m262of(bundle)));
    ...
    public static final class RemotableTimeline extends Timeline {
        ...
        public Period getPeriod(int i, Period period, boolean z) {
            ...
            period.set(period2.f150id, period2.uid, period2.windowIndex, period2.durationUs, period2.positionInWindowUs, period2.adPlaybackState, period2.isPlaceholder);
            return period;
        }

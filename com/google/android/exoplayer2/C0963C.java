...
public final class C0963C {
    ...
    public static long msToUs(long j) {
        return C1229Util.msToUs(j);
    }

    @Deprecated
    public static int generateAudioSessionIdV21(Context context) {
        return C1229Util.generateAudioSessionIdV21(context);
    }

    @Deprecated
    public static String getFormatSupportString(int i) {
        return C1229Util.getFormatSupportString(i);
    }

    @Deprecated
    public static int getErrorCodeForMediaDrmErrorCode(int i) {
        return C1229Util.getErrorCodeForMediaDrmErrorCode(i);
    }
}

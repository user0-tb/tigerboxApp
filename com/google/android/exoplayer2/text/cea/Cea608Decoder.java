...
public final class Cea608Decoder extends CeaDecoder {
    ...
    private static final int[] SPECIAL_CHARACTER_SET = {CipherSuite.TLS_PSK_WITH_AES_128_CBC_SHA256, CipherSuite.TLS_PSK_WITH_NULL_SHA256, 189, CipherSuite.TLS_DH_anon_WITH_CAMELLIA_128_CBC_SHA256, 8482, CipherSuite.TLS_DHE_DSS_WITH_AES_128_GCM_SHA256, CipherSuite.TLS_DHE_DSS_WITH_AES_256_GCM_SHA384, 9834, 224, 32, 232, HttpStatusCodesKt.HTTP_IM_USED, 234, 238, 244, 251};
    private static final int[] SPECIAL_ES_FR_CHARACTER_SET = {CipherSuite.TLS_DH_DSS_WITH_CAMELLIA_256_CBC_SHA256, HttpStatusCodesKt.HTTP_CREATED, 211, 218, 220, 252, 8216, CipherSuite.TLS_DH_RSA_WITH_AES_256_GCM_SHA384, 42, 39, 8212, CipherSuite.TLS_PSK_WITH_AES_256_GCM_SHA384, 8480, 8226, 8220, 8221, 192, CipherSuite.TLS_DH_RSA_WITH_CAMELLIA_256_CBC_SHA256, 199, 200, HttpStatusCodesKt.HTTP_ACCEPTED, HttpStatusCodesKt.HTTP_NOT_AUTHORITATIVE, 235, HttpStatusCodesKt.HTTP_PARTIAL_CONTENT, HttpStatusCodesKt.HTTP_MULTI_STATUS, 239, 212, 217, 249, 219, CipherSuite.TLS_DHE_PSK_WITH_AES_256_GCM_SHA384, CipherSuite.TLS_DH_DSS_WITH_CAMELLIA_128_CBC_SHA256};
    private static final int[] SPECIAL_PT_DE_CHARACTER_SET = {CipherSuite.TLS_DHE_DSS_WITH_CAMELLIA_256_CBC_SHA256, 227, HttpStatusCodesKt.HTTP_RESET_CONTENT, HttpStatusCodesKt.HTTP_NO_CONTENT, 236, 210, 242, 213, 245, 123, 125, 92, 94, 95, 124, 126, CipherSuite.TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA256, 228, 214, 246, 223, CipherSuite.TLS_DH_DSS_WITH_AES_256_GCM_SHA384, CipherSuite.TLS_DH_DSS_WITH_AES_128_GCM_SHA256, 9474, CipherSuite.TLS_DH_anon_WITH_CAMELLIA_256_CBC_SHA256, 229, 216, 248, 9484, 9488, 9492, 9496};
    ...
    public Cea608Decoder(String str, int i, long j) {
        ...
        if (i == 1) {
            ...
            Log.m157w(TAG, "Invalid channel. Defaulting to CC1.");
            this.selectedChannel = 0;
            this.selectedField = 0;
        } else {
            this.selectedChannel = 1;
        ...
        this.lastCueUpdateUs = C0963C.TIME_UNSET;
    }
    ...
    private static char getSpecialNorthAmericanChar(byte b) {
        return (char) SPECIAL_CHARACTER_SET[b & Ascii.f278SI];
    }
    ...
    private static char getExtendedEsFrChar(byte b) {
        return (char) SPECIAL_ES_FR_CHARACTER_SET[b & Ascii.f281US];
    }

    private static char getExtendedPtDeChar(byte b) {
        return (char) SPECIAL_PT_DE_CHARACTER_SET[b & Ascii.f281US];
    }
    ...
    private static final class CueBuilder {
        ...
        public Cue build(int i) {
            ...
            for (int i4 = 0; i4 < this.rolledUpCaptions.size(); i4++) {
                spannableStringBuilder.append(C1229Util.truncateAscii(this.rolledUpCaptions.get(i4), i3));
                spannableStringBuilder.append(10);
            }
            spannableStringBuilder.append(C1229Util.truncateAscii(buildCurrentLine(), i3));
    ...
    private boolean shouldClearStuckCaptions() {
        if (this.validDataChannelTimeoutUs == C0963C.TIME_UNSET || this.lastCueUpdateUs == C0963C.TIME_UNSET || getPositionUs() - this.lastCueUpdateUs < this.validDataChannelTimeoutUs) {
            return false;
        }
        return true;
    }

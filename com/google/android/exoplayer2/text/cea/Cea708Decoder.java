...
public final class Cea708Decoder extends CeaDecoder {
        ...
        while (this.ccData.bytesLeft() >= 3) {
            ...
            if ((i == 2 || i == 3) && z2) {
                if (i == 3) {
                    ...
                    if (!(i3 == -1 || i2 == (i3 + 1) % 4)) {
                        resetCueBuilders();
                        Log.m157w(TAG, "Sequence number discontinuity. previous=" + this.previousSequenceNumber + " current=" + i2);
                    }
    ...
    private void processCurrentPacket() {
        if (this.currentDtvCcPacket.currentIndex != (this.currentDtvCcPacket.packetSize * 2) - 1) {
            Log.m151d(TAG, "DtvCcPacket ended prematurely; size is " + ((this.currentDtvCcPacket.packetSize * 2) - 1) + ", but current index is " + this.currentDtvCcPacket.currentIndex + " (sequence number " + this.currentDtvCcPacket.sequenceNumber + ");");
        }
        boolean z = false;
    ...
    private void handleG2Character(int i) {
        if (i == 32) {
            ...
            this.currentCueInfoBuilder.append(Typography.f558tm);
        } else if (i == 58) {
    ...
    private static final class Cea708CueInfo {
        ...
        public static final Comparator<Cea708CueInfo> LEAST_IMPORTANT_FIRST = Cea708Decoder$Cea708CueInfo$$ExternalSyntheticLambda0.INSTANCE;

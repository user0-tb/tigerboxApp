...
abstract class CeaDecoder implements SubtitleDecoder {
    ...
    public SubtitleOutputBuffer dequeueOutputBuffer() throws SubtitleDecoderException {
        ...
        while (!this.queuedInputBuffers.isEmpty() && ((CeaInputBuffer) C1229Util.castNonNull(this.queuedInputBuffers.peek())).timeUs <= this.playbackPositionUs) {
            CeaInputBuffer ceaInputBuffer = (CeaInputBuffer) C1229Util.castNonNull(this.queuedInputBuffers.poll());
            if (ceaInputBuffer.isEndOfStream()) {
                SubtitleOutputBuffer subtitleOutputBuffer = (SubtitleOutputBuffer) C1229Util.castNonNull(this.availableOutputBuffers.pollFirst());
            ...
            if (isNewSubtitleDataAvailable()) {
                ...
                SubtitleOutputBuffer subtitleOutputBuffer2 = (SubtitleOutputBuffer) C1229Util.castNonNull(this.availableOutputBuffers.pollFirst());
    ...
    public void flush() {
        ...
        while (!this.queuedInputBuffers.isEmpty()) {
            releaseInputBuffer((CeaInputBuffer) C1229Util.castNonNull(this.queuedInputBuffers.poll()));
        }

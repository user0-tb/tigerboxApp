...
public final class Cue implements Bundleable {
    ...
    private static final String FIELD_BITMAP = C1229Util.intToStringMaxRadix(3);
    private static final String FIELD_BITMAP_HEIGHT = C1229Util.intToStringMaxRadix(12);
    private static final String FIELD_LINE = C1229Util.intToStringMaxRadix(4);
    private static final String FIELD_LINE_ANCHOR = C1229Util.intToStringMaxRadix(6);
    private static final String FIELD_LINE_TYPE = C1229Util.intToStringMaxRadix(5);
    private static final String FIELD_MULTI_ROW_ALIGNMENT = C1229Util.intToStringMaxRadix(2);
    private static final String FIELD_POSITION = C1229Util.intToStringMaxRadix(7);
    private static final String FIELD_POSITION_ANCHOR = C1229Util.intToStringMaxRadix(8);
    private static final String FIELD_SHEAR_DEGREES = C1229Util.intToStringMaxRadix(16);
    private static final String FIELD_SIZE = C1229Util.intToStringMaxRadix(11);
    private static final String FIELD_TEXT = C1229Util.intToStringMaxRadix(0);
    private static final String FIELD_TEXT_ALIGNMENT = C1229Util.intToStringMaxRadix(1);
    private static final String FIELD_TEXT_SIZE = C1229Util.intToStringMaxRadix(10);
    private static final String FIELD_TEXT_SIZE_TYPE = C1229Util.intToStringMaxRadix(9);
    private static final String FIELD_VERTICAL_TYPE = C1229Util.intToStringMaxRadix(15);
    private static final String FIELD_WINDOW_COLOR = C1229Util.intToStringMaxRadix(13);
    private static final String FIELD_WINDOW_COLOR_SET = C1229Util.intToStringMaxRadix(14);

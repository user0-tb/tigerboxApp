...
final class SsaSubtitle implements Subtitle {
    ...
    public int getNextEventTimeIndex(long j) {
        int binarySearchCeil = C1229Util.binarySearchCeil(this.cueTimesUs, Long.valueOf(j), false, false);
    ...
    public List<Cue> getCues(long j) {
        int binarySearchFloor = C1229Util.binarySearchFloor(this.cueTimesUs, Long.valueOf(j), true, false);

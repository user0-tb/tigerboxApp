...
public final class PgsDecoder extends SimpleSubtitleDecoder {
    ...
    private void maybeInflateData(ParsableByteArray parsableByteArray) {
        if (parsableByteArray.bytesLeft() > 0 && parsableByteArray.peekUnsignedByte() == 120) {
            ...
            if (C1229Util.inflate(parsableByteArray, this.inflatedBuffer, this.inflater)) {
        ...
        public void parsePaletteSection(ParsableByteArray parsableByteArray, int i) {
            if (i % 5 == 2) {
                ...
                while (i3 < i2) {
                    ...
                    int constrainValue = C1229Util.constrainValue((int) ((d - (0.34414d * d3)) - (d2 * 0.71414d)), 0, 255) << 8;
                    iArr[readUnsignedByte] = C1229Util.constrainValue((int) (d + (d3 * 1.772d)), 0, 255) | constrainValue | (readUnsignedByte5 << 24) | (C1229Util.constrainValue((int) ((1.402d * d2) + d), 0, 255) << 16);
                    i3 = i4 + 1;
                }
                this.colorsSet = true;
            }

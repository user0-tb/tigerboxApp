...
public final class WebvttCueParser {
        ...
        while (matcher.find()) {
            ...
            try {
                if ("line".equals(str2)) {
                    ...
                    Log.m157w(TAG, "Unknown cue setting " + str2 + ":" + str3);
                }
            } catch (NumberFormatException unused) {
    ...
    private static int parseLineAnchor(String str) {
        ...
        switch (c) {
            ...
            case 3:
                return 0;
            default:
                Log.m157w(TAG, "Invalid anchor value: " + str);
    ...
    private static int parseVerticalAttribute(String str) {
        ...
        Log.m157w(TAG, "Invalid 'vertical' value: " + str);
        return Integer.MIN_VALUE;
    }
    ...
    private static int parseTextAlignment(String str) {
        ...
        switch (c) {
            ...
            case 5:
                return 1;
            default:
                Log.m157w(TAG, "Invalid alignment value: " + str);
                return 2;
        }
    }
    ...
    private static void applyEntity(String str, SpannableStringBuilder spannableStringBuilder) {
        ...
        switch (c) {
            ...
            case 3:
                ...
                return;
            default:
                Log.m157w(TAG, "ignoring unsupported entity: '&" + str + ";'");
                return;
        }
    }
    ...
    private static String getTagName(String str) {
        ...
        return C1229Util.splitAtFirst(trim, "[ \\.]")[0];
    }
        ...
        private static Layout.Alignment convertTextAlignment(int i) {
            if (i != 1) {
                ...
                if (i != 3) {
                    if (i != 4) {
                        if (i != 5) {
                            Log.m157w(WebvttCueParser.TAG, "Unknown textAlignment: " + i);
                            return null;
                        }
                    }
                }
    ...
    private static final class StartTag {
        ...
        public static StartTag buildStartTag(String str, int i) {
            ...
            String[] split = C1229Util.split(trim, "\\.");
            String str3 = split[0];

...
final class DvbParser {
    ...
    private static final byte[] defaultMap2To4 = {0, 7, 8, Ascii.f278SI};
        ...
        switch (readBits) {
            ...
            case 17:
                ...
                if (readBits2 == subtitleService2.subtitlePageId && pageComposition2 != null) {
                    ...
                    if (pageComposition2.state == 0 && (regionComposition = subtitleService2.regions.get(parseRegionComposition.f180id)) != null) {
                        parseRegionComposition.mergeFrom(regionComposition);
                    }
                    subtitleService2.regions.put(parseRegionComposition.f180id, parseRegionComposition);
                    break;
                }
            case 18:
                if (readBits2 != subtitleService2.subtitlePageId) {
                    if (readBits2 == subtitleService2.ancillaryPageId) {
                        ...
                        subtitleService2.ancillaryCluts.put(parseClutDefinition.f178id, parseClutDefinition);
                        break;
                    }
                } else {
                    ClutDefinition parseClutDefinition2 = parseClutDefinition(parsableBitArray, readBits3);
                    subtitleService2.cluts.put(parseClutDefinition2.f178id, parseClutDefinition2);
                    break;
                }
                break;
            case 19:
                if (readBits2 != subtitleService2.subtitlePageId) {
                    if (readBits2 == subtitleService2.ancillaryPageId) {
                        ...
                        subtitleService2.ancillaryObjects.put(parseObjectData.f179id, parseObjectData);
                        break;
                    }
                } else {
                    ObjectData parseObjectData2 = parseObjectData(parsableBitArray);
                    subtitleService2.objects.put(parseObjectData2.f179id, parseObjectData2);
                    break;
                }
                break;
            case 20:
    ...
    private static ClutDefinition parseClutDefinition(ParsableBitArray parsableBitArray, int i) {
        ...
        while (i9 > 0) {
            ...
            iArr[readBits2] = getColor((byte) (255 - (i2 & 255)), C1229Util.constrainValue((int) (d + (1.402d * d2)), 0, 255), C1229Util.constrainValue((int) ((d - (0.34414d * d3)) - (d2 * 0.71414d)), 0, 255), C1229Util.constrainValue((int) (d + (d3 * 1.772d)), 0, 255));
            i9 = i6;
            readBits = readBits;
            i7 = 8;
            i8 = 2;
    ...
    private static ObjectData parseObjectData(ParsableBitArray parsableBitArray) {
        ...
        byte[] bArr = C1229Util.EMPTY_BYTE_ARRAY;
        byte[] bArr2 = C1229Util.EMPTY_BYTE_ARRAY;
        if (readBits2 == 1) {
    ...
    private static int[] generateDefault8BitClutEntries() {
        ...
        for (int i = 0; i < 256; i++) {
            ...
            if (i < 8) {
                ...
                int i5 = i & CipherSuite.TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA;
                int i6 = CipherSuite.TLS_DHE_PSK_WITH_AES_128_GCM_SHA256;
                int i7 = 85;
                if (i5 == 0) {
                    int i8 = ((i & 1) != 0 ? 85 : 0) + ((i & 16) != 0 ? CipherSuite.TLS_DHE_PSK_WITH_AES_128_GCM_SHA256 : 0);
                    int i9 = ((i & 2) != 0 ? 85 : 0) + ((i & 32) != 0 ? CipherSuite.TLS_DHE_PSK_WITH_AES_128_GCM_SHA256 : 0);
                    if ((i & 4) == 0) {
                        i7 = 0;
                    }
                    if ((i & 64) == 0) {
                    ...
                    int i16 = ((i & 1) != 0 ? 85 : 0) + ((i & 16) != 0 ? CipherSuite.TLS_DHE_PSK_WITH_AES_128_GCM_SHA256 : 0);
                    int i17 = ((i & 2) != 0 ? 85 : 0) + ((i & 32) != 0 ? CipherSuite.TLS_DHE_PSK_WITH_AES_128_GCM_SHA256 : 0);
                    if ((i & 4) == 0) {
                        i7 = 0;
                    }
                    if ((i & 64) == 0) {

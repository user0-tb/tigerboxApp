...
public final class MediaMetadata implements Bundleable {
    ...
    private static final String FIELD_ALBUM_ARTIST = C1229Util.intToStringMaxRadix(3);
    private static final String FIELD_ALBUM_TITLE = C1229Util.intToStringMaxRadix(2);
    private static final String FIELD_ARTIST = C1229Util.intToStringMaxRadix(1);
    private static final String FIELD_ARTWORK_DATA = C1229Util.intToStringMaxRadix(10);
    private static final String FIELD_ARTWORK_DATA_TYPE = C1229Util.intToStringMaxRadix(29);
    private static final String FIELD_ARTWORK_URI = C1229Util.intToStringMaxRadix(11);
    private static final String FIELD_COMPILATION = C1229Util.intToStringMaxRadix(28);
    private static final String FIELD_COMPOSER = C1229Util.intToStringMaxRadix(23);
    private static final String FIELD_CONDUCTOR = C1229Util.intToStringMaxRadix(24);
    private static final String FIELD_DESCRIPTION = C1229Util.intToStringMaxRadix(6);
    private static final String FIELD_DISC_NUMBER = C1229Util.intToStringMaxRadix(25);
    private static final String FIELD_DISPLAY_TITLE = C1229Util.intToStringMaxRadix(4);
    private static final String FIELD_EXTRAS = C1229Util.intToStringMaxRadix(1000);
    private static final String FIELD_FOLDER_TYPE = C1229Util.intToStringMaxRadix(14);
    private static final String FIELD_GENRE = C1229Util.intToStringMaxRadix(27);
    private static final String FIELD_IS_BROWSABLE = C1229Util.intToStringMaxRadix(32);
    private static final String FIELD_IS_PLAYABLE = C1229Util.intToStringMaxRadix(15);
    private static final String FIELD_MEDIA_TYPE = C1229Util.intToStringMaxRadix(31);
    private static final String FIELD_OVERALL_RATING = C1229Util.intToStringMaxRadix(9);
    private static final String FIELD_RECORDING_DAY = C1229Util.intToStringMaxRadix(18);
    private static final String FIELD_RECORDING_MONTH = C1229Util.intToStringMaxRadix(17);
    private static final String FIELD_RECORDING_YEAR = C1229Util.intToStringMaxRadix(16);
    private static final String FIELD_RELEASE_DAY = C1229Util.intToStringMaxRadix(21);
    private static final String FIELD_RELEASE_MONTH = C1229Util.intToStringMaxRadix(20);
    private static final String FIELD_RELEASE_YEAR = C1229Util.intToStringMaxRadix(19);
    private static final String FIELD_STATION = C1229Util.intToStringMaxRadix(30);
    private static final String FIELD_SUBTITLE = C1229Util.intToStringMaxRadix(5);
    private static final String FIELD_TITLE = C1229Util.intToStringMaxRadix(0);
    private static final String FIELD_TOTAL_DISC_COUNT = C1229Util.intToStringMaxRadix(26);
    private static final String FIELD_TOTAL_TRACK_COUNT = C1229Util.intToStringMaxRadix(13);
    private static final String FIELD_TRACK_NUMBER = C1229Util.intToStringMaxRadix(12);
    private static final String FIELD_USER_RATING = C1229Util.intToStringMaxRadix(8);
    private static final String FIELD_WRITER = C1229Util.intToStringMaxRadix(22);
    ...
    public static final class Builder {
        ...
        public Builder maybeSetArtworkData(byte[] bArr, int i) {
            if (this.artworkData == null || C1229Util.areEqual(Integer.valueOf(i), 3) || !C1229Util.areEqual(this.artworkDataType, 3)) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!C1229Util.areEqual(this.title, mediaMetadata.title) || !C1229Util.areEqual(this.artist, mediaMetadata.artist) || !C1229Util.areEqual(this.albumTitle, mediaMetadata.albumTitle) || !C1229Util.areEqual(this.albumArtist, mediaMetadata.albumArtist) || !C1229Util.areEqual(this.displayTitle, mediaMetadata.displayTitle) || !C1229Util.areEqual(this.subtitle, mediaMetadata.subtitle) || !C1229Util.areEqual(this.description, mediaMetadata.description) || !C1229Util.areEqual(this.userRating, mediaMetadata.userRating) || !C1229Util.areEqual(this.overallRating, mediaMetadata.overallRating) || !Arrays.equals(this.artworkData, mediaMetadata.artworkData) || !C1229Util.areEqual(this.artworkDataType, mediaMetadata.artworkDataType) || !C1229Util.areEqual(this.artworkUri, mediaMetadata.artworkUri) || !C1229Util.areEqual(this.trackNumber, mediaMetadata.trackNumber) || !C1229Util.areEqual(this.totalTrackCount, mediaMetadata.totalTrackCount) || !C1229Util.areEqual(this.folderType, mediaMetadata.folderType) || !C1229Util.areEqual(this.isBrowsable, mediaMetadata.isBrowsable) || !C1229Util.areEqual(this.isPlayable, mediaMetadata.isPlayable) || !C1229Util.areEqual(this.recordingYear, mediaMetadata.recordingYear) || !C1229Util.areEqual(this.recordingMonth, mediaMetadata.recordingMonth) || !C1229Util.areEqual(this.recordingDay, mediaMetadata.recordingDay) || !C1229Util.areEqual(this.releaseYear, mediaMetadata.releaseYear) || !C1229Util.areEqual(this.releaseMonth, mediaMetadata.releaseMonth) || !C1229Util.areEqual(this.releaseDay, mediaMetadata.releaseDay) || !C1229Util.areEqual(this.writer, mediaMetadata.writer) || !C1229Util.areEqual(this.composer, mediaMetadata.composer) || !C1229Util.areEqual(this.conductor, mediaMetadata.conductor) || !C1229Util.areEqual(this.discNumber, mediaMetadata.discNumber) || !C1229Util.areEqual(this.totalDiscCount, mediaMetadata.totalDiscCount) || !C1229Util.areEqual(this.genre, mediaMetadata.genre) || !C1229Util.areEqual(this.compilation, mediaMetadata.compilation) || !C1229Util.areEqual(this.station, mediaMetadata.station) || !C1229Util.areEqual(this.mediaType, mediaMetadata.mediaType)) {
            return false;
        }
        return true;
    }

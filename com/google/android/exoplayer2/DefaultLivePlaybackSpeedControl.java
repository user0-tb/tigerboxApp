...
public final class DefaultLivePlaybackSpeedControl implements LivePlaybackSpeedControl {
    ...
    public static final class Builder {
        ...
        private long maxLiveOffsetErrorUsForUnitSpeed = C1229Util.msToUs(20);
        ...
        private long targetLiveOffsetIncrementOnRebufferUs = C1229Util.msToUs(500);
        ...
        public Builder setMaxLiveOffsetErrorMsForUnitSpeed(long j) {
            Assertions.checkArgument(j > 0);
            this.maxLiveOffsetErrorUsForUnitSpeed = C1229Util.msToUs(j);
            return this;
        }

        public Builder setTargetLiveOffsetIncrementOnRebufferMs(long j) {
            Assertions.checkArgument(j >= 0);
            this.targetLiveOffsetIncrementOnRebufferUs = C1229Util.msToUs(j);
            return this;
        }
    ...
    private DefaultLivePlaybackSpeedControl(float f, float f2, long j, float f3, long j2, long j3, float f4) {
        ...
        this.mediaConfigurationTargetLiveOffsetUs = C0963C.TIME_UNSET;
        this.targetLiveOffsetOverrideUs = C0963C.TIME_UNSET;
        this.minTargetLiveOffsetUs = C0963C.TIME_UNSET;
        this.maxTargetLiveOffsetUs = C0963C.TIME_UNSET;
        this.minPlaybackSpeed = f;
        this.maxPlaybackSpeed = f2;
        this.adjustedPlaybackSpeed = 1.0f;
        this.lastPlaybackSpeedUpdateMs = C0963C.TIME_UNSET;
        this.idealTargetLiveOffsetUs = C0963C.TIME_UNSET;
        this.currentTargetLiveOffsetUs = C0963C.TIME_UNSET;
        this.smoothedMinPossibleLiveOffsetUs = C0963C.TIME_UNSET;
        this.smoothedMinPossibleLiveOffsetDeviationUs = C0963C.TIME_UNSET;
    }

    public void setLiveConfiguration(MediaItem.LiveConfiguration liveConfiguration) {
        float f;
        float f2;
        this.mediaConfigurationTargetLiveOffsetUs = C1229Util.msToUs(liveConfiguration.targetOffsetMs);
        this.minTargetLiveOffsetUs = C1229Util.msToUs(liveConfiguration.minOffsetMs);
        this.maxTargetLiveOffsetUs = C1229Util.msToUs(liveConfiguration.maxOffsetMs);
    ...
    public float getAdjustedPlaybackSpeed(long j, long j2) {
        if (this.mediaConfigurationTargetLiveOffsetUs == C0963C.TIME_UNSET) {
            return 1.0f;
        }
        updateSmoothedMinPossibleLiveOffsetUs(j, j2);
        if (this.lastPlaybackSpeedUpdateMs != C0963C.TIME_UNSET && SystemClock.elapsedRealtime() - this.lastPlaybackSpeedUpdateMs < this.minUpdateIntervalMs) {
        ...
        if (Math.abs(j3) < this.maxLiveOffsetErrorUsForUnitSpeed) {
            ...
            this.adjustedPlaybackSpeed = C1229Util.constrainValue((this.proportionalControlFactor * ((float) j3)) + 1.0f, this.minPlaybackSpeed, this.maxPlaybackSpeed);
        }
        return this.adjustedPlaybackSpeed;
    }
    ...
    private void adjustTargetLiveOffsetUs(long j) {
        ...
        if (this.currentTargetLiveOffsetUs > j2) {
            float msToUs = (float) C1229Util.msToUs(this.minUpdateIntervalMs);
        ...
        long constrainValue = C1229Util.constrainValue(j - ((long) (Math.max(0.0f, this.adjustedPlaybackSpeed - 1.0f) / this.proportionalControlFactor)), this.currentTargetLiveOffsetUs, j2);
        this.currentTargetLiveOffsetUs = constrainValue;
        long j3 = this.maxTargetLiveOffsetUs;
        if (j3 != C0963C.TIME_UNSET && constrainValue > j3) {
            this.currentTargetLiveOffsetUs = j3;
        }
    }
}

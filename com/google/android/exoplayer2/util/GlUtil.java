...
public final class GlUtil {
    ...
    public static boolean isProtectedContentExtensionSupported(Context context) {
        ...
        if (C1229Util.SDK_INT < 26 && ("samsung".equals(C1229Util.MANUFACTURER) || "XT1650".equals(C1229Util.MODEL))) {
            return false;
        }
        if ((C1229Util.SDK_INT >= 26 || context.getPackageManager().hasSystemFeature("android.hardware.vr.high_performance")) && (eglQueryString = EGL14.eglQueryString(EGL14.eglGetDisplay(0), 12373)) != null && eglQueryString.contains(EXTENSION_PROTECTED_CONTENT)) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isSurfacelessContextExtensionSupported() {
        String eglQueryString;
        if (C1229Util.SDK_INT >= 17 && (eglQueryString = EGL14.eglQueryString(EGL14.eglGetDisplay(0), 12373)) != null && eglQueryString.contains(EXTENSION_SURFACELESS_CONTEXT)) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isYuvTargetExtensionSupported() {
        ...
        if (C1229Util.areEqual(EGL14.eglGetCurrentContext(), EGL14.EGL_NO_CONTEXT)) {
            try {
    ...
    public static int createTexture(int i, int i2, boolean z) throws GlException {
        ...
        Assertions.checkState(C1229Util.SDK_INT >= 18, "GLES30 extensions are not supported below API 18.");
    ...
    private static int generateTexture() throws GlException {
        checkGlException(!C1229Util.areEqual(EGL14.eglGetCurrentContext(), EGL14.EGL_NO_CONTEXT), "No current context");
        int[] iArr = new int[1];
    ...
    private static final class Api17 {
        ...
        public static void focusFramebufferUsingCurrentContext(int i, int i2, int i3) throws GlException {
            GlUtil.checkGlException(!C1229Util.areEqual(EGL14.eglGetCurrentContext(), EGL14.EGL_NO_CONTEXT), "No current context");
            int[] iArr = new int[1];

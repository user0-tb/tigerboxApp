...
public final class AdPlaybackState implements Bundleable {
    ...
    private static final String FIELD_AD_GROUPS = C1229Util.intToStringMaxRadix(1);
    private static final String FIELD_AD_RESUME_POSITION_US = C1229Util.intToStringMaxRadix(2);
    private static final String FIELD_CONTENT_DURATION_US = C1229Util.intToStringMaxRadix(3);
    private static final String FIELD_REMOVED_AD_GROUP_COUNT = C1229Util.intToStringMaxRadix(4);
    public static final AdPlaybackState NONE = new AdPlaybackState((Object) null, new AdGroup[0], 0, C0963C.TIME_UNSET, 0);
    ...
    public static final class AdGroup implements Bundleable {
        ...
        private static final String FIELD_CONTENT_RESUME_OFFSET_US = C1229Util.intToStringMaxRadix(5);
        private static final String FIELD_COUNT = C1229Util.intToStringMaxRadix(1);
        private static final String FIELD_DURATIONS_US = C1229Util.intToStringMaxRadix(4);
        private static final String FIELD_IS_SERVER_SIDE_INSERTED = C1229Util.intToStringMaxRadix(6);
        private static final String FIELD_ORIGINAL_COUNT = C1229Util.intToStringMaxRadix(7);
        private static final String FIELD_STATES = C1229Util.intToStringMaxRadix(3);
        private static final String FIELD_TIME_US = C1229Util.intToStringMaxRadix(0);
        private static final String FIELD_URIS = C1229Util.intToStringMaxRadix(2);
        ...
        public AdGroup withLastAdRemoved() {
            ...
            long[] jArr2 = jArr;
            return new AdGroup(this.timeUs, length, this.originalCount, copyOf, uriArr, jArr2, C1229Util.sum(jArr2), this.isServerSideInserted);
        }
        ...
        private static long[] copyDurationsUsWithSpaceForAdCount(long[] jArr, int i) {
            ...
            Arrays.fill(copyOf, length, max, C0963C.TIME_UNSET);
            return copyOf;
        }
    ...
    public AdPlaybackState(Object obj, long... jArr) {
        this(obj, createEmptyAdGroups(jArr), 0, C0963C.TIME_UNSET, 0);
    }
    ...
    public AdPlaybackState withAdGroupTimeUs(int i, long j) {
        ...
        AdGroup[] adGroupArr2 = (AdGroup[]) C1229Util.nullSafeArrayCopy(adGroupArr, adGroupArr.length);
    ...
    public AdPlaybackState withNewAdGroup(int i, long j) {
        ...
        AdGroup[] adGroupArr = (AdGroup[]) C1229Util.nullSafeArrayAppend(this.adGroups, adGroup);
    ...
    private boolean isPositionBeforeAdGroup(long j, long j2, int i) {
        ...
        return j3 == Long.MIN_VALUE ? j2 == C0963C.TIME_UNSET || j < j2 : j < j3;
    }

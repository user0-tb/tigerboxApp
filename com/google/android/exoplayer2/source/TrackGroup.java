...
public final class TrackGroup implements Bundleable {
    ...
    private static final String FIELD_FORMATS = C1229Util.intToStringMaxRadix(0);
    private static final String FIELD_ID = C1229Util.intToStringMaxRadix(1);
    private static final String TAG = "TrackGroup";
    private final Format[] formats;
    private int hashCode;

    /* renamed from: id */
    public final String f170id;
    ...
    public int hashCode() {
        if (this.hashCode == 0) {
            this.hashCode = ((527 + this.f170id.hashCode()) * 31) + Arrays.hashCode(this.formats);
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (!this.f170id.equals(trackGroup.f170id) || !Arrays.equals(this.formats, trackGroup.formats)) {
            return false;
        }
        return true;
    }
    ...
    public Bundle toBundle() {
        ...
        bundle.putString(FIELD_ID, this.f170id);
        return bundle;
    }
    ...
    private static String normalizeLanguage(String str) {
        return (str == null || str.equals(C0963C.LANGUAGE_UNDETERMINED)) ? "" : str;
    }

    private static void logErrorMessage(String str, String str2, String str3, int i) {
        Log.m154e(TAG, "", new IllegalStateException("Different " + str + " combined in one TrackGroup: '" + str2 + "' (track 0) and '" + str3 + "' (track " + i + ")"));
    }
}

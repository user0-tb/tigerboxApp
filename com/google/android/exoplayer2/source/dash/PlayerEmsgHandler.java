...
public final class PlayerEmsgHandler implements Handler.Callback {
    ...
    /* access modifiers changed from: private */
    public final Handler handler = C1229Util.createHandlerForCurrentLooper(this);
    ...
    public static long getManifestPublishTimeMsInEmsg(EventMessage eventMessage) {
        try {
            return C1229Util.parseXsDateTime(C1229Util.fromUtf8Bytes(eventMessage.messageData));
    ...
    public final class PlayerTrackEmsgHandler implements TrackOutput {
        ...
        private long maxLoadedChunkEndTimeUs = C0963C.TIME_UNSET;
        ...
        public void onChunkLoadCompleted(Chunk chunk) {
            if (this.maxLoadedChunkEndTimeUs == C0963C.TIME_UNSET || chunk.endTimeUs > this.maxLoadedChunkEndTimeUs) {
        ...
        public boolean onChunkLoadError(Chunk chunk) {
            ...
            return PlayerEmsgHandler.this.onChunkLoadError(j != C0963C.TIME_UNSET && j < chunk.startTimeUs);
        }
        ...
        private void parsePlayerEmsgEvent(long j, EventMessage eventMessage) {
            ...
            if (access$200 != C0963C.TIME_UNSET) {

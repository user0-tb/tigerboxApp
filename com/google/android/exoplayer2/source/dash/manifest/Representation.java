...
public abstract class Representation {
    ...
    public static Representation newInstance(long j, Format format2, List<BaseUrl> list, SegmentBase segmentBase) {
        return newInstance(j, format2, list, segmentBase, (List<Descriptor>) null, ImmutableList.m261of(), ImmutableList.m261of(), (String) null);
    }
    ...
    public static class SingleSegmentRepresentation extends Representation {
        ...
        public static SingleSegmentRepresentation newInstance(long j, Format format, String str, long j2, long j3, long j4, long j5, List<Descriptor> list, String str2, long j6) {
            return new SingleSegmentRepresentation(j, format, ImmutableList.m262of(new BaseUrl(str)), new SegmentBase.SingleSegmentBase(new RangedUri((String) null, j2, (j3 - j2) + 1), 1, 0, j4, (j5 - j4) + 1), list, ImmutableList.m261of(), ImmutableList.m261of(), str2, j6);
        }

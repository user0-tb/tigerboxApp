...
public final class ProgramInformation {
    ...
    public boolean equals(Object obj) {
        ...
        if (!C1229Util.areEqual(this.title, programInformation.title) || !C1229Util.areEqual(this.source, programInformation.source) || !C1229Util.areEqual(this.copyright, programInformation.copyright) || !C1229Util.areEqual(this.moreInformationURL, programInformation.moreInformationURL) || !C1229Util.areEqual(this.lang, programInformation.lang)) {
            return false;
        }
        return true;
    }

...
public abstract class SegmentBase {
    ...
    public long getPresentationTimeOffsetUs() {
        return C1229Util.scaleLargeTimestamp(this.presentationTimeOffset, 1000000, this.timescale);
    }
    ...
    public static abstract class MultiSegmentBase extends SegmentBase {
        ...
        public final long getSegmentTimeUs(long j) {
            ...
            return C1229Util.scaleLargeTimestamp(j2, 1000000, this.timescale);
        }
    ...
    public static final class SegmentTemplate extends MultiSegmentBase {
        ...
        public RangedUri getInitialization(Representation representation) {
            ...
            if (urlTemplate != null) {
                return new RangedUri(urlTemplate.buildUri(representation.format.f144id, 0, representation.format.bitrate, 0), 0, -1);
            }
        ...
        public RangedUri getSegmentUrl(Representation representation, long j) {
            ...
            long j3 = j2;
            return new RangedUri(this.mediaTemplate.buildUri(representation2.format.f144id, j, representation2.format.bitrate, j3), 0, -1);
        }

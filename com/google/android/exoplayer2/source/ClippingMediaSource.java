...
public final class ClippingMediaSource extends WrappingMediaSource {
    ...
    private static final class ClippingTimeline extends ForwardingTimeline {
        ...
        public ClippingTimeline(Timeline timeline, long j, long j2) throws IllegalClippingException {
            ...
            if (timeline.getPeriodCount() == 1) {
                ...
                if (window.isPlaceholder || max == 0 || window.isSeekable) {
                    ...
                    this.startUs = max;
                    this.endUs = max2;
                    int i = (max2 > C0963C.TIME_UNSET ? 1 : (max2 == C0963C.TIME_UNSET ? 0 : -1));
                    this.durationUs = i == 0 ? -9223372036854775807L : max2 - max;
                    if (window.isDynamic && (i == 0 || (window.durationUs != C0963C.TIME_UNSET && max2 == window.durationUs))) {
                        z = true;
                    }
                    this.isDynamic = z;
                    return;
        ...
        public Timeline.Window getWindow(int i, Timeline.Window window, long j) {
            ...
            if (window.defaultPositionUs != C0963C.TIME_UNSET) {
                window.defaultPositionUs = Math.max(window.defaultPositionUs, this.startUs);
                int i2 = (this.endUs > C0963C.TIME_UNSET ? 1 : (this.endUs == C0963C.TIME_UNSET ? 0 : -1));
            ...
            long usToMs = C1229Util.usToMs(this.startUs);
            if (window.presentationStartTimeMs != C0963C.TIME_UNSET) {
                window.presentationStartTimeMs += usToMs;
            }
            if (window.windowStartTimeMs != C0963C.TIME_UNSET) {
        ...
        public Timeline.Period getPeriod(int i, Timeline.Period period, boolean z) {
            ...
            return period.set(period.f150id, period.uid, 0, j == C0963C.TIME_UNSET ? -9223372036854775807L : j - positionInWindowUs, positionInWindowUs);
        }
    }
}

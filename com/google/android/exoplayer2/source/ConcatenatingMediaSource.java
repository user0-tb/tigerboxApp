...
public final class ConcatenatingMediaSource extends CompositeMediaSource<MediaSourceHolder> {
    ...
    private void removePublicMediaSources(int i, int i2, Handler handler, Runnable runnable) {
        ...
        Assertions.checkArgument(z);
        Handler handler2 = this.playbackThreadHandler;
        C1229Util.removeRange(this.mediaSourcesPublic, i, i2);
        if (handler2 != null) {
    ...
    public boolean handleMessage(Message message) {
        int i = message.what;
        if (i == 0) {
            MessageData messageData = (MessageData) C1229Util.castNonNull(message.obj);
            ...
            MessageData messageData2 = (MessageData) C1229Util.castNonNull(message.obj);
            ...
            MessageData messageData3 = (MessageData) C1229Util.castNonNull(message.obj);
            ...
            MessageData messageData4 = (MessageData) C1229Util.castNonNull(message.obj);
            this.shuffleOrder = (ShuffleOrder) messageData4.customData;
            scheduleTimelineUpdate(messageData4.onCompletionAction);
        } else if (i == 4) {
            updateTimelineAndScheduleOnCompletionActions();
        } else if (i == 5) {
            dispatchOnCompletionActions((Set) C1229Util.castNonNull(message.obj));
        } else {
    ...
    private static final class ConcatenatedTimeline extends AbstractConcatenatedTimeline {
        ...
        public int getChildIndexByPeriodIndex(int i) {
            return C1229Util.binarySearchFloor(this.firstPeriodInChildIndices, i + 1, false, false);
        }

        /* access modifiers changed from: protected */
        public int getChildIndexByWindowIndex(int i) {
            return C1229Util.binarySearchFloor(this.firstWindowInChildIndices, i + 1, false, false);
        }

...
final class RtspMessageChannel implements Closeable {
    ...
    /* access modifiers changed from: private */
    public final Map<Integer, InterleavedBinaryDataListener> interleavedBinaryDataListeners = DesugarCollections.synchronizedMap(new HashMap());
    /* access modifiers changed from: private */
    ...
    private final class Sender implements Closeable {
        ...
        public /* synthetic */ void mo18695x9fa6909d(byte[] bArr, List list) {
            try {

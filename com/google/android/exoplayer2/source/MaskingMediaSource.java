...
public final class MaskingMediaSource extends WrappingMediaSource {
    ...
    public void onChildSourceInfoRefreshed(com.google.android.exoplayer2.Timeline r15) {
        ...
        L_0x0036:
            ...
            com.google.android.exoplayer2.source.MediaSource$MediaPeriodId r7 = r7.f168id
        ...
        L_0x0098:
            ...
            com.google.android.exoplayer2.source.MediaSource$MediaPeriodId r0 = r15.f168id
            com.google.android.exoplayer2.source.MediaSource$MediaPeriodId r15 = r15.f168id
    ...
    private void setPreparePositionOverrideToUnpreparedMaskingPeriod(long j) {
        ...
        int indexOfPeriod = this.timeline.getIndexOfPeriod(maskingMediaPeriod.f168id.periodUid);
        if (indexOfPeriod != -1) {
    ...
    private static final class MaskingTimeline extends ForwardingTimeline {
        ...
        public Timeline.Window getWindow(int i, Timeline.Window window, long j) {
            ...
            if (C1229Util.areEqual(window.uid, this.replacedInternalWindowUid)) {
        ...
        public Timeline.Period getPeriod(int i, Timeline.Period period, boolean z) {
            ...
            if (C1229Util.areEqual(period.uid, this.replacedInternalPeriodUid) && z) {
        ...
        public Object getUidOfPeriod(int i) {
            ...
            return C1229Util.areEqual(uidOfPeriod, this.replacedInternalPeriodUid) ? MASKING_EXTERNAL_PERIOD_UID : uidOfPeriod;
        }
    }
    ...
    public static final class PlaceholderTimeline extends Timeline {
        ...
        public Timeline.Window getWindow(int i, Timeline.Window window, long j) {
            ...
            window.set(Timeline.Window.SINGLE_WINDOW_UID, this.mediaItem, (Object) null, C0963C.TIME_UNSET, C0963C.TIME_UNSET, C0963C.TIME_UNSET, false, true, (MediaItem.LiveConfiguration) null, 0, C0963C.TIME_UNSET, 0, 0, 0);
        ...
        public Timeline.Period getPeriod(int i, Timeline.Period period, boolean z) {
            ...
            period.set(num, obj, 0, C0963C.TIME_UNSET, 0, AdPlaybackState.NONE, true);
            return period;
        }

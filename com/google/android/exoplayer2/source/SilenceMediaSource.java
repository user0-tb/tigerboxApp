...
public final class SilenceMediaSource extends BaseMediaSource {
    ...
    /* access modifiers changed from: private */
    public static final byte[] SILENCE_SAMPLE = new byte[(C1229Util.getPcmFrameSize(2, 2) * 1024)];
    ...
    private static final class SilenceMediaPeriod implements MediaPeriod {
        ...
        private long constrainSeekPosition(long j) {
            return C1229Util.constrainValue(j, 0, this.durationUs);
        }
    }
    ...
    private static final class SilenceSampleStream implements SampleStream {
        ...
        public void seekTo(long j) {
            this.positionBytes = C1229Util.constrainValue(SilenceMediaSource.getAudioByteCount(j), 0, this.durationBytes);
        }
    ...
    public static long getAudioByteCount(long j) {
        return ((long) C1229Util.getPcmFrameSize(2, 2)) * ((j * 44100) / 1000000);
    }

    /* access modifiers changed from: private */
    public static long getAudioPositionUs(long j) {
        return ((j / ((long) C1229Util.getPcmFrameSize(2, 2))) * 1000000) / 44100;
    }
}

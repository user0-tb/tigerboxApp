...
public final class OutputConsumerAdapterV30 implements MediaParser.OutputConsumer {
    ...
    public OutputConsumerAdapterV30(Format format, int i, boolean z) {
        ...
        this.sampleTimestampUpperLimitFilterUs = C0963C.TIME_UNSET;
        this.muxedCaptionFormats = ImmutableList.m261of();
    }
        ...
        if (!this.expectDummySeekMap || this.dummySeekMap != null) {
            ...
            if (this.seekingDisabled) {
                if (durationMicros == -2147483648L) {
                    durationMicros = C0963C.TIME_UNSET;
                }
    ...
    private TrackOutput.CryptoData toExoPlayerCryptoData(int i, MediaCodec.CryptoInfo cryptoInfo) {
        ...
        try {
            ...
            matcher.find();
            int parseInt = Integer.parseInt((String) C1229Util.castNonNull(matcher.group(1)));
            i2 = Integer.parseInt((String) C1229Util.castNonNull(matcher.group(2)));
            i3 = parseInt;
        } catch (RuntimeException e) {
            Log.m154e(TAG, "Unexpected error while parsing CryptoInfo: " + cryptoInfo, e);
            i2 = 0;
        }
    ...
    private Format toExoPlayerFormat(MediaParser.TrackData trackData) {
        ...
        while (true) {
            ...
            if (C1229Util.areEqual(format.sampleMimeType, string) && format.accessibilityChannel == integer) {
    ...
    private static final class SeekMapAdapter implements SeekMap {
        ...
        public long getDurationUs() {
            ...
            return durationMicros != -2147483648L ? durationMicros : C0963C.TIME_UNSET;
        }
    ...
    private static final class DataReaderAdapter implements DataReader {
        ...
        public int read(byte[] bArr, int i, int i2) throws IOException {
            return ((MediaParser.InputReader) C1229Util.castNonNull(this.input)).read(bArr, i, i2);
        }
    }
}

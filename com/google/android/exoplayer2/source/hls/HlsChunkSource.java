...
class HlsChunkSource {
    ...
    private long liveEdgeInPeriodTimeUs = C0963C.TIME_UNSET;
    ...
    private byte[] scratchSpace = C1229Util.EMPTY_BYTE_ARRAY;
    ...
    public long getAdjustedSeekPositionUs(long j, SeekParameters seekParameters) {
        ...
        int binarySearchFloor = C1229Util.binarySearchFloor(playlistSnapshot.segments, Long.valueOf(j2), true, true);
    ...
    public int getChunkPublicationState(HlsMediaChunk hlsMediaChunk) {
        ...
        if (C1229Util.areEqual(Uri.parse(UriUtil.resolve(hlsMediaPlaylist.baseUri, part.url)), hlsMediaChunk.dataSpec.uri)) {
            return 1;
        }
        return 2;
    }
    ...
    public void getNextChunk(long j, long j2, List<HlsMediaChunk> list, boolean z, HlsChunkHolder hlsChunkHolder) {
        ...
        if (hlsMediaChunk != null && !this.independentSegments) {
            ...
            if (resolveTimeToLiveEdgeUs != C0963C.TIME_UNSET) {
    ...
    public boolean onPlaylistError(Uri uri, long j) {
        ...
        this.seenExpectedPlaylistError |= uri.equals(this.expectedPlaylistUrl);
        if (j == C0963C.TIME_UNSET || (this.trackSelection.blacklist(indexOf, j) && this.playlistTracker.excludeMediaPlaylist(uri, j))) {
            return true;
        }
        return false;
    }
    ...
    static List<HlsMediaPlaylist.SegmentBase> getSegmentBaseList(HlsMediaPlaylist hlsMediaPlaylist, long j, int i) {
        ...
        if (hlsMediaPlaylist.partTargetDurationUs != C0963C.TIME_UNSET) {
            if (i != -1) {
                i3 = i;
            }
    ...
    public boolean obtainsChunksForPlaylist(Uri uri) {
        return C1229Util.contains(this.playlistUrls, uri);
    }
    ...
    private Pair<Long, Integer> getNextMediaSequenceAndPartIndex(HlsMediaChunk hlsMediaChunk, boolean z, HlsMediaPlaylist hlsMediaPlaylist, long j, long j2) {
        ...
        if (hlsMediaChunk == null || z) {
            ...
            long j5 = j2 - j;
            int i2 = 0;
            int binarySearchFloor = C1229Util.binarySearchFloor(hlsMediaPlaylist.segments, Long.valueOf(j5), true, !this.playlistTracker.isLive() || hlsMediaChunk == null);
    ...
    private long resolveTimeToLiveEdgeUs(long j) {
        ...
        return (j2 > C0963C.TIME_UNSET ? 1 : (j2 == C0963C.TIME_UNSET ? 0 : -1)) != 0 ? j2 - j : C0963C.TIME_UNSET;
    }

...
public final class DefaultHlsPlaylistTracker implements HlsPlaylistTracker, Loader.Callback<ParsingLoadable<HlsPlaylist>> {
    ...
    public DefaultHlsPlaylistTracker(HlsDataSourceFactory hlsDataSourceFactory, LoadErrorHandlingPolicy loadErrorHandlingPolicy2, HlsPlaylistParserFactory hlsPlaylistParserFactory, double d) {
        ...
        this.initialStartTimeUs = C0963C.TIME_UNSET;
    }
    ...
    public void start(Uri uri, MediaSourceEventListener.EventDispatcher eventDispatcher2, HlsPlaylistTracker.PrimaryPlaylistListener primaryPlaylistListener2) {
        this.playlistRefreshHandler = C1229Util.createHandlerForCurrentLooper();
    ...
    public Loader.LoadErrorAction onLoadError(ParsingLoadable<HlsPlaylist> parsingLoadable, long j, long j2, IOException iOException, int i) {
        ...
        boolean z = retryDelayMsFor == C0963C.TIME_UNSET;
    ...
    private final class MediaPlaylistBundle implements Loader.Callback<ParsingLoadable<HlsPlaylist>> {
        ...
        public boolean isSnapshotValid() {
            ...
            long elapsedRealtime = SystemClock.elapsedRealtime();
            long max = Math.max(30000, C1229Util.usToMs(this.playlistSnapshot.durationUs));
        ...
        public Loader.LoadErrorAction onLoadError(ParsingLoadable<HlsPlaylist> parsingLoadable, long j, long j2, IOException iOException, int i) {
            ...
            if ((parsingLoadable.getUri().getQueryParameter(BLOCK_MSN_PARAM) != null) || z) {
                ...
                if (z || i2 == 400 || i2 == 503) {
                    ...
                    loadPlaylist();
                    ((MediaSourceEventListener.EventDispatcher) C1229Util.castNonNull(DefaultHlsPlaylistTracker.this.eventDispatcher)).loadError(loadEventInfo, parsingLoadable2.type, iOException2, true);
        ...
        public void loadPlaylistInternal(Uri uri) {
            ...
            if (!this.loadPending && !this.mediaPlaylistLoader.isLoading() && !this.mediaPlaylistLoader.hasFatalError()) {
                ...
                if (elapsedRealtime < this.earliestNextLoadTimeMs) {
                    ...
                    DefaultHlsPlaylistTracker.this.playlistRefreshHandler.postDelayed(new C1149x8000b21b(this, uri), this.earliestNextLoadTimeMs - elapsedRealtime);
                    return;
                }
        ...
        public /* synthetic */ void mo18527x4fadff69(Uri uri) {
        ...
        public void processLoadedPlaylist(HlsMediaPlaylist hlsMediaPlaylist, LoadEventInfo loadEventInfo) {
            ...
            if (access$1400 != hlsMediaPlaylist2) {
                ...
                if (hlsMediaPlaylist.mediaSequence + ((long) hlsMediaPlaylist.segments.size()) < this.playlistSnapshot.mediaSequence) {
                    ...
                    if (((double) (elapsedRealtime - this.lastSnapshotChangeMs)) > ((double) C1229Util.usToMs(this.playlistSnapshot.targetDurationUs)) * DefaultHlsPlaylistTracker.this.playlistStuckTargetDurationCoefficient) {
            ...
            this.earliestNextLoadTimeMs = elapsedRealtime + C1229Util.usToMs(j);
            if (this.playlistSnapshot.partTargetDurationUs != C0963C.TIME_UNSET || this.playlistUrl.equals(DefaultHlsPlaylistTracker.this.primaryMediaPlaylistUrl)) {
                z2 = true;
            }
        ...
        private Uri getMediaPlaylistUriForReload() {
            ...
            if (hlsMediaPlaylist == null || (hlsMediaPlaylist.serverControl.skipUntilUs == C0963C.TIME_UNSET && !this.playlistSnapshot.serverControl.canBlockReload)) {
            ...
            if (this.playlistSnapshot.serverControl.canBlockReload) {
                ...
                if (this.playlistSnapshot.partTargetDurationUs != C0963C.TIME_UNSET) {
            ...
            if (this.playlistSnapshot.serverControl.skipUntilUs != C0963C.TIME_UNSET) {
    ...
    private class FirstPrimaryMediaPlaylistListener implements HlsPlaylistTracker.PlaylistEventListener {
        ...
        public boolean onPlaylistError(Uri uri, LoadErrorHandlingPolicy.LoadErrorInfo loadErrorInfo, boolean z) {
            ...
            if (DefaultHlsPlaylistTracker.this.primaryMediaPlaylistSnapshot == null) {
                long elapsedRealtime = SystemClock.elapsedRealtime();
                List<HlsMultivariantPlaylist.Variant> list = ((HlsMultivariantPlaylist) C1229Util.castNonNull(DefaultHlsPlaylistTracker.this.multivariantPlaylist)).variants;
                int i = 0;

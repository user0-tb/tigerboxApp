...
public class SsManifest implements FilterableManifest<SsManifest> {
    ...
    public static class StreamElement {
        ...
        public StreamElement(String str, String str2, int i, String str3, long j, String str4, int i2, int i3, int i4, int i5, String str5, Format[] formatArr, List<Long> list, long j2) {
            this(str, str2, i, str3, j, str4, i2, i3, i4, i5, str5, formatArr, list, C1229Util.scaleLargeTimestamps(list, 1000000, j), C1229Util.scaleLargeTimestamp(j2, 1000000, j));
            String str6 = str;
            String str7 = str2;
            int i6 = i;
        }
        ...
        public int getChunkIndex(long j) {
            return C1229Util.binarySearchFloor(this.chunkStartTimesUs, j, true, true);
        }
    ...
    public SsManifest(int i, int i2, long j, long j2, long j3, int i3, boolean z, ProtectionElement protectionElement2, StreamElement[] streamElementArr) {
        this(i, i2, j2 == 0 ? -9223372036854775807L : C1229Util.scaleLargeTimestamp(j2, 1000000, j), j3 != 0 ? C1229Util.scaleLargeTimestamp(j3, 1000000, j) : C0963C.TIME_UNSET, i3, z, protectionElement2, streamElementArr);
    }

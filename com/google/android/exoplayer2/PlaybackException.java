...
public class PlaybackException extends Exception implements Bundleable {
    ...
    private static final String FIELD_INT_ERROR_CODE = C1229Util.intToStringMaxRadix(0);
    private static final String FIELD_LONG_TIMESTAMP_MS = C1229Util.intToStringMaxRadix(1);
    private static final String FIELD_STRING_CAUSE_CLASS_NAME = C1229Util.intToStringMaxRadix(3);
    private static final String FIELD_STRING_CAUSE_MESSAGE = C1229Util.intToStringMaxRadix(4);
    private static final String FIELD_STRING_MESSAGE = C1229Util.intToStringMaxRadix(2);
    ...
    public boolean errorInfoEquals(com.google.android.exoplayer2.PlaybackException r7) {
        ...
        L_0x0012:
            ...
            boolean r4 = com.google.android.exoplayer2.util.C1229Util.areEqual(r4, r5)
            if (r4 != 0) goto L_0x002d
            return r1
        L_0x002d:
            java.lang.Class r2 = r2.getClass()
            java.lang.Class r3 = r3.getClass()
            boolean r2 = com.google.android.exoplayer2.util.C1229Util.areEqual(r2, r3)

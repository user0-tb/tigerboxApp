...
public interface AnalyticsListener {
    ...
    public final /* synthetic */ class CC {
        ...
        public static void $default$onEvents(AnalyticsListener analyticsListener, Player player, C0996Events events) {
        }
    ...
    void onEvents(Player player, C0996Events events);
    ...
    public static final class C0996Events {
        private final SparseArray<EventTime> eventTimes;
        private final FlagSet flags;

        public C0996Events(FlagSet flagSet, SparseArray<EventTime> sparseArray) {
            this.flags = flagSet;

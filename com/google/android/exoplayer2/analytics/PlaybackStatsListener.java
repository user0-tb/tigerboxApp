...
public final class PlaybackStatsListener implements AnalyticsListener, PlaybackSessionManager.Listener {
    ...
    public void onSessionFinished(AnalyticsListener.EventTime eventTime, String str, boolean z) {
        ...
        playbackStatsTracker.onFinished(eventTime, z, str.equals(this.discontinuityFromSession) ? this.discontinuityFromPositionMs : C0963C.TIME_UNSET);
    ...
    public void onEvents(Player player, AnalyticsListener.C0996Events events) {
        ...
        AnalyticsListener.C0996Events events2 = events;
        if (events.size() != 0) {
            ...
            for (String next : this.playbackStatsTrackers.keySet()) {
                ...
                long j = next.equals(this.discontinuityFromSession) ? this.discontinuityFromPositionMs : C0963C.TIME_UNSET;
    ...
    private Pair<AnalyticsListener.EventTime, Boolean> findBestEventTime(AnalyticsListener.C0996Events events, String str) {
        AnalyticsListener.C0996Events events2 = events;
        String str2 = str;
    ...
    private boolean hasEvent(AnalyticsListener.C0996Events events, String str, int i) {
    ...
    private static final class PlaybackStatsTracker {
        ...
        public PlaybackStatsTracker(boolean z, AnalyticsListener.EventTime eventTime) {
            ...
            this.firstReportedTimeMs = C0963C.TIME_UNSET;
            this.maxRebufferTimeMs = C0963C.TIME_UNSET;
        ...
        private void updatePlaybackState(int i, AnalyticsListener.EventTime eventTime) {
            ...
            jArr[i2] = jArr[i2] + j;
            if (this.firstReportedTimeMs == C0963C.TIME_UNSET) {

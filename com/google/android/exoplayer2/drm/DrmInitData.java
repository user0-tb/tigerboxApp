...
public final class DrmInitData implements Comparator<SchemeData>, Parcelable {
    ...
    DrmInitData(Parcel parcel) {
        ...
        SchemeData[] schemeDataArr = (SchemeData[]) C1229Util.castNonNull((SchemeData[]) parcel.createTypedArray(SchemeData.CREATOR));
    ...
    public DrmInitData copyWithSchemeType(String str) {
        if (C1229Util.areEqual(this.schemeType, str)) {
            return this;
        }
    ...
    public com.google.android.exoplayer2.drm.DrmInitData merge(com.google.android.exoplayer2.drm.DrmInitData r3) {
        ...
        L_0x001c:
            ...
            java.lang.Object[] r3 = com.google.android.exoplayer2.util.C1229Util.nullSafeArrayConcatenation(r1, r3)
            com.google.android.exoplayer2.drm.DrmInitData$SchemeData[] r3 = (com.google.android.exoplayer2.drm.DrmInitData.SchemeData[]) r3
    ...
    public boolean equals(Object obj) {
        ...
        if (!C1229Util.areEqual(this.schemeType, drmInitData.schemeType) || !Arrays.equals(this.schemeDatas, drmInitData.schemeDatas)) {
            return false;
        }
        return true;
    }
    ...
    public int compare(SchemeData schemeData, SchemeData schemeData2) {
        if (C0963C.UUID_NIL.equals(schemeData.uuid)) {
            return C0963C.UUID_NIL.equals(schemeData2.uuid) ? 0 : 1;
        }
    ...
    public static final class SchemeData implements Parcelable {
        ...
        SchemeData(Parcel parcel) {
            ...
            this.mimeType = (String) C1229Util.castNonNull(parcel.readString());
            this.data = parcel.createByteArray();
        }

        public boolean matches(UUID uuid2) {
            return C0963C.UUID_NIL.equals(this.uuid) || uuid2.equals(this.uuid);
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (!C1229Util.areEqual(this.licenseServerUrl, schemeData.licenseServerUrl) || !C1229Util.areEqual(this.mimeType, schemeData.mimeType) || !C1229Util.areEqual(this.uuid, schemeData.uuid) || !Arrays.equals(this.data, schemeData.data)) {
                return false;
            }
            return true;
        }

...
final class ClearKeyUtil {
    ...
    public static byte[] adjustRequestData(byte[] bArr) {
        if (C1229Util.SDK_INT >= 27) {
            return bArr;
        }
        return C1229Util.getUtf8Bytes(base64ToBase64Url(C1229Util.fromUtf8Bytes(bArr)));
    }
    ...
    public static byte[] adjustResponseData(byte[] bArr) {
        ...
        try {
            JSONObject jSONObject = new JSONObject(C1229Util.fromUtf8Bytes(bArr));
            ...
            sb.append("]}");
            return C1229Util.getUtf8Bytes(sb.toString());
        } catch (JSONException e) {
            Log.m154e(TAG, "Failed to adjust response data: " + C1229Util.fromUtf8Bytes(bArr), e);
            return bArr;
        }
    }

...
public final class Base64 {
    ...
    public static byte[] decode(byte[] bArr, int i, int i2, int i3) {
        ...
        } else if (decoder.f499op == decoder.output.length) {
            return decoder.output;
        } else {
            byte[] bArr2 = new byte[decoder.f499op];
            System.arraycopy(decoder.output, 0, bArr2, 0, decoder.f499op);
            return bArr2;
        }
    }
    ...
    public static String encodeToString(byte[] bArr, int i) {
        try {
            return new String(encode(bArr, i), C0963C.ASCII_NAME);
    ...
    public static String encodeToString(byte[] bArr, int i, int i2, int i3) {
        try {
            return new String(encode(bArr, i, i2, i3), C0963C.ASCII_NAME);
        } catch (UnsupportedEncodingException e) {
            throw new AssertionError(e);
        }
    }

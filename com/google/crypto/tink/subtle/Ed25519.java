...
final class Ed25519 {
    ...
    /* renamed from: eq */
    private static int m428eq(int i, int i2) {
        int i3 = (~(i ^ i2)) & 255;
        int i4 = i3 & (i3 << 4);
        int i5 = i4 & (i4 << 2);
        return ((i5 & (i5 << 1)) >> 7) & 1;
    ...
    private static class XYZ {
        ...
        XYZ(XYZ xyz) {
            this.f502x = Arrays.copyOf(xyz.f502x, 10);
            this.f503y = Arrays.copyOf(xyz.f503y, 10);
            this.f504z = Arrays.copyOf(xyz.f504z, 10);
        }
        ...
        static XYZ fromPartialXYZT(XYZ xyz, PartialXYZT partialXYZT) {
            Field25519.mult(xyz.f502x, partialXYZT.xyz.f502x, partialXYZT.f501t);
            Field25519.mult(xyz.f503y, partialXYZT.xyz.f503y, partialXYZT.xyz.f504z);
            Field25519.mult(xyz.f504z, partialXYZT.xyz.f504z, partialXYZT.f501t);
            return xyz;
        }
        ...
        public byte[] toBytes() {
            ...
            Field25519.inverse(jArr, this.f504z);
            Field25519.mult(jArr2, this.f502x, jArr);
            Field25519.mult(jArr3, this.f503y, jArr);
        ...
        public boolean isOnCurve() {
            long[] jArr = new long[10];
            Field25519.square(jArr, this.f502x);
            long[] jArr2 = new long[10];
            Field25519.square(jArr2, this.f503y);
            long[] jArr3 = new long[10];
            Field25519.square(jArr3, this.f504z);
            ...
            Field25519.mult(jArr6, jArr6, Ed25519Constants.f507D);
    ...
    private static class XYZT {
        ...
        public static XYZT fromPartialXYZT(XYZT xyzt, PartialXYZT partialXYZT) {
            Field25519.mult(xyzt.xyz.f502x, partialXYZT.xyz.f502x, partialXYZT.f501t);
            Field25519.mult(xyzt.xyz.f503y, partialXYZT.xyz.f503y, partialXYZT.xyz.f504z);
            Field25519.mult(xyzt.xyz.f504z, partialXYZT.xyz.f504z, partialXYZT.f501t);
            Field25519.mult(xyzt.f505t, partialXYZT.xyz.f502x, partialXYZT.xyz.f503y);
            return xyzt;
        }
        ...
        public static XYZT fromBytesNegateVarTime(byte[] bArr) throws GeneralSecurityException {
            ...
            Field25519.mult(jArr5, jArr4, Ed25519Constants.f507D);
    ...
    private static class PartialXYZT {
        ...
        PartialXYZT(PartialXYZT partialXYZT) {
            ...
            this.f501t = Arrays.copyOf(partialXYZT.f501t, 10);
        }
    }
    ...
    private static class CachedXYZT extends CachedXYT {
        ...
        CachedXYZT(XYZT xyzt) {
            this();
            Field25519.sum(this.yPlusX, xyzt.xyz.f503y, xyzt.xyz.f502x);
            Field25519.sub(this.yMinusX, xyzt.xyz.f503y, xyzt.xyz.f502x);
            System.arraycopy(xyzt.xyz.f504z, 0, this.f500z, 0, 10);
            Field25519.mult(this.t2d, xyzt.f505t, Ed25519Constants.f508D2);
        }
        ...
        public void multByZ(long[] jArr, long[] jArr2) {
            Field25519.mult(jArr, jArr2, this.f500z);
        }
    }

    private static void add(PartialXYZT partialXYZT, XYZT xyzt, CachedXYT cachedXYT) {
        long[] jArr = new long[10];
        Field25519.sum(partialXYZT.xyz.f502x, xyzt.xyz.f503y, xyzt.xyz.f502x);
        Field25519.sub(partialXYZT.xyz.f503y, xyzt.xyz.f503y, xyzt.xyz.f502x);
        Field25519.mult(partialXYZT.xyz.f503y, partialXYZT.xyz.f503y, cachedXYT.yMinusX);
        Field25519.mult(partialXYZT.xyz.f504z, partialXYZT.xyz.f502x, cachedXYT.yPlusX);
        Field25519.mult(partialXYZT.f501t, xyzt.f505t, cachedXYT.t2d);
        cachedXYT.multByZ(partialXYZT.xyz.f502x, xyzt.xyz.f504z);
        Field25519.sum(jArr, partialXYZT.xyz.f502x, partialXYZT.xyz.f502x);
        Field25519.sub(partialXYZT.xyz.f502x, partialXYZT.xyz.f504z, partialXYZT.xyz.f503y);
        Field25519.sum(partialXYZT.xyz.f503y, partialXYZT.xyz.f504z, partialXYZT.xyz.f503y);
        Field25519.sum(partialXYZT.xyz.f504z, jArr, partialXYZT.f501t);
        Field25519.sub(partialXYZT.f501t, jArr, partialXYZT.f501t);
    }
    ...
    private static void sub(PartialXYZT partialXYZT, XYZT xyzt, CachedXYT cachedXYT) {
        ...
        Field25519.sum(partialXYZT.xyz.f502x, xyzt.xyz.f503y, xyzt.xyz.f502x);
        Field25519.sub(partialXYZT.xyz.f503y, xyzt.xyz.f503y, xyzt.xyz.f502x);
        Field25519.mult(partialXYZT.xyz.f503y, partialXYZT.xyz.f503y, cachedXYT.yPlusX);
        Field25519.mult(partialXYZT.xyz.f504z, partialXYZT.xyz.f502x, cachedXYT.yMinusX);
        Field25519.mult(partialXYZT.f501t, xyzt.f505t, cachedXYT.t2d);
        cachedXYT.multByZ(partialXYZT.xyz.f502x, xyzt.xyz.f504z);
        Field25519.sum(jArr, partialXYZT.xyz.f502x, partialXYZT.xyz.f502x);
        Field25519.sub(partialXYZT.xyz.f502x, partialXYZT.xyz.f504z, partialXYZT.xyz.f503y);
        Field25519.sum(partialXYZT.xyz.f503y, partialXYZT.xyz.f504z, partialXYZT.xyz.f503y);
        Field25519.sub(partialXYZT.xyz.f504z, jArr, partialXYZT.f501t);
        Field25519.sum(partialXYZT.f501t, jArr, partialXYZT.f501t);
    }

    private static void doubleXYZ(PartialXYZT partialXYZT, XYZ xyz) {
        long[] jArr = new long[10];
        Field25519.square(partialXYZT.xyz.f502x, xyz.f502x);
        Field25519.square(partialXYZT.xyz.f504z, xyz.f503y);
        Field25519.square(partialXYZT.f501t, xyz.f504z);
        Field25519.sum(partialXYZT.f501t, partialXYZT.f501t, partialXYZT.f501t);
        Field25519.sum(partialXYZT.xyz.f503y, xyz.f502x, xyz.f503y);
        Field25519.square(jArr, partialXYZT.xyz.f503y);
        Field25519.sum(partialXYZT.xyz.f503y, partialXYZT.xyz.f504z, partialXYZT.xyz.f502x);
        Field25519.sub(partialXYZT.xyz.f504z, partialXYZT.xyz.f504z, partialXYZT.xyz.f502x);
        Field25519.sub(partialXYZT.xyz.f502x, jArr, partialXYZT.xyz.f503y);
        Field25519.sub(partialXYZT.f501t, partialXYZT.f501t, partialXYZT.xyz.f504z);
    }
    ...
    private static void select(CachedXYT cachedXYT, int i, byte b) {
        int i2 = (b & 255) >> 7;
        int i3 = b - (((-i2) & b) << 1);
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][0], m428eq(i3, 1));
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][1], m428eq(i3, 2));
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][2], m428eq(i3, 3));
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][3], m428eq(i3, 4));
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][4], m428eq(i3, 5));
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][5], m428eq(i3, 6));
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][6], m428eq(i3, 7));
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][7], m428eq(i3, 8));
    ...
    private static XYZ doubleScalarMultVarTime(byte[] bArr, XYZT xyzt, byte[] bArr2) {
        ...
        while (i2 >= 0) {
            ...
            if (slide2[i2] > 0) {
                add(partialXYZT2, XYZT.fromPartialXYZT(xyzt3, partialXYZT2), Ed25519Constants.f506B2[slide2[i2] / 2]);
            } else if (slide2[i2] < 0) {
                sub(partialXYZT2, XYZT.fromPartialXYZT(xyzt3, partialXYZT2), Ed25519Constants.f506B2[(-slide2[i2]) / 2]);
            }
            i2--;
        }

    ...
    static /* synthetic */ class C24361 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.subtle.prf.HkdfStreamingPrf.C24361.<clinit>():void");
        }
    }

    /* access modifiers changed from: private */
    public static String getJavaxHmacName(Enums.HashType hashType2) throws GeneralSecurityException {
        int i = C24361.$SwitchMap$com$google$crypto$tink$subtle$Enums$HashType[hashType2.ordinal()];
        if (i == 1) {
            return "HmacSha1";
        }
        if (i == 2) {

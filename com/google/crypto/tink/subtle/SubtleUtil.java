...
public final class SubtleUtil {
    ...
    static /* synthetic */ class C24341 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.subtle.SubtleUtil.C24341.<clinit>():void");
        }
    }

    public static String toDigestAlgo(Enums.HashType hashType) throws GeneralSecurityException {
        int i = C24341.$SwitchMap$com$google$crypto$tink$subtle$Enums$HashType[hashType.ordinal()];
        if (i == 1) {
            return "SHA-1";
        }
        if (i == 2) {
    ...
    public static int androidApiLevel() {
        Integer androidApiLevel = C2194Util.getAndroidApiLevel();

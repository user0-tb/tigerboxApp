...
public final class KeyTemplate {
    ...
    /* renamed from: kt */
    private final com.google.crypto.tink.proto.KeyTemplate f354kt;
    ...
    static OutputPrefixType fromProto(com.google.crypto.tink.proto.OutputPrefixType outputPrefixType) {
        int i = C21391.$SwitchMap$com$google$crypto$tink$proto$OutputPrefixType[outputPrefixType.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C21391 {
        ...
        static {
            ...
            L_0x0062:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.KeyTemplate.C21391.<clinit>():void");
        }
    }

    static com.google.crypto.tink.proto.OutputPrefixType toProto(OutputPrefixType outputPrefixType) {
        int i = C21391.$SwitchMap$com$google$crypto$tink$KeyTemplate$OutputPrefixType[outputPrefixType.ordinal()];
        if (i == 1) {
    ...
    public String getTypeUrl() {
        return this.f354kt.getTypeUrl();
    }

    public byte[] getValue() {
        return this.f354kt.getValue().toByteArray();
    }

    public OutputPrefixType getOutputPrefixType() {
        return fromProto(this.f354kt.getOutputPrefixType());
    }
}

...
public final class RsaSsaPkcs1PrivateKey extends GeneratedMessageLite<RsaSsaPkcs1PrivateKey, Builder> implements RsaSsaPkcs1PrivateKeyOrBuilder {
    ...
    /* renamed from: d_ */
    private ByteString f451d_ = ByteString.EMPTY;
    private ByteString dp_ = ByteString.EMPTY;
    private ByteString dq_ = ByteString.EMPTY;

    /* renamed from: p_ */
    private ByteString f452p_ = ByteString.EMPTY;
    private RsaSsaPkcs1PublicKey publicKey_;

    /* renamed from: q_ */
    private ByteString f453q_ = ByteString.EMPTY;
    ...
    public void setD(ByteString byteString) {
        byteString.getClass();
        this.f451d_ = byteString;
    }

    /* access modifiers changed from: private */
    public void clearD() {
        this.f451d_ = getDefaultInstance().getD();
    }
    ...
    public void setP(ByteString byteString) {
        byteString.getClass();
        this.f452p_ = byteString;
    }

    /* access modifiers changed from: private */
    public void clearP() {
        this.f452p_ = getDefaultInstance().getP();
    }
    ...
    public void setQ(ByteString byteString) {
        byteString.getClass();
        this.f453q_ = byteString;
    }

    /* access modifiers changed from: private */
    public void clearQ() {
        this.f453q_ = getDefaultInstance().getQ();
    }
    ...
    static /* synthetic */ class C23261 {
        ...
        static {
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.proto.RsaSsaPkcs1PrivateKey.C23261.<clinit>():void");
        }
    }

    /* access modifiers changed from: protected */
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C23261.f454xa1df5c61[methodToInvoke.ordinal()]) {
            case 1:
                return new RsaSsaPkcs1PrivateKey();
            case 2:
                return new Builder((C23261) null);
            case 3:

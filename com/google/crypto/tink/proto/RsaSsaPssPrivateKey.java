...
public final class RsaSsaPssPrivateKey extends GeneratedMessageLite<RsaSsaPssPrivateKey, Builder> implements RsaSsaPssPrivateKeyOrBuilder {
    ...
    /* renamed from: d_ */
    private ByteString f460d_ = ByteString.EMPTY;
    private ByteString dp_ = ByteString.EMPTY;
    private ByteString dq_ = ByteString.EMPTY;

    /* renamed from: p_ */
    private ByteString f461p_ = ByteString.EMPTY;
    private RsaSsaPssPublicKey publicKey_;

    /* renamed from: q_ */
    private ByteString f462q_ = ByteString.EMPTY;
    ...
    public void setD(ByteString byteString) {
        byteString.getClass();
        this.f460d_ = byteString;
    }

    /* access modifiers changed from: private */
    public void clearD() {
        this.f460d_ = getDefaultInstance().getD();
    }
    ...
    public void setP(ByteString byteString) {
        byteString.getClass();
        this.f461p_ = byteString;
    }

    /* access modifiers changed from: private */
    public void clearP() {
        this.f461p_ = getDefaultInstance().getP();
    }
    ...
    public void setQ(ByteString byteString) {
        byteString.getClass();
        this.f462q_ = byteString;
    }

    /* access modifiers changed from: private */
    public void clearQ() {
        this.f462q_ = getDefaultInstance().getQ();
    }
    ...
    static /* synthetic */ class C23301 {
        ...
        static {
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.proto.RsaSsaPssPrivateKey.C23301.<clinit>():void");
        }
    }

    /* access modifiers changed from: protected */
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C23301.f463xa1df5c61[methodToInvoke.ordinal()]) {
            case 1:
                return new RsaSsaPssPrivateKey();
            case 2:
                return new Builder((C23301) null);
            case 3:

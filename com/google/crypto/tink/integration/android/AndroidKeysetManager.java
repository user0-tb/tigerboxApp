...
public final class AndroidKeysetManager {
    ...
    /* synthetic */ AndroidKeysetManager(Builder builder, C21811 r2) throws GeneralSecurityException, IOException {
        this(builder);
    }
    ...
    public static final class Builder {
        ...
        public synchronized AndroidKeysetManager build() throws GeneralSecurityException, IOException {
            ...
            return new AndroidKeysetManager(this, (C21811) null);
        }
        ...
        private KeysetManager readOrGenerateNewKeyset() throws GeneralSecurityException, IOException {
            try {
                ...
                if (Log.isLoggable(AndroidKeysetManager.TAG, 4)) {
                    Log.i(AndroidKeysetManager.TAG, String.format("keyset not found, will generate a new one. %s", new Object[]{e.getMessage()}));
                }
    ...
    static /* synthetic */ class C21811 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.integration.android.AndroidKeysetManager.C21811.<clinit>():void");
        }
    }

    /* access modifiers changed from: private */
    public static KeyTemplate.OutputPrefixType fromProto(OutputPrefixType outputPrefixType) {
        int i = C21811.$SwitchMap$com$google$crypto$tink$proto$OutputPrefixType[outputPrefixType.ordinal()];
        if (i == 1) {

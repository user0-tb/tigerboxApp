    ...
    static /* synthetic */ class C24251 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.streamingaead.StreamingAeadUtil.C24251.<clinit>():void");
        }
    }

    public static String toHmacAlgo(HashType hashType) throws NoSuchAlgorithmException {
        int i = C24251.$SwitchMap$com$google$crypto$tink$proto$HashType[hashType.ordinal()];
        if (i == 1) {
            return "HmacSha1";
        }
        if (i == 2) {

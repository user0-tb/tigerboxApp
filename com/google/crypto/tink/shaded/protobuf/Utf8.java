...
final class Utf8 {
            ...
            while (access$200 < i2) {
                ...
                if (b < 0) {
                    if (b < -32) {
                        ...
                        if (b3 <= -65 && (((b << Ascii.f272FS) + (b3 + 112)) >> 30) == 0) {
                            int i6 = i5 + 1;
    ...
    static final class UnsafeProcessor extends Processor {
        ...
        public String decodeUtf8(byte[] bArr, int i, int i2) throws InvalidProtocolBufferException {
            int i3;
            if ((i | i2 | ((bArr.length - i) - i2)) >= 0) {
                int unsafeEstimateConsecutiveAscii = unsafeEstimateConsecutiveAscii(bArr, (long) i, i2) + i;
                int i4 = i + i2;
                while (i3 < i4 && UnsafeUtil.getByte(bArr, (long) i3) >= 0) {
                    unsafeEstimateConsecutiveAscii = i3 + 1;
                }
                if (i3 == i4) {
                ...
                int i5 = 0;
                while (i < i3) {
                    DecodeUtil.handleOneByte(UnsafeUtil.getByte(bArr, (long) i), cArr, i5);
                    i++;
                    i5++;
                }
                int i6 = i5;
                while (i3 < i4) {
                    int i7 = i3 + 1;
                    byte b = UnsafeUtil.getByte(bArr, (long) i3);
                    if (DecodeUtil.isOneByte(b)) {
                        int i8 = i6 + 1;
                        DecodeUtil.handleOneByte(b, cArr, i6);
                        while (i7 < i4) {
                            byte b2 = UnsafeUtil.getByte(bArr, (long) i7);
                            if (!DecodeUtil.isOneByte(b2)) {
                                break;
                            }
                            i7++;
                        ...
                        if (i7 < i4) {
                            i3 = i7 + 1;
                            DecodeUtil.handleTwoBytes(b, UnsafeUtil.getByte(bArr, (long) i7), cArr, i6);
                            i6++;
                        } else {
                            throw InvalidProtocolBufferException.invalidUtf8();
                        }
                        ...
                        if (i7 < i4 - 1) {
                            int i9 = i7 + 1;
                            int i10 = i9 + 1;
                            DecodeUtil.handleThreeBytes(b, UnsafeUtil.getByte(bArr, (long) i7), UnsafeUtil.getByte(bArr, (long) i9), cArr, i6);
                            i3 = i10;
                            i6++;
                        } else {
                            throw InvalidProtocolBufferException.invalidUtf8();
                        ...
                        int i12 = i11 + 1;
                        i3 = i12 + 1;
                        DecodeUtil.handleFourBytes(b, UnsafeUtil.getByte(bArr, (long) i7), UnsafeUtil.getByte(bArr, (long) i11), UnsafeUtil.getByte(bArr, (long) i12), cArr, i6);
                        i6 = i6 + 1 + 1;
                    } else {
                        throw InvalidProtocolBufferException.invalidUtf8();
                    }
    ...
    private static class DecodeUtil {
        ...
        public static void handleTwoBytes(byte b, byte b2, char[] cArr, int i) throws InvalidProtocolBufferException {
            ...
            cArr[i] = (char) (((b & Ascii.f281US) << 6) | trailingByteValue(b2));
        }
        ...
        public static void handleThreeBytes(byte b, byte b2, byte b3, char[] cArr, int i) throws InvalidProtocolBufferException {
            ...
            cArr[i] = (char) (((b & Ascii.f278SI) << Ascii.f271FF) | (trailingByteValue(b2) << 6) | trailingByteValue(b3));
        }

        /* access modifiers changed from: private */
        public static void handleFourBytes(byte b, byte b2, byte b3, byte b4, char[] cArr, int i) throws InvalidProtocolBufferException {
            if (isNotTrailingByte(b2) || (((b << Ascii.f272FS) + (b2 + 112)) >> 30) != 0 || isNotTrailingByte(b3) || isNotTrailingByte(b4)) {
                throw InvalidProtocolBufferException.invalidUtf8();
            }

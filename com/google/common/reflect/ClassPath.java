...
import com.google.common.p010io.ByteSource;
import com.google.common.p010io.CharSource;
import com.google.common.p010io.Resources;
import java.io.File;
...
public final class ClassPath {
    ...
    private static final Splitter CLASS_PATH_ATTRIBUTE_SEPARATOR = Splitter.m241on(" ").omitEmptyStrings();
    ...
    public static class ResourceInfo {
        ...
        /* renamed from: of */
        static ResourceInfo m412of(File file2, String str, ClassLoader classLoader) {
        ...
        private void scanJarFile(JarFile jarFile, ImmutableSet.Builder<ResourceInfo> builder) {
            ...
            while (entries.hasMoreElements()) {
                ...
                if (!nextElement.isDirectory() && !nextElement.getName().equals("META-INF/MANIFEST.MF")) {
                    builder.add((Object) ResourceInfo.m412of(new File(jarFile.getName()), nextElement.getName(), this.classloader));
                }
            }
        }
            ...
            for (File file2 : listFiles) {
                ...
                if (file2.isDirectory()) {
                    ...
                    if (set.add(canonicalFile)) {
                        ...
                        sb2.append(str);
                        sb2.append(name);
                        sb2.append(DownloadsManager.FOLDERS_SEPARATOR);
                    ...
                    if (!concat.equals("META-INF/MANIFEST.MF")) {
                        builder.add((Object) ResourceInfo.m412of(file2, concat, this.classloader));
                    }
                }
            }
        }
    ...
    static com.google.common.collect.ImmutableList<java.net.URL> parseJavaClassPath() {
        /*
            ...
            com.google.common.base.Splitter r1 = com.google.common.base.Splitter.m241on((java.lang.String) r1)

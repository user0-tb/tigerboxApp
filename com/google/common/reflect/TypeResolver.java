...
public final class TypeResolver {
    ...
    private static class WildcardCapturer {
        ...
        public TypeVariable<?> captureAsTypeVariable(Type[] typeArr) {
            int incrementAndGet = this.f353id.incrementAndGet();
            String join = Joiner.m225on((char) Typography.amp).join((Object[]) typeArr);
        ...
        private WildcardCapturer forTypeVariable(final TypeVariable<?> typeVariable) {
            return new WildcardCapturer(this, this.f353id) {
                /* access modifiers changed from: package-private */
                public TypeVariable<?> captureAsTypeVariable(Type[] typeArr) {

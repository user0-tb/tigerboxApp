...
public final class InternetDomainName {
    ...
    private static final Joiner DOT_JOINER = Joiner.m225on('.');
    private static final Splitter DOT_SPLITTER = Splitter.m238on('.');
    ...
    static {
        ...
        CharMatcher or = CharMatcher.inRange('a', 'z').mo24931or(CharMatcher.inRange('A', Matrix.MATRIX_TYPE_ZERO));
        LETTER_MATCHER = or;
        PART_CHAR_MATCHER = inRange.mo24931or(or).mo24931or(anyOf);
    }
    ...
    InternetDomainName(String str) {
        ...
        this.registrySuffixIndex = findSuffixOfType(Optional.m227of(PublicSuffixType.REGISTRY));
    }

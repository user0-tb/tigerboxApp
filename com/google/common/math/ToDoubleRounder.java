...
abstract class ToDoubleRounder<X extends Number & Comparable<X>> {
    ...
    public final double roundToDouble(X x, RoundingMode roundingMode) {
        ...
        if (Double.isInfinite(roundToDoubleArbitrarily)) {
            switch (C20061.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
                case 1:
                case 2:
                case 3:
                case 4:
        ...
        switch (C20061.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            ...
            case 4:
                ...
                int i = C20061.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()];
                if (i == 2) {
    ...
    static /* synthetic */ class C20061 {
        ...
        static {
            ...
            L_0x0060:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.math.ToDoubleRounder.C20061.<clinit>():void");
        }
    }
}

...
public final class LongMath {
    ...
    static /* synthetic */ class C20021 {
        ...
        static {
            ...
            L_0x0060:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.math.LongMath.C20021.<clinit>():void");
        }
    }

    public static int log2(long j, RoundingMode roundingMode) {
        MathPreconditions.checkPositive("x", j);
        switch (C20021.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            case 1:
    ...
    public static int log10(long r4, java.math.RoundingMode r6) {
        /*
            ...
            long[] r1 = powersOf10
            r2 = r1[r0]
            int[] r1 = com.google.common.math.LongMath.C20021.$SwitchMap$java$math$RoundingMode
            int r6 = r6.ordinal()
            r6 = r1[r6]
            switch(r6) {
    ...
    public static long divide(long r9, long r11, java.math.RoundingMode r13) {
        ...
        L_0x0010:
            ...
            r9 = 1
            r10 = r10 | r9
            int[] r7 = com.google.common.math.LongMath.C20021.$SwitchMap$java$math$RoundingMode
            int r8 = r13.ordinal()
            r7 = r7[r8]
            r8 = 0
            switch(r7) {
    ...
    public static double roundToDouble(long j, RoundingMode roundingMode) {
        ...
        switch (C20021.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            ...
            case 8:
                ...
                int i = C20021.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()];
                if (i == 6) {
                    return j3 >= 0 ? d2 : d;
                }
                if (i == 7) {

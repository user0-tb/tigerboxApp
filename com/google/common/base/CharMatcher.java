...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    /* renamed from: is */
    public static CharMatcher m219is(char c) {
        return new C1609Is(c);
    }
    ...
    public static CharMatcher anyOf(CharSequence charSequence) {
        ...
        if (length == 1) {
            return m219is(charSequence.charAt(0));
        }
        if (length != 2) {
    ...
    /* renamed from: or */
    public CharMatcher mo24931or(CharMatcher charMatcher) {
        return new C1610Or(this, charMatcher);
    }
    ...
    private static CharMatcher precomputedPositive(int i, BitSet bitSet, String str) {
        ...
        if (i == 1) {
            return m219is((char) bitSet.nextSetBit(0));
        }
        if (i == 2) {
    ...
    private static final class C1610Or extends CharMatcher {
        final CharMatcher first;
        final CharMatcher second;
        ...
        C1610Or(CharMatcher charMatcher, CharMatcher charMatcher2) {
            this.first = (CharMatcher) Preconditions.checkNotNull(charMatcher);
            this.second = (CharMatcher) Preconditions.checkNotNull(charMatcher2);
        }
    ...
    private static final class C1609Is extends FastMatcher {
        ...
        /* renamed from: or */
        public CharMatcher mo24931or(CharMatcher charMatcher) {
            return charMatcher.matches(this.match) ? charMatcher : super.mo24931or(charMatcher);
        }

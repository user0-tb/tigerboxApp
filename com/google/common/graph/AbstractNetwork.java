...
public abstract class AbstractNetwork<N, E> implements Network<N, E> {
            ...
            public Set<EndpointPair<N>> edges() {
                ...
                return new AbstractSet<EndpointPair<N>>() {
                    ...
                    public boolean contains(@CheckForNull Object obj) {
                        ...
                        if (!C19141.this.isOrderingCompatible(endpointPair) || !C19141.this.nodes().contains(endpointPair.nodeU()) || !C19141.this.successors(endpointPair.nodeU()).contains(endpointPair.nodeV())) {
                            return false;
                        }
                        return true;
                    }
    ...
    public Set<E> adjacentEdges(E e) {
        ...
        return Sets.difference(Sets.union(incidentEdges(incidentNodes.nodeU()), incidentEdges(incidentNodes.nodeV())), ImmutableSet.m309of(e));
    }

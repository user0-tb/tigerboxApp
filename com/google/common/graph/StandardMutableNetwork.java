...
final class StandardMutableNetwork<N, E> extends StandardNetwork<N, E> implements MutableNetwork<N, E> {
    ...
    public boolean addEdge(N n, N n2, E e) {
        ...
        if (containsEdge(e)) {
            ...
            EndpointPair of = EndpointPair.m375of((Network<?, ?>) this, n, n2);
    ...
    private NetworkConnections<N, E> newConnections() {
        if (isDirected()) {
            if (allowsParallelEdges()) {
                return DirectedMultiNetworkConnections.m372of();
            }
            return DirectedNetworkConnections.m373of();
        } else if (allowsParallelEdges()) {
            return UndirectedMultiNetworkConnections.m378of();
        } else {
            return UndirectedNetworkConnections.m379of();
        }
    }
}

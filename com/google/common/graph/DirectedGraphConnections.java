    ...
    static /* synthetic */ class C19338 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.graph.DirectedGraphConnections.C19338.<clinit>():void");
        }
    }

    /* renamed from: of */
    static <N, V> DirectedGraphConnections<N, V> m371of(ElementOrder<N> elementOrder) {
        ArrayList arrayList;
        int i = C19338.$SwitchMap$com$google$common$graph$ElementOrder$Type[elementOrder.type().ordinal()];
        if (i == 1) {
            arrayList = null;
        } else if (i == 2) {
        ...
        return new AbstractIterator<EndpointPair<N>>(this) {
            ...
            public com.google.common.graph.EndpointPair<N> computeNext() {
                ...
                L_0x0028:
                    ...
                    return r0
                */
                throw new UnsupportedOperationException("Method not decompiled: com.google.common.graph.DirectedGraphConnections.C19327.computeNext():com.google.common.graph.EndpointPair");
            }
        };
    }

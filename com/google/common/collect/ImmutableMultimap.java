...
public abstract class ImmutableMultimap<K, V> extends BaseImmutableMultimap<K, V> implements Serializable {
    ...
    /* renamed from: of */
    public static <K, V> ImmutableMultimap<K, V> m291of() {
        return ImmutableListMultimap.m274of();
    }

    /* renamed from: of */
    public static <K, V> ImmutableMultimap<K, V> m292of(K k, V v) {
        return ImmutableListMultimap.m275of(k, v);
    }

    /* renamed from: of */
    public static <K, V> ImmutableMultimap<K, V> m293of(K k, V v, K k2, V v2) {
        return ImmutableListMultimap.m276of(k, v, k2, v2);
    }

    /* renamed from: of */
    public static <K, V> ImmutableMultimap<K, V> m294of(K k, V v, K k2, V v2, K k3, V v3) {
        return ImmutableListMultimap.m277of(k, v, k2, v2, k3, v3);
    }

    /* renamed from: of */
    public static <K, V> ImmutableMultimap<K, V> m295of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4) {
        return ImmutableListMultimap.m278of(k, v, k2, v2, k3, v3, k4, v4);
    }

    /* renamed from: of */
    public static <K, V> ImmutableMultimap<K, V> m296of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5) {
        return ImmutableListMultimap.m279of(k, v, k2, v2, k3, v3, k4, v4, k5, v5);
    }

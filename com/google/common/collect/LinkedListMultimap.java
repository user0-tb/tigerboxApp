...
public class LinkedListMultimap<K, V> extends AbstractMultimap<K, V> implements ListMultimap<K, V>, Serializable {
    ...
    private class NodeIterator implements ListIterator<Map.Entry<K, V>>, Iterator {
        @CheckForNull
        Node<K, V> current;
    ...
    private class DistinctKeyIterator implements java.util.Iterator<K>, Iterator {
        @CheckForNull
        Node<K, V> current;
        int expectedModCount;
        @CheckForNull
    ...
    private class ValueForKeyIterator implements ListIterator<V>, Iterator {
        @CheckForNull
        Node<K, V> current;
        @ParametricNullness
        final K key;

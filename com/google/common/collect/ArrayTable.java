...
public final class ArrayTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    @CheckForNull
    /* renamed from: at */
    public V mo25784at(int i, int i2) {
    ...
    public V get(@CheckForNull Object obj, @CheckForNull Object obj2) {
        ...
        return mo25784at(num.intValue(), num2.intValue());
    }
    ...
    public Table.Cell<R, C, V> getCell(int i) {
        return new Tables.AbstractCell<R, C, V>(i) {
            ...
            @CheckForNull
            public V getValue() {
                return ArrayTable.this.mo25784at(this.rowIndex, this.columnIndex);
            }
        };
    }
    ...
    public V getValue(int i) {
        return mo25784at(i / this.columnList.size(), i % this.columnList.size());
    }
    ...
    private class Column extends ArrayMap<R, V> {
        ...
        @CheckForNull
        public V getValue(int i) {
            return ArrayTable.this.mo25784at(i, this.columnIndex);
        }
    ...
    private class Row extends ArrayMap<C, V> {
        ...
        @CheckForNull
        public V getValue(int i) {
            return ArrayTable.this.mo25784at(this.rowIndex, i);
        }

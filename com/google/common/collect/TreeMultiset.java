...
public final class TreeMultiset<E> extends AbstractSortedMultiset<E> implements Serializable {
    ...
    private long aggregateBelowRange(Aggregate aggregate, @CheckForNull AvlNode<E> avlNode) {
        ...
        if (compare == 0) {
            int i = C18764.$SwitchMap$com$google$common$collect$BoundType[this.range.getLowerBoundType().ordinal()];
            if (i == 1) {
    ...
    static /* synthetic */ class C18764 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.collect.TreeMultiset.C18764.<clinit>():void");
        }
    }
    ...
    private long aggregateAboveRange(Aggregate aggregate, @CheckForNull AvlNode<E> avlNode) {
        ...
        if (compare == 0) {
            int i = C18764.$SwitchMap$com$google$common$collect$BoundType[this.range.getUpperBoundType().ordinal()];
            if (i == 1) {
                treeAggregate = (long) aggregate.nodeAggregate(avlNode);
    ...
    /* access modifiers changed from: package-private */
    public java.util.Iterator<Multiset.Entry<E>> descendingEntryIterator() {
        return new Object() {
            @CheckForNull
            AvlNode<E> current;
            @CheckForNull

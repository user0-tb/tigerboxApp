...
public abstract class FluentIterable<E> implements Iterable<E> {
    ...
    FluentIterable(Iterable<E> iterable) {
        this.iterableDelegate = Optional.m227of(iterable);
    }

    private Iterable<E> getDelegate() {
        return this.iterableDelegate.mo24900or(this);
    }
    ...
    /* renamed from: of */
    public static <E> FluentIterable<E> m246of() {
        return from(Collections.emptyList());
    }

    /* renamed from: of */
    public static <E> FluentIterable<E> m247of(@ParametricNullness E e, E... eArr) {
    ...
    public final Optional<E> first() {
        ...
        return it.hasNext() ? Optional.m227of(it.next()) : Optional.absent();
    }
    ...
    public final Optional<E> last() {
        ...
        if (delegate instanceof List) {
            ...
            return Optional.m227of(list.get(list.size() - 1));
        }
        ...
        if (delegate instanceof SortedSet) {
            return Optional.m227of(((SortedSet) delegate).last());
        }
        do {
            next = it.next();
        } while (it.hasNext());

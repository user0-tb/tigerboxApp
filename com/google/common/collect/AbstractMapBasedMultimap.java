...
abstract class AbstractMapBasedMultimap<K, V> extends AbstractMultimap<K, V> implements Serializable {
    ...
    class WrappedCollection extends AbstractCollection<V> {
        ...
        class WrappedIterator implements Iterator<V>, p009j$.util.Iterator {
    ...
    class WrappedList extends AbstractMapBasedMultimap<K, V>.WrappedCollection implements List<V> {
        ...
        private class WrappedListIterator extends AbstractMapBasedMultimap<K, V>.WrappedIterator implements ListIterator<V>, p009j$.util.Iterator {
            WrappedListIterator() {
                super();
            }
    ...
    private abstract class Itr<T> implements java.util.Iterator<T>, p009j$.util.Iterator {
        @CheckForNull
    ...
    private class AsMap extends Maps.ViewCachingAbstractMap<K, Collection<V>> {
        ...
        class AsMapIterator implements java.util.Iterator<Map.Entry<K, Collection<V>>>, p009j$.util.Iterator {
            @CheckForNull
            Collection<V> collection;

...
class EngineJob<R> implements DecodeJob.Callback<R>, FactoryPools.Poolable {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x0055, code lost:
        r1 = r0.next();
        r1.executor.execute(new com.bumptech.glide.load.engine.EngineJob.CallResourceReady(r5, r1.f133cb));
     */
    ...
    public void notifyCallbacksOfResult() {
        ...
        L_0x004f:
            ...
            com.bumptech.glide.request.ResourceCallback r1 = r1.f133cb
            r3.<init>(r1)
            r2.execute(r3)
            goto L_0x004f
        L_0x0068:
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x003f, code lost:
        r1 = r0.next();
        r1.executor.execute(new com.bumptech.glide.load.engine.EngineJob.CallLoadFailed(r4, r1.f133cb));
     */
    ...
    private class CallLoadFailed implements Runnable {
        ...
        /* renamed from: cb */
        private final ResourceCallback f131cb;

        CallLoadFailed(ResourceCallback resourceCallback) {
            this.f131cb = resourceCallback;
        }

        public void run() {
            synchronized (this.f131cb.getLock()) {
                synchronized (EngineJob.this) {
                    if (EngineJob.this.cbs.contains(this.f131cb)) {
                        EngineJob.this.callCallbackOnLoadFailed(this.f131cb);
                    }
    ...
    private class CallResourceReady implements Runnable {
        ...
        /* renamed from: cb */
        private final ResourceCallback f132cb;

        CallResourceReady(ResourceCallback resourceCallback) {
            this.f132cb = resourceCallback;
        }

        public void run() {
            synchronized (this.f132cb.getLock()) {
                synchronized (EngineJob.this) {
                    if (EngineJob.this.cbs.contains(this.f132cb)) {
                        EngineJob.this.engineResource.acquire();
                        EngineJob.this.callCallbackOnResourceReady(this.f132cb);
                        EngineJob.this.removeCallback(this.f132cb);
                    }
                    EngineJob.this.decrementPendingCallbacks();
                }
            }
    ...
    static final class ResourceCallbackAndExecutor {
        ...
        /* renamed from: cb */
        final ResourceCallback f133cb;
        final Executor executor;

        ResourceCallbackAndExecutor(ResourceCallback resourceCallback, Executor executor2) {
            this.f133cb = resourceCallback;
            this.executor = executor2;
        }

        public boolean equals(Object obj) {
            if (obj instanceof ResourceCallbackAndExecutor) {
                return this.f133cb.equals(((ResourceCallbackAndExecutor) obj).f133cb);
            }
            return false;
        }

        public int hashCode() {
            return this.f133cb.hashCode();
        }
    }

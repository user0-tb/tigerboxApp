...
public final class GranularRoundedCorners extends BitmapTransformation {
    ...
    /* renamed from: ID */
    private static final String f141ID = "com.bumptech.glide.load.resource.bitmap.GranularRoundedCorners";
    private static final byte[] ID_BYTES = f141ID.getBytes(CHARSET);
    ...
    public int hashCode() {
        return C0957Util.hashCode(this.bottomLeft, C0957Util.hashCode(this.bottomRight, C0957Util.hashCode(this.topRight, C0957Util.hashCode(-2013597734, C0957Util.hashCode(this.topLeft)))));
    }

...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f125ix = readShort();
        this.header.currentFrame.f126iy = readShort();
        this.header.currentFrame.f124iw = readShort();
        this.header.currentFrame.f123ih = readShort();
        int read = read();
        boolean z = false;

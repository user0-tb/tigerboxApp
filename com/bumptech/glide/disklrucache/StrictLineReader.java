...
class StrictLineReader implements Closeable {
    ...
    /* renamed from: CR */
    private static final byte f120CR = 13;

    /* renamed from: LF */
    private static final byte f121LF = 10;
    private byte[] buf;
    ...
    public StrictLineReader(InputStream inputStream, int i, Charset charset2) {
        ...
        } else if (charset2.equals(C0886Util.US_ASCII)) {
    ...
    public String readLine() throws IOException {
        ...
        synchronized (this.f122in) {
            if (this.buf != null) {
                ...
                C08851 r1 = new ByteArrayOutputStream((this.end - this.pos) + 80) {
    ...
    private void fillBuf() throws IOException {
        InputStream inputStream = this.f122in;
        byte[] bArr = this.buf;

...
public abstract class BaseRequestOptions<T extends BaseRequestOptions<T>> implements Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (Float.compare(baseRequestOptions.sizeMultiplier, this.sizeMultiplier) == 0 && this.errorId == baseRequestOptions.errorId && C0957Util.bothNullOrEqual(this.errorPlaceholder, baseRequestOptions.errorPlaceholder) && this.placeholderId == baseRequestOptions.placeholderId && C0957Util.bothNullOrEqual(this.placeholderDrawable, baseRequestOptions.placeholderDrawable) && this.fallbackId == baseRequestOptions.fallbackId && C0957Util.bothNullOrEqual(this.fallbackDrawable, baseRequestOptions.fallbackDrawable) && this.isCacheable == baseRequestOptions.isCacheable && this.overrideHeight == baseRequestOptions.overrideHeight && this.overrideWidth == baseRequestOptions.overrideWidth && this.isTransformationRequired == baseRequestOptions.isTransformationRequired && this.isTransformationAllowed == baseRequestOptions.isTransformationAllowed && this.useUnlimitedSourceGeneratorsPool == baseRequestOptions.useUnlimitedSourceGeneratorsPool && this.onlyRetrieveFromCache == baseRequestOptions.onlyRetrieveFromCache && this.diskCacheStrategy.equals(baseRequestOptions.diskCacheStrategy) && this.priority == baseRequestOptions.priority && this.options.equals(baseRequestOptions.options) && this.transformations.equals(baseRequestOptions.transformations) && this.resourceClass.equals(baseRequestOptions.resourceClass) && C0957Util.bothNullOrEqual(this.signature, baseRequestOptions.signature) && C0957Util.bothNullOrEqual(this.theme, baseRequestOptions.theme)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return C0957Util.hashCode((Object) this.theme, C0957Util.hashCode((Object) this.signature, C0957Util.hashCode((Object) this.resourceClass, C0957Util.hashCode((Object) this.transformations, C0957Util.hashCode((Object) this.options, C0957Util.hashCode((Object) this.priority, C0957Util.hashCode((Object) this.diskCacheStrategy, C0957Util.hashCode(this.onlyRetrieveFromCache, C0957Util.hashCode(this.useUnlimitedSourceGeneratorsPool, C0957Util.hashCode(this.isTransformationAllowed, C0957Util.hashCode(this.isTransformationRequired, C0957Util.hashCode(this.overrideWidth, C0957Util.hashCode(this.overrideHeight, C0957Util.hashCode(this.isCacheable, C0957Util.hashCode((Object) this.fallbackDrawable, C0957Util.hashCode(this.fallbackId, C0957Util.hashCode((Object) this.placeholderDrawable, C0957Util.hashCode(this.placeholderId, C0957Util.hashCode((Object) this.errorPlaceholder, C0957Util.hashCode(this.errorId, C0957Util.hashCode(this.sizeMultiplier)))))))))))))))))))));
    }
    ...
    public final boolean isValidOverride() {
        return C0957Util.isValidDimensions(this.overrideWidth, this.overrideHeight);
    }

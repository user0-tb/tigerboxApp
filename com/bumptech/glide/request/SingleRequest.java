...
public final class SingleRequest<R> implements Request, SizeReadyCallback, ResourceCallback {
    ...
    public void begin() {
        /*
            ...
            boolean r1 = com.bumptech.glide.util.C0957Util.isValidDimensions(r1, r2)     // Catch:{ all -> 0x00bd }
    ...
    public void onResourceReady(com.bumptech.glide.load.engine.Resource<?> r6, com.bumptech.glide.load.DataSource r7, boolean r8) {
        /*
            ...
            r0.throwIfRecycled()
            r0 = 0
            java.lang.Object r1 = r5.requestLock     // Catch:{ all -> 0x00c3 }
            monitor-enter(r1)     // Catch:{ all -> 0x00c3 }
            r5.loadStatus = r0     // Catch:{ all -> 0x00c0 }
            if (r6 != 0) goto L_0x002f
            com.bumptech.glide.load.engine.GlideException r6 = new com.bumptech.glide.load.engine.GlideException     // Catch:{ all -> 0x00c0 }
            ...
            java.lang.Class<R> r8 = r5.transcodeClass     // Catch:{ all -> 0x00c0 }
            r7.append(r8)     // Catch:{ all -> 0x00c0 }
            java.lang.String r8 = " inside, but instead got null."
            r7.append(r8)     // Catch:{ all -> 0x00c0 }
            java.lang.String r7 = r7.toString()     // Catch:{ all -> 0x00c0 }
            r6.<init>(r7)     // Catch:{ all -> 0x00c0 }
            r5.onLoadFailed(r6)     // Catch:{ all -> 0x00c0 }
            monitor-exit(r1)     // Catch:{ all -> 0x00c0 }
            return
        L_0x002f:
            java.lang.Object r2 = r6.get()     // Catch:{ all -> 0x00c0 }
            if (r2 == 0) goto L_0x0063
            java.lang.Class<R> r3 = r5.transcodeClass     // Catch:{ all -> 0x00c0 }
            java.lang.Class r4 = r2.getClass()     // Catch:{ all -> 0x00c0 }
            boolean r3 = r3.isAssignableFrom(r4)     // Catch:{ all -> 0x00c0 }
            if (r3 != 0) goto L_0x0042
            goto L_0x0063
        L_0x0042:
            boolean r3 = r5.canSetResource()     // Catch:{ all -> 0x00c0 }
            if (r3 != 0) goto L_0x005e
            r5.resource = r0     // Catch:{ all -> 0x00bc }
            com.bumptech.glide.request.SingleRequest$Status r7 = com.bumptech.glide.request.SingleRequest.Status.COMPLETE     // Catch:{ all -> 0x00bc }
            r5.status = r7     // Catch:{ all -> 0x00bc }
            java.lang.String r7 = "GlideRequest"
            int r8 = r5.cookie     // Catch:{ all -> 0x00bc }
            com.bumptech.glide.util.pool.GlideTrace.endSectionAsync(r7, r8)     // Catch:{ all -> 0x00bc }
        ...
        L_0x005d:
            return
        L_0x005e:
            r5.onResourceReady(r6, r2, r7, r8)     // Catch:{ all -> 0x00c0 }
            monitor-exit(r1)     // Catch:{ all -> 0x00c0 }
            return
        L_0x0063:
            r5.resource = r0     // Catch:{ all -> 0x00bc }
            com.bumptech.glide.load.engine.GlideException r7 = new com.bumptech.glide.load.engine.GlideException     // Catch:{ all -> 0x00bc }
            java.lang.StringBuilder r8 = new java.lang.StringBuilder     // Catch:{ all -> 0x00bc }
            r8.<init>()     // Catch:{ all -> 0x00bc }
            java.lang.String r0 = "Expected to receive an object of "
            r8.append(r0)     // Catch:{ all -> 0x00bc }
            java.lang.Class<R> r0 = r5.transcodeClass     // Catch:{ all -> 0x00bc }
            r8.append(r0)     // Catch:{ all -> 0x00bc }
            java.lang.String r0 = " but instead got "
            r8.append(r0)     // Catch:{ all -> 0x00bc }
            if (r2 == 0) goto L_0x0082
            java.lang.Class r0 = r2.getClass()     // Catch:{ all -> 0x00bc }
            goto L_0x0084
        L_0x0082:
            java.lang.String r0 = ""
        L_0x0084:
            ...
            java.lang.String r0 = "{"
            r8.append(r0)     // Catch:{ all -> 0x00bc }
            r8.append(r2)     // Catch:{ all -> 0x00bc }
            java.lang.String r0 = "} inside Resource{"
            r8.append(r0)     // Catch:{ all -> 0x00bc }
            r8.append(r6)     // Catch:{ all -> 0x00bc }
            java.lang.String r0 = "}."
            r8.append(r0)     // Catch:{ all -> 0x00bc }
        ...
        L_0x00a6:
            ...
            r7.<init>(r8)     // Catch:{ all -> 0x00bc }
            r5.onLoadFailed(r7)     // Catch:{ all -> 0x00bc }
            monitor-exit(r1)     // Catch:{ all -> 0x00bc }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:20:0x00a8 A[Catch:{ all -> 0x00c0 }] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void onResourceReady(com.bumptech.glide.load.engine.Resource<R> r10, R r11, com.bumptech.glide.load.DataSource r12, boolean r13) {
        ...
        L_0x006b:
            ...
            r6 = 0
            java.util.List<com.bumptech.glide.request.RequestListener<R>> r0 = r9.requestListeners     // Catch:{ all -> 0x00c0 }
            if (r0 == 0) goto L_0x0091
            java.util.Iterator r7 = r0.iterator()     // Catch:{ all -> 0x00c0 }
            r8 = 0
        L_0x0078:
            boolean r0 = r7.hasNext()     // Catch:{ all -> 0x00c0 }
            if (r0 == 0) goto L_0x0092
            java.lang.Object r0 = r7.next()     // Catch:{ all -> 0x00c0 }
            com.bumptech.glide.request.RequestListener r0 = (com.bumptech.glide.request.RequestListener) r0     // Catch:{ all -> 0x00c0 }
            java.lang.Object r2 = r9.model     // Catch:{ all -> 0x00c0 }
            com.bumptech.glide.request.target.Target<R> r3 = r9.target     // Catch:{ all -> 0x00c0 }
            r1 = r11
            r4 = r12
            r5 = r13
            boolean r0 = r0.onResourceReady(r1, r2, r3, r4, r5)     // Catch:{ all -> 0x00c0 }
            r8 = r8 | r0
            goto L_0x0078
        L_0x0091:
            r8 = 0
        L_0x0092:
            com.bumptech.glide.request.RequestListener<R> r0 = r9.targetListener     // Catch:{ all -> 0x00c0 }
        ...
        L_0x00a5:
            ...
            com.bumptech.glide.request.transition.TransitionFactory<? super R> r10 = r9.animationFactory     // Catch:{ all -> 0x00c0 }
            com.bumptech.glide.request.transition.Transition r10 = r10.build(r12, r13)     // Catch:{ all -> 0x00c0 }
            com.bumptech.glide.request.target.Target<R> r12 = r9.target     // Catch:{ all -> 0x00c0 }
            r12.onResourceReady(r11, r10)     // Catch:{ all -> 0x00c0 }
        L_0x00b3:
    ...
    public boolean isEquivalentTo(Request request) {
        ...
        return i == i3 && i2 == i4 && C0957Util.bothModelsNullEquivalentOrEquals(obj, obj2) && cls.equals(cls2) && baseRequestOptions.equals(baseRequestOptions2) && priority2 == priority3 && size == size2;
    }

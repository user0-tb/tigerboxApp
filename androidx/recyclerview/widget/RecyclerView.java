...
import androidx.recyclerview.C0627R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public RecyclerView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0627R.attr.recyclerViewStyle);
    }
    ...
    public RecyclerView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0627R.styleable.RecyclerView, i, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, C0627R.styleable.RecyclerView, attributeSet, obtainStyledAttributes, i, 0);
        String string = obtainStyledAttributes.getString(C0627R.styleable.RecyclerView_layoutManager);
        if (obtainStyledAttributes.getInt(C0627R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
            setDescendantFocusability(262144);
        }
        this.mClipToPadding = obtainStyledAttributes.getBoolean(C0627R.styleable.RecyclerView_android_clipToPadding, true);
        boolean z2 = obtainStyledAttributes.getBoolean(C0627R.styleable.RecyclerView_fastScrollEnabled, false);
        this.mEnableFastScroller = z2;
        if (z2) {
            initFastScroller((StateListDrawable) obtainStyledAttributes.getDrawable(C0627R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes.getDrawable(C0627R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes.getDrawable(C0627R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes.getDrawable(C0627R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
        }
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public boolean canRestoreState() {
            int i = C06707.f105x3d106619[this.mStateRestorationPolicy.ordinal()];
            if (i == 1) {
                return false;
            }
    ...
    static /* synthetic */ class C06707 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f105x3d106619     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.recyclerview.widget.RecyclerView.C06707.<clinit>():void");
        }
    }
    ...
    public static abstract class LayoutManager {
        ...
        public LayoutManager() {
            C06711 r0 = new ViewBoundsCheck.Callback() {
                public View getChildAt(int i) {
            ...
            C06722 r1 = new ViewBoundsCheck.Callback() {
                public View getChildAt(int i) {
                    return LayoutManager.this.getChildAt(i);
                }
        ...
        public static Properties getProperties(Context context, AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0627R.styleable.RecyclerView, i, i2);
            properties.orientation = obtainStyledAttributes.getInt(C0627R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = obtainStyledAttributes.getInt(C0627R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = obtainStyledAttributes.getBoolean(C0627R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = obtainStyledAttributes.getBoolean(C0627R.styleable.RecyclerView_stackFromEnd, false);
            obtainStyledAttributes.recycle();
            return properties;
        }
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0627R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0627R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0627R.dimen.fastscroll_margin));
    }

...
public class DrawerArrowDrawable extends Drawable {
    ...
    public DrawerArrowDrawable(Context context) {
        ...
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes((AttributeSet) null, C0056R.styleable.DrawerArrowToggle, C0056R.attr.drawerArrowStyle, C0056R.C0062style.Base_Widget_AppCompat_DrawerArrowToggle);

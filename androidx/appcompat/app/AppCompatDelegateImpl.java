...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    public Context attachBaseContext2(Context context) {
        ...
        androidx.appcompat.view.ContextThemeWrapper contextThemeWrapper = new androidx.appcompat.view.ContextThemeWrapper(context, C0056R.C0062style.Theme_AppCompat_Empty);
    ...
    private ViewGroup createSubDecor() {
        ...
        if (obtainStyledAttributes.hasValue(C0056R.styleable.AppCompatTheme_windowActionBar)) {
            ...
            if (this.mWindowNoTitle) {
                viewGroup = this.mOverlayActionMode ? (ViewGroup) from.inflate(C0056R.C0061layout.abc_screen_simple_overlay_action_mode, (ViewGroup) null) : (ViewGroup) from.inflate(C0056R.C0061layout.abc_screen_simple, (ViewGroup) null);
            } else if (this.mIsFloating) {
                viewGroup = (ViewGroup) from.inflate(C0056R.C0061layout.abc_dialog_title_material, (ViewGroup) null);
                ...
                viewGroup = (ViewGroup) LayoutInflater.from(context).inflate(C0056R.C0061layout.abc_screen_toolbar, (ViewGroup) null);
    ...
    protected static final class PanelFeatureState {
        ...
        public void setStyle(Context context) {
            ...
            if (typedValue.resourceId != 0) {
                ...
                newTheme.applyStyle(C0056R.C0062style.Theme_AppCompat_CompactMenu, true);
            }
            androidx.appcompat.view.ContextThemeWrapper contextThemeWrapper = new androidx.appcompat.view.ContextThemeWrapper(context, 0);
        ...
        public MenuView getListMenuView(MenuPresenter.Callback callback) {
            ...
            if (this.listMenuPresenter == null) {
                ListMenuPresenter listMenuPresenter2 = new ListMenuPresenter(this.listPresenterContext, C0056R.C0061layout.abc_list_menu_item_layout);

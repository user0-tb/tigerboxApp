...
class TooltipPopup {
    ...
    TooltipPopup(Context context) {
        ...
        View inflate = LayoutInflater.from(context).inflate(C0056R.C0061layout.abc_tooltip, (ViewGroup) null);
        ...
        layoutParams.windowAnimations = C0056R.C0062style.Animation_AppCompat_Tooltip;

...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(getContext()).inflate(C0056R.C0061layout.abc_activity_chooser_view, this, true);
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (itemViewType == 0) {
                if (view == null || view.getId() != C0056R.C0059id.list_item) {
                    view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0056R.C0061layout.abc_activity_chooser_view_list_item, viewGroup, false);
                }
                ...
                View inflate = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0056R.C0061layout.abc_activity_chooser_view_list_item, viewGroup, false);
                inflate.setId(1);

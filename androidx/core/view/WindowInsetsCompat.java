...
public class WindowInsetsCompat {
    ...
    public WindowInsetsCompat replaceSystemWindowInsets(Rect rect) {
        return new Builder(this).setSystemWindowInsets(Insets.m8of(rect)).build();
    }
                ...
                if (i != 2) {
                    if (i == 8) {
                        ...
                        if (systemWindowInsets.bottom > rootStableInsets.bottom) {
                            return Insets.m7of(0, 0, 0, systemWindowInsets.bottom);
                        }
                        ...
                        if (displayCutoutCompat != null) {
                            return Insets.m7of(displayCutoutCompat.getSafeInsetLeft(), displayCutoutCompat.getSafeInsetTop(), displayCutoutCompat.getSafeInsetRight(), displayCutoutCompat.getSafeInsetBottom());
                        }
                        return Insets.NONE;
                    }
                } else if (z) {
                    ...
                    return Insets.m7of(Math.max(rootStableInsets2.left, stableInsets.left), 0, Math.max(rootStableInsets2.right, stableInsets.right), Math.max(rootStableInsets2.bottom, stableInsets.bottom));
                } else {
                    ...
                    return Insets.m7of(systemWindowInsets2.left, 0, systemWindowInsets2.right, i2);
                }
            } else if (z) {
    ...
    static Insets insetInsets(Insets insets, int i, int i2, int i3, int i4) {
        ...
        return Insets.m7of(max, max2, max3, max4);
    }
                ...
                try {
                    ...
                    if (obj != null) {
                        ...
                        if (!(rect == null || rect2 == null)) {
                            WindowInsetsCompat build = new Builder().setStableInsets(Insets.m8of(rect)).setSystemWindowInsets(Insets.m8of(rect2)).build();

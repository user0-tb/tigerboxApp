...
import p009j$.wrappers.C$r8$wrapper$java$util$function$Supplier$WRP;

public class Utf8Old extends Utf8 {
    private static final ThreadLocal<Cache> CACHE = ThreadLocal.withInitial(C$r8$wrapper$java$util$function$Supplier$WRP.convert(Utf8Old$$ExternalSyntheticLambda0.INSTANCE));

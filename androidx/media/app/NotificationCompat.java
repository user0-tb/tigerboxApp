...
public class NotificationCompat {
    ...
    public static class MediaStyle extends NotificationCompat.Style {
        ...
        public RemoteViews generateContentView() {
            ...
            applyStandardTemplate.removeAllViews(C0603R.C0605id.media_actions);
            if (i > 0) {
                int i2 = 0;
                while (i2 < i) {
                    if (i2 < size) {
                        applyStandardTemplate.addView(C0603R.C0605id.media_actions, generateMediaActionButton(this.mBuilder.mActions.get(this.mActionsToShowInCompact[i2])));
                        i2++;
                    } else {
            ...
            if (this.mShowCancelButton) {
                applyStandardTemplate.setViewVisibility(C0603R.C0605id.end_padder, 8);
                applyStandardTemplate.setViewVisibility(C0603R.C0605id.cancel_action, 0);
                applyStandardTemplate.setOnClickPendingIntent(C0603R.C0605id.cancel_action, this.mCancelButtonIntent);
                applyStandardTemplate.setInt(C0603R.C0605id.cancel_action, "setAlpha", this.mBuilder.mContext.getResources().getInteger(C0603R.integer.cancel_button_image_alpha));
            } else {
                applyStandardTemplate.setViewVisibility(C0603R.C0605id.end_padder, 0);
                applyStandardTemplate.setViewVisibility(C0603R.C0605id.cancel_action, 8);
            }
        ...
        private RemoteViews generateMediaActionButton(NotificationCompat.Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), C0603R.C0606layout.notification_media_action);
            remoteViews.setImageViewResource(C0603R.C0605id.action0, action.getIcon());
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0603R.C0605id.action0, action.getActionIntent());
            }
            if (Build.VERSION.SDK_INT >= 15) {
                Api15Impl.setContentDescription(remoteViews, C0603R.C0605id.action0, action.getTitle());
            }
            return remoteViews;
        }
        ...
        public int getContentViewLayoutResource() {
            return C0603R.C0606layout.notification_template_media;
        }
        ...
        public RemoteViews generateBigContentView() {
            ...
            if (min > 0) {
                for (int i = 0; i < min; i++) {
                    applyStandardTemplate.addView(C0603R.C0605id.media_actions, generateMediaActionButton(this.mBuilder.mActions.get(i)));
                }
            }
            if (this.mShowCancelButton) {
                applyStandardTemplate.setViewVisibility(C0603R.C0605id.cancel_action, 0);
        ...
        public int getBigContentViewLayoutResource(int i) {
            if (i <= 3) {
                return C0603R.C0606layout.notification_template_big_media_narrow;
            }
            return C0603R.C0606layout.notification_template_big_media;
        }
    }
    ...
    public static class DecoratedMediaCustomViewStyle extends MediaStyle {
        ...
        public int getContentViewLayoutResource() {
            if (this.mBuilder.getContentView() != null) {
                return C0603R.C0606layout.notification_template_media_custom;
            }
        ...
        public int getBigContentViewLayoutResource(int i) {
            if (i <= 3) {
                return C0603R.C0606layout.notification_template_big_media_narrow_custom;
            }
            return C0603R.C0606layout.notification_template_big_media_custom;
        }
        ...
        private void setBackgroundColor(RemoteViews remoteViews) {
            ...
            if (this.mBuilder.getColor() != 0) {
                ...
                i = this.mBuilder.mContext.getResources().getColor(C0603R.C0604color.notification_material_background_media_default_color);
            }
            remoteViews.setInt(C0603R.C0605id.status_bar_latest_event_content, "setBackgroundColor", i);
        }
    }

...
abstract class MapCollections<K, V> {
    ...
    final class ArrayIterator<T> implements Iterator<T>, p009j$.util.Iterator {
    ...
    final class MapIterator implements java.util.Iterator<Map.Entry<K, V>>, Map.Entry<K, V>, p009j$.util.Iterator, Map.Entry {
        int mEnd;

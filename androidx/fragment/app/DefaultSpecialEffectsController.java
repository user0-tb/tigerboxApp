...
class DefaultSpecialEffectsController extends SpecialEffectsController {
    ...
    public void executeOperations(List<SpecialEffectsController.Operation> list, boolean z) {
        ...
        for (SpecialEffectsController.Operation next : list) {
            ...
            int i = C044410.f91xe493b431[next.getFinalState().ordinal()];
            if (i == 1 || i == 2 || i == 3) {
    ...
    static /* synthetic */ class C044410 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.fragment.app.DefaultSpecialEffectsController.C044410.<clinit>():void");
        }
    }
                ...
                if (animation == null) {
                    ...
                    if (animator == null) {
                        ...
                        if (Boolean.TRUE.equals(map.get(operation2))) {
                            ...
                            C04452 r0 = new AnimatorListenerAdapter() {
        ...
        while (it2.hasNext()) {
            ...
            if (z) {
                ...
                if (operation5.getFinalState() != SpecialEffectsController.Operation.State.REMOVED) {
                    ...
                    C04474 r02 = new Animation.AnimationListener() {
                ...
                C04495 r03 = new CancellationSignal.OnCancelListener() {
                    public void onCancel() {

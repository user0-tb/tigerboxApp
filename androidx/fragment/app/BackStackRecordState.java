...
final class BackStackRecordState implements Parcelable {
    ...
    BackStackRecordState(BackStackRecord backStackRecord) {
        ...
        if (backStackRecord.mAddToBackStack) {
            ...
            int i2 = 0;
            while (i < size) {
                FragmentTransaction.C0486Op op = (FragmentTransaction.C0486Op) backStackRecord.mOps.get(i);
                int i3 = i2 + 1;
    ...
    public BackStackRecord instantiate(FragmentManager fragmentManager) {
        ...
        for (int i = 0; i < this.mFragmentWhos.size(); i++) {
            ...
            if (str != null) {
                ((FragmentTransaction.C0486Op) backStackRecord.mOps.get(i)).mFragment = fragmentManager.findActiveFragment(str);
            }
        }
    ...
    public BackStackRecord instantiate(FragmentManager fragmentManager, Map<String, Fragment> map) {
        ...
        for (int i = 0; i < this.mFragmentWhos.size(); i++) {
            ...
            if (str != null) {
                ...
                if (fragment != null) {
                    ((FragmentTransaction.C0486Op) backStackRecord.mOps.get(i)).mFragment = fragment;
                } else {
    ...
    private void fillInBackStackRecord(BackStackRecord backStackRecord) {
        ...
        while (true) {
            ...
            if (i < this.mOps.length) {
                FragmentTransaction.C0486Op op = new FragmentTransaction.C0486Op();
                int i3 = i + 1;
                op.mCmd = this.mOps[i];

...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    public final void setFragmentResultListener(final String str, LifecycleOwner lifecycleOwner, final FragmentResultListener fragmentResultListener) {
        ...
        if (lifecycle.getCurrentState() != Lifecycle.State.DESTROYED) {
            C04745 r0 = new LifecycleEventObserver() {
    ...
    static Fragment getViewFragment(View view) {
        Object tag = view.getTag(C0439R.C0440id.fragment_container_view_tag);
    ...
    private void executeOpsTogether(ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, int i, int i2) {
        ...
        if (!z && this.mCurState >= 1) {
            for (int i4 = i; i4 < i2; i4++) {
                ...
                while (it.hasNext()) {
                    Fragment fragment = ((FragmentTransaction.C0486Op) it.next()).mFragment;
        ...
        for (int i5 = i; i5 < i2; i5++) {
            ...
            if (booleanValue) {
                for (int size = backStackRecord2.mOps.size() - 1; size >= 0; size--) {
                    Fragment fragment2 = ((FragmentTransaction.C0486Op) backStackRecord2.mOps.get(size)).mFragment;
                    if (fragment2 != null) {
                ...
                while (it2.hasNext()) {
                    Fragment fragment3 = ((FragmentTransaction.C0486Op) it2.next()).mFragment;
                    if (fragment3 != null) {
    ...
    private void setVisibleRemovingFragment(Fragment fragment) {
        ...
        if (fragmentContainer != null && fragment.getEnterAnim() + fragment.getExitAnim() + fragment.getPopEnterAnim() + fragment.getPopExitAnim() > 0) {
            if (fragmentContainer.getTag(C0439R.C0440id.visible_removing_fragment_view_tag) == null) {
                fragmentContainer.setTag(C0439R.C0440id.visible_removing_fragment_view_tag, fragment);
            }
            ((Fragment) fragmentContainer.getTag(C0439R.C0440id.visible_removing_fragment_view_tag)).setPopDirection(fragment.getPopDirection());
        }
    }
    ...
    public boolean restoreBackStackState(ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, String str) {
        ...
        while (it.hasNext()) {
            ...
            if (next.mBeingSaved) {
                ...
                while (it2.hasNext()) {
                    FragmentTransaction.C0486Op op = (FragmentTransaction.C0486Op) it2.next();
    ...
    public boolean saveBackStackState(ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, String str) {
        ...
        for (int i2 = findBackStackIndex; i2 < this.mBackStack.size(); i2++) {
            ...
            while (it.hasNext()) {
                FragmentTransaction.C0486Op op = (FragmentTransaction.C0486Op) it.next();
    ...
    public /* synthetic */ Bundle m675lambda$attachController$0$androidxfragmentappFragmentManager() {

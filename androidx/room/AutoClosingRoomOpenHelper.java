...
@Metadata(mo33736d1 = {"\u0000>\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0004\b\u0000\u0018\u00002\u00020\u00012\u00020\u0002:\u0003\u001a\u001b\u001cB\u0015\u0012\u0006\u0010\u0003\u001a\u00020\u0001\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006J\b\u0010\u0015\u001a\u00020\u0016H\u0016J\u0011\u0010\u0017\u001a\u00020\u00162\u0006\u0010\u0018\u001a\u00020\u0019H\u0001R\u0010\u0010\u0004\u001a\u00020\u00058\u0000X\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\bX\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\t\u001a\u0004\u0018\u00010\nX\u0005¢\u0006\u0006\u001a\u0004\b\u000b\u0010\fR\u0014\u0010\u0003\u001a\u00020\u0001X\u0004¢\u0006\b\n\u0000\u001a\u0004\b\r\u0010\u000eR\u0014\u0010\u000f\u001a\u00020\u00108WX\u0004¢\u0006\u0006\u001a\u0004\b\u0011\u0010\u0012R\u0014\u0010\u0013\u001a\u00020\u00108WX\u0004¢\u0006\u0006\u001a\u0004\b\u0014\u0010\u0012¨\u0006\u001d"}, mo33737d2 = {"Landroidx/room/AutoClosingRoomOpenHelper;", "Landroidx/sqlite/db/SupportSQLiteOpenHelper;", "Landroidx/room/DelegatingOpenHelper;", "delegate", "autoCloser", "Landroidx/room/AutoCloser;", "(Landroidx/sqlite/db/SupportSQLiteOpenHelper;Landroidx/room/AutoCloser;)V", "autoClosingDb", "Landroidx/room/AutoClosingRoomOpenHelper$AutoClosingSupportSQLiteDatabase;", "databaseName", "", "getDatabaseName", "()Ljava/lang/String;", "getDelegate", "()Landroidx/sqlite/db/SupportSQLiteOpenHelper;", "readableDatabase", "Landroidx/sqlite/db/SupportSQLiteDatabase;", "getReadableDatabase", "()Landroidx/sqlite/db/SupportSQLiteDatabase;", "writableDatabase", "getWritableDatabase", "close", "", "setWriteAheadLoggingEnabled", "enabled", "", "AutoClosingSupportSQLiteDatabase", "AutoClosingSupportSqliteStatement", "KeepAliveCursor", "room-runtime_release"}, mo33738k = 1, mo33739mv = {1, 7, 1}, mo33741xi = 48)
...
public final class AutoClosingRoomOpenHelper implements SupportSQLiteOpenHelper, DelegatingOpenHelper {
    ...
    public static final class AutoClosingSupportSQLiteDatabase implements SupportSQLiteDatabase {
        ...
        public final void pokeOpen() {
            this.autoCloser.executeRefCountingFunction(C0696x1a023a99.INSTANCE);
        }
        ...
        public boolean inTransaction() {
            ...
            return ((Boolean) this.autoCloser.executeRefCountingFunction(C0685x5693171d.INSTANCE)).booleanValue();
        }
        ...
        public boolean isDbLockedByCurrentThread() {
            ...
            return ((Boolean) this.autoCloser.executeRefCountingFunction(C0688xa0ea6de.INSTANCE)).booleanValue();
        }

        public boolean yieldIfContendedSafely() {
            return ((Boolean) this.autoCloser.executeRefCountingFunction(C0704x2da6dfee.INSTANCE)).booleanValue();
        }

        public boolean yieldIfContendedSafely(long j) {
            return ((Boolean) this.autoCloser.executeRefCountingFunction(C0705x2da6dfef.INSTANCE)).booleanValue();
        }

        public int getVersion() {
            return ((Number) this.autoCloser.executeRefCountingFunction(C0702xff8530fc.INSTANCE)).intValue();
        }

        public void setVersion(int i) {
            this.autoCloser.executeRefCountingFunction(new C0703xff8530fd(i));
        }

        public long getMaximumSize() {
            return ((Number) this.autoCloser.executeRefCountingFunction(C0691xb75cb4a5.INSTANCE)).longValue();
        }

        public long setMaximumSize(long j) {
            return ((Number) this.autoCloser.executeRefCountingFunction(new C0700xd48b87d5(j))).longValue();
        }

        public long getPageSize() {
            return ((Number) this.autoCloser.executeRefCountingFunction(C0693x65399d06.INSTANCE)).longValue();
        }

        public void setPageSize(long j) {
            this.autoCloser.executeRefCountingFunction(new C0694x65399d07(j));
        }
        ...
        public long insert(String str, int i, ContentValues contentValues) throws SQLException {
            ...
            return ((Number) this.autoCloser.executeRefCountingFunction(new C0686x9698888f(str, i, contentValues))).longValue();
        }

        public int delete(String str, String str2, Object[] objArr) {
            Intrinsics.checkNotNullParameter(str, "table");
            return ((Number) this.autoCloser.executeRefCountingFunction(new C0682xa7295701(str, str2, objArr))).intValue();
        }

        public int update(String str, int i, ContentValues contentValues, String str2, Object[] objArr) {
            Intrinsics.checkNotNullParameter(str, "table");
            Intrinsics.checkNotNullParameter(contentValues, "values");
            return ((Number) this.autoCloser.executeRefCountingFunction(new C0701xc522ba9f(str, i, contentValues, str2, objArr))).intValue();
        }

        public void execSQL(String str) throws SQLException {
            Intrinsics.checkNotNullParameter(str, "sql");
            this.autoCloser.executeRefCountingFunction(new C0683x106d7261(str));
        }

        public void execSQL(String str, Object[] objArr) throws SQLException {
            Intrinsics.checkNotNullParameter(str, "sql");
            Intrinsics.checkNotNullParameter(objArr, "bindArgs");
            this.autoCloser.executeRefCountingFunction(new C0684x106d7262(str, objArr));
        }

        public boolean isReadOnly() {
            return ((Boolean) this.autoCloser.executeRefCountingFunction(C0689x928ac242.INSTANCE)).booleanValue();
        }
        ...
        public boolean needUpgrade(int i) {
            return ((Boolean) this.autoCloser.executeRefCountingFunction(new C0692xfb73a9ca(i))).booleanValue();
        }

        public String getPath() {
            return (String) this.autoCloser.executeRefCountingFunction(C0695x4ec8cd3b.INSTANCE);
        }

        public void setLocale(Locale locale) {
            Intrinsics.checkNotNullParameter(locale, "locale");
            this.autoCloser.executeRefCountingFunction(new C0698xf1df5ec0(locale));
        }

        public void setMaxSqlCacheSize(int i) {
            this.autoCloser.executeRefCountingFunction(new C0699x9778840d(i));
        }

        public void setForeignKeyConstraintsEnabled(boolean z) {
            this.autoCloser.executeRefCountingFunction(new C0697xeb7db11c(z));
        }
        ...
        public boolean isWriteAheadLoggingEnabled() {
            return ((Boolean) this.autoCloser.executeRefCountingFunction(C0690x1aa74a04.INSTANCE)).booleanValue();
        }

        public List<Pair<String, String>> getAttachedDbs() {
            return (List) this.autoCloser.executeRefCountingFunction(C0681x882a29d5.INSTANCE);
        }

        public boolean isDatabaseIntegrityOk() {
            return ((Boolean) this.autoCloser.executeRefCountingFunction(C0687x7d1b80e8.INSTANCE)).booleanValue();
        }
    ...
    private static final class AutoClosingSupportSqliteStatement implements SupportSQLiteStatement {
        ...
        private final <T> T executeSqliteStatementWithRefCount(Function1<? super SupportSQLiteStatement, ? extends T> function1) {
            return this.autoCloser.executeRefCountingFunction(new C0708xdd6c1cf2(this, function1));
        }
        ...
        public void execute() {
            executeSqliteStatementWithRefCount(C0706xc356304d.INSTANCE);
        }

        public int executeUpdateDelete() {
            return ((Number) executeSqliteStatementWithRefCount(C0709x7fb2e741.INSTANCE)).intValue();
        }

        public long executeInsert() {
            return ((Number) executeSqliteStatementWithRefCount(C0707xe79bbce6.INSTANCE)).longValue();
        }

        public long simpleQueryForLong() {
            return ((Number) executeSqliteStatementWithRefCount(C0710x6100e31.INSTANCE)).longValue();
        }

        public String simpleQueryForString() {
            return (String) executeSqliteStatementWithRefCount(C0711xa8feac86.INSTANCE);
        }

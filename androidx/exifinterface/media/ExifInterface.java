...
public class ExifInterface {
    ...
    private static final byte[] PNG_SIGNATURE = {-119, 80, 78, 71, Ascii.f269CR, 10, Ascii.SUB, 10};
    ...
    static {
        ...
        Charset forName = Charset.forName(C0963C.ASCII_NAME);
        ASCII = forName;
    ...
    public void setAttribute(java.lang.String r18, java.lang.String r19) {
        ...
        L_0x005f:
            ...
            goto L_0x00bf
        L_0x0098:
            double r9 = java.lang.Double.parseDouble(r19)     // Catch:{ NumberFormatException -> 0x00a6 }
            androidx.exifinterface.media.ExifInterface$Rational r6 = new androidx.exifinterface.media.ExifInterface$Rational     // Catch:{ NumberFormatException -> 0x00a6 }
            r6.<init>(r9)     // Catch:{ NumberFormatException -> 0x00a6 }
            java.lang.String r2 = r6.toString()     // Catch:{ NumberFormatException -> 0x00a6 }
            goto L_0x00bf
        L_0x00a6:
            java.lang.StringBuilder r3 = new java.lang.StringBuilder
            r3.<init>()
    ...
    /* JADX WARNING: Removed duplicated region for block: B:43:0x00ba A[Catch:{ Exception -> 0x0115, all -> 0x0112 }] */
    /* JADX WARNING: Removed duplicated region for block: B:44:0x00c2 A[Catch:{ Exception -> 0x0115, all -> 0x0112 }] */
    /* JADX WARNING: Removed duplicated region for block: B:56:0x00e7 A[Catch:{ Exception -> 0x0108, all -> 0x0106 }] */
    /* JADX WARNING: Removed duplicated region for block: B:57:0x00eb A[Catch:{ Exception -> 0x0108, all -> 0x0106 }] */
    /* JADX WARNING: Removed duplicated region for block: B:82:0x0121 A[Catch:{ all -> 0x0144 }] */
    /* JADX WARNING: Removed duplicated region for block: B:84:0x013c A[Catch:{ all -> 0x0144 }] */
    ...
    public void saveAttributes() throws java.io.IOException {
        ...
        L_0x002d:
            r0 = r1
        L_0x002e:
            java.lang.String r2 = r8.mFilename     // Catch:{ Exception -> 0x0152, all -> 0x014f }
            r3 = 0
            r5 = 21
            if (r2 == 0) goto L_0x0071
            java.io.File r2 = new java.io.File     // Catch:{ Exception -> 0x0152, all -> 0x014f }
            java.lang.StringBuilder r6 = new java.lang.StringBuilder     // Catch:{ Exception -> 0x0152, all -> 0x014f }
            r6.<init>()     // Catch:{ Exception -> 0x0152, all -> 0x014f }
            java.lang.String r7 = r8.mFilename     // Catch:{ Exception -> 0x0152, all -> 0x014f }
            r6.append(r7)     // Catch:{ Exception -> 0x0152, all -> 0x014f }
            java.lang.String r7 = ".tmp"
            r6.append(r7)     // Catch:{ Exception -> 0x0152, all -> 0x014f }
            java.lang.String r6 = r6.toString()     // Catch:{ Exception -> 0x0152, all -> 0x014f }
            r2.<init>(r6)     // Catch:{ Exception -> 0x0152, all -> 0x014f }
            boolean r6 = r0.renameTo(r2)     // Catch:{ Exception -> 0x0152, all -> 0x014f }
            if (r6 == 0) goto L_0x0056
            r6 = r1
            goto L_0x00aa
        L_0x0056:
            java.io.IOException r0 = new java.io.IOException     // Catch:{ Exception -> 0x0152, all -> 0x014f }
            java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch:{ Exception -> 0x0152, all -> 0x014f }
            r3.<init>()     // Catch:{ Exception -> 0x0152, all -> 0x014f }
            java.lang.String r4 = "Couldn't rename to "
            r3.append(r4)     // Catch:{ Exception -> 0x0152, all -> 0x014f }
            java.lang.String r2 = r2.getAbsolutePath()     // Catch:{ Exception -> 0x0152, all -> 0x014f }
            r3.append(r2)     // Catch:{ Exception -> 0x0152, all -> 0x014f }
            java.lang.String r2 = r3.toString()     // Catch:{ Exception -> 0x0152, all -> 0x014f }
            r0.<init>(r2)     // Catch:{ Exception -> 0x0152, all -> 0x014f }
            throw r0     // Catch:{ Exception -> 0x0152, all -> 0x014f }
        L_0x0071:
            int r2 = android.os.Build.VERSION.SDK_INT     // Catch:{ Exception -> 0x0152, all -> 0x014f }
            if (r2 < r5) goto L_0x00a8
            java.io.FileDescriptor r2 = r8.mSeekableFileDescriptor     // Catch:{ Exception -> 0x0152, all -> 0x014f }
            if (r2 == 0) goto L_0x00a8
            java.lang.String r2 = "temp"
            java.lang.String r6 = "tmp"
            java.io.File r2 = java.io.File.createTempFile(r2, r6)     // Catch:{ Exception -> 0x0152, all -> 0x014f }
            java.io.FileDescriptor r6 = r8.mSeekableFileDescriptor     // Catch:{ Exception -> 0x0152, all -> 0x014f }
            int r7 = android.system.OsConstants.SEEK_SET     // Catch:{ Exception -> 0x0152, all -> 0x014f }
            android.system.Os.lseek(r6, r3, r7)     // Catch:{ Exception -> 0x0152, all -> 0x014f }
            java.io.FileInputStream r6 = new java.io.FileInputStream     // Catch:{ Exception -> 0x0152, all -> 0x014f }
            java.io.FileDescriptor r7 = r8.mSeekableFileDescriptor     // Catch:{ Exception -> 0x0152, all -> 0x014f }
            r6.<init>(r7)     // Catch:{ Exception -> 0x0152, all -> 0x014f }
        ...
        L_0x00ab:
            closeQuietly(r6)
            closeQuietly(r7)
            java.io.FileInputStream r6 = new java.io.FileInputStream     // Catch:{ Exception -> 0x0115, all -> 0x0112 }
            r6.<init>(r2)     // Catch:{ Exception -> 0x0115, all -> 0x0112 }
            java.lang.String r7 = r8.mFilename     // Catch:{ Exception -> 0x0115, all -> 0x0112 }
            if (r7 == 0) goto L_0x00c2
            java.io.FileOutputStream r3 = new java.io.FileOutputStream     // Catch:{ Exception -> 0x0115, all -> 0x0112 }
            java.lang.String r4 = r8.mFilename     // Catch:{ Exception -> 0x0115, all -> 0x0112 }
            r3.<init>(r4)     // Catch:{ Exception -> 0x0115, all -> 0x0112 }
            goto L_0x00d8
        L_0x00c2:
            int r7 = android.os.Build.VERSION.SDK_INT     // Catch:{ Exception -> 0x0115, all -> 0x0112 }
            if (r7 < r5) goto L_0x00d7
            java.io.FileDescriptor r5 = r8.mSeekableFileDescriptor     // Catch:{ Exception -> 0x0115, all -> 0x0112 }
            if (r5 == 0) goto L_0x00d7
            int r7 = android.system.OsConstants.SEEK_SET     // Catch:{ Exception -> 0x0115, all -> 0x0112 }
            android.system.Os.lseek(r5, r3, r7)     // Catch:{ Exception -> 0x0115, all -> 0x0112 }
            java.io.FileOutputStream r3 = new java.io.FileOutputStream     // Catch:{ Exception -> 0x0115, all -> 0x0112 }
            java.io.FileDescriptor r4 = r8.mSeekableFileDescriptor     // Catch:{ Exception -> 0x0115, all -> 0x0112 }
            r3.<init>(r4)     // Catch:{ Exception -> 0x0115, all -> 0x0112 }
            goto L_0x00d8
        L_0x00d7:
            r3 = r1
        L_0x00d8:
            java.io.BufferedInputStream r4 = new java.io.BufferedInputStream     // Catch:{ Exception -> 0x0115, all -> 0x0112 }
            r4.<init>(r6)     // Catch:{ Exception -> 0x0115, all -> 0x0112 }
            java.io.BufferedOutputStream r5 = new java.io.BufferedOutputStream     // Catch:{ Exception -> 0x010e, all -> 0x010a }
            r5.<init>(r3)     // Catch:{ Exception -> 0x010e, all -> 0x010a }
            int r3 = r8.mMimeType     // Catch:{ Exception -> 0x0108, all -> 0x0106 }
            r6 = 4
            if (r3 != r6) goto L_0x00eb
            r8.saveJpegAttributes(r4, r5)     // Catch:{ Exception -> 0x0108, all -> 0x0106 }
            goto L_0x00fa
        L_0x00eb:
            r6 = 13
            if (r3 != r6) goto L_0x00f3
            r8.savePngAttributes(r4, r5)     // Catch:{ Exception -> 0x0108, all -> 0x0106 }
            goto L_0x00fa
        L_0x00f3:
            r6 = 14
            if (r3 != r6) goto L_0x00fa
            r8.saveWebpAttributes(r4, r5)     // Catch:{ Exception -> 0x0108, all -> 0x0106 }
        L_0x00fa:
            closeQuietly(r4)
            closeQuietly(r5)
            r2.delete()
        ...
        L_0x0115:
            ...
            r5 = r1
        L_0x0117:
            java.lang.String r4 = r8.mFilename     // Catch:{ all -> 0x0144 }
            if (r4 == 0) goto L_0x013c
            boolean r4 = r2.renameTo(r0)     // Catch:{ all -> 0x0144 }
            if (r4 != 0) goto L_0x013c
            java.io.IOException r3 = new java.io.IOException     // Catch:{ all -> 0x0144 }
            ...
            r4.append(r6)     // Catch:{ all -> 0x0144 }
            java.lang.String r0 = r0.getAbsolutePath()     // Catch:{ all -> 0x0144 }
            r4.append(r0)     // Catch:{ all -> 0x0144 }
            java.lang.String r0 = r4.toString()     // Catch:{ all -> 0x0144 }
            r3.<init>(r0)     // Catch:{ all -> 0x0144 }
            throw r3     // Catch:{ all -> 0x0144 }
        L_0x013c:
            java.io.IOException r0 = new java.io.IOException     // Catch:{ all -> 0x0144 }
            java.lang.String r4 = "Failed to save new file"
            r0.<init>(r4, r3)     // Catch:{ all -> 0x0144 }
        ...
        L_0x0152:
            ...
            r7 = r1
        L_0x0154:
            java.io.IOException r2 = new java.io.IOException     // Catch:{ all -> 0x015c }
            java.lang.String r3 = "Failed to copy original file to temp file"
            r2.<init>(r3, r0)     // Catch:{ all -> 0x015c }

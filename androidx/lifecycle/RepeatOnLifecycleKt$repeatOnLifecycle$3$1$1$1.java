...
@Metadata(mo33735bv = {1, 0, 3}, mo33736d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0001\u001a\u00020\u00002\u0006\u0010\u0003\u001a\u00020\u0002H\n"}, mo33737d2 = {"Landroidx/lifecycle/LifecycleOwner;", "<anonymous parameter 0>", "Landroidx/lifecycle/Lifecycle$Event;", "event", "", "<anonymous>"}, mo33738k = 3, mo33739mv = {1, 5, 1})
...
final class RepeatOnLifecycleKt$repeatOnLifecycle$3$1$1$1 implements LifecycleEventObserver {
    ...
    public final void onStateChanged(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
        ...
        if (event == this.$startWorkEvent) {
            ...
            objectRef.element = BuildersKt__Builders_commonKt.launch$default(coroutineScope, (CoroutineContext) null, (CoroutineStart) null, new C05371((Continuation<? super C05371>) null), 3, (Object) null);
            return;
        }
        ...
        if (event == Lifecycle.Event.ON_DESTROY) {
            ...
            this.$cont.resumeWith(Result.m772constructorimpl(unit));
        }
    }

    @Metadata(mo33735bv = {1, 0, 3}, mo33736d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0000\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H@"}, mo33737d2 = {"Lkotlinx/coroutines/CoroutineScope;", "", "<anonymous>"}, mo33738k = 3, mo33739mv = {1, 5, 1})
    @DebugMetadata(mo34423c = "androidx.lifecycle.RepeatOnLifecycleKt$repeatOnLifecycle$3$1$1$1$1", mo34424f = "RepeatOnLifecycle.kt", mo34425i = {0, 1}, mo34426l = {171, 110}, mo34427m = "invokeSuspend", mo34428n = {"$this$withLock_u24default$iv", "$this$withLock_u24default$iv"}, mo34429s = {"L$0", "L$0"})
    ...
    static final class C05371 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C05371(mutex, function2, continuation);
        }

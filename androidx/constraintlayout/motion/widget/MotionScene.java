...
public class MotionScene {
    ...
    /* access modifiers changed from: private */
    public int mDefaultDuration = HttpStatusCodesKt.HTTP_BAD_REQUEST;
    ...
    public static class Transition {
        ...
        /* access modifiers changed from: private */
        public int mDuration = HttpStatusCodesKt.HTTP_BAD_REQUEST;
        /* access modifiers changed from: private */
        public int mId = -1;
        /* access modifiers changed from: private */
        ...
        public static class TransitionOnClick implements View.OnClickListener {
            ...
            public TransitionOnClick(Context context, Transition transition, XmlPullParser xmlPullParser) {
                ...
                TypedArray obtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(xmlPullParser), C0222R.styleable.OnClick);
                int indexCount = obtainStyledAttributes.getIndexCount();
                for (int i = 0; i < indexCount; i++) {
                    int index = obtainStyledAttributes.getIndex(i);
                    if (index == C0222R.styleable.OnClick_targetId) {
                        this.mTargetId = obtainStyledAttributes.getResourceId(index, this.mTargetId);
                    } else if (index == C0222R.styleable.OnClick_clickAction) {
        ...
        private void fillFromAttributeList(MotionScene motionScene, Context context, AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0222R.styleable.Transition);
        ...
        private void fill(MotionScene motionScene, Context context, TypedArray typedArray) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                if (index == C0222R.styleable.Transition_constraintSetEnd) {
                ...
                } else if (index == C0222R.styleable.Transition_constraintSetStart) {
                ...
                } else if (index == C0222R.styleable.Transition_motionInterpolator) {
                ...
                } else if (index == C0222R.styleable.Transition_duration) {
                    int i2 = typedArray.getInt(index, this.mDuration);
                    this.mDuration = i2;
                    if (i2 < 8) {
                        this.mDuration = 8;
                    }
                } else if (index == C0222R.styleable.Transition_staggered) {
                    this.mStagger = typedArray.getFloat(index, this.mStagger);
                } else if (index == C0222R.styleable.Transition_autoTransition) {
                    this.mAutoTransition = typedArray.getInteger(index, this.mAutoTransition);
                } else if (index == C0222R.styleable.Transition_android_id) {
                    this.mId = typedArray.getResourceId(index, this.mId);
                } else if (index == C0222R.styleable.Transition_transitionDisable) {
                    this.mDisable = typedArray.getBoolean(index, this.mDisable);
                } else if (index == C0222R.styleable.Transition_pathMotionArc) {
                    this.mPathMotionArc = typedArray.getInteger(index, -1);
                } else if (index == C0222R.styleable.Transition_layoutDuringTransition) {
                    this.mLayoutDuringTransition = typedArray.getInteger(index, 0);
                } else if (index == C0222R.styleable.Transition_transitionFlags) {
    ...
    MotionScene(Context context, MotionLayout motionLayout, int i) {
        ...
        this.mViewTransitionController = new ViewTransitionController(motionLayout);
        load(context, i);
        this.mConstraintSetMap.put(C0222R.C0225id.motion_base, new ConstraintSet());
        this.mConstraintSetIdMap.put("motion_base", Integer.valueOf(C0222R.C0225id.motion_base));
    }
    ...
    private void parseMotionSceneTags(Context context, XmlPullParser xmlPullParser) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(xmlPullParser), C0222R.styleable.MotionScene);
        int indexCount = obtainStyledAttributes.getIndexCount();
        for (int i = 0; i < indexCount; i++) {
            int index = obtainStyledAttributes.getIndex(i);
            if (index == C0222R.styleable.MotionScene_defaultDuration) {
                int i2 = obtainStyledAttributes.getInt(index, this.mDefaultDuration);
                this.mDefaultDuration = i2;
                if (i2 < 8) {
                    this.mDefaultDuration = 8;
                }
            } else if (index == C0222R.styleable.MotionScene_layoutDuringTransition) {
    ...
    private int getId(Context context, String str) {
        int i;
        if (str.contains(DownloadsManager.FOLDERS_SEPARATOR)) {
    ...
    private void parseInclude(Context context, XmlPullParser xmlPullParser) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(xmlPullParser), C0222R.styleable.include);
        int indexCount = obtainStyledAttributes.getIndexCount();
        for (int i = 0; i < indexCount; i++) {
            int index = obtainStyledAttributes.getIndex(i);
            if (index == C0222R.styleable.include_constraintSet) {
    ...
    private void readConstraintChain(int i, MotionLayout motionLayout) {
        ...
        if (i2 > 0) {
            ...
            constraintSet.derivedState += DownloadsManager.FOLDERS_SEPARATOR + constraintSet2.derivedState;

...
public class CustomSupport {
    ...
    public static void setInterpolatedValue(ConstraintAttribute constraintAttribute, View view, float[] fArr) {
        ...
        try {
            boolean z = true;
            switch (C02001.f49x66adad53[constraintAttribute.getType().ordinal()]) {
                case 1:
    ...
    static /* synthetic */ class C02001 {
        ...
        static {
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.motion.utils.CustomSupport.C02001.<clinit>():void");
        }
    }
}
